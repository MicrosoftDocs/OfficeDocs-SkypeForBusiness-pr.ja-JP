...
- Strat_SB_PSTN
- seo-marvel-mar2020
description: 空き時間情報、有線/固定回線、モバイル ネットワークの可用性、制限など、国/地域の無料電話番号のダイヤルについて学習します。
...
---
# <a name="toll-free-dialing-limitations-and-restrictions"></a><span data-ttu-id="380a6-103">無料電話ダイヤルの制限事項と制約事項</span><span class="sxs-lookup"><span data-stu-id="380a6-103">Toll-free dialing limitations and restrictions</span></span>

<span data-ttu-id="380a6-104">これは、国または地域ごとに無料電話番号にダイヤルする方法を確認するのに役立ちます。</span><span class="sxs-lookup"><span data-stu-id="380a6-104">This will help you find out how to dial toll free numbers in each country or region.</span></span> <span data-ttu-id="380a6-105">国/地域を選択すると、特定の詳細、制限、制限など、無料のサービスを利用できるページが表示されます。</span><span class="sxs-lookup"><span data-stu-id="380a6-105">After you select the country/region, it will take you to a page that contains where toll free service is available including specific details, restrictions, and limits.</span></span> <span data-ttu-id="380a6-106">ダイヤルの形式または形式には、各国/地域内で無料電話番号にダイヤルするために必要なアクセス コードが表示されます。</span><span class="sxs-lookup"><span data-stu-id="380a6-106">The dialing format or formats will show you the required access codes within each country/region to dial the toll-free number.</span></span>
  
<span data-ttu-id="380a6-107">準備ができたら、国または地域を選択します。</span><span class="sxs-lookup"><span data-stu-id="380a6-107">If you're ready, select a country or region:</span></span>
  
## <a name="select-your-country-or-region-to-see-the-dialing-codes-limitations-and-restrictions"></a><span data-ttu-id="380a6-108">お客様の国または地域を選択すると、ダイヤル コード、制限、制限が表示されます。</span><span class="sxs-lookup"><span data-stu-id="380a6-108">Select your country or region to see the dialing codes, limitations and restrictions.</span></span>
...
> - [ベルギー](toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-belgium.md)
...
## <a name="here-are-some-important-things-for-you-to-remember-about-toll-free-numbers"></a><span data-ttu-id="380a6-174">無料電話番号について覚えておく必要がある重要な点を次に示します。</span><span class="sxs-lookup"><span data-stu-id="380a6-174">Here are some important things for you to remember about toll free numbers:</span></span>

- <span data-ttu-id="380a6-175">**無料電話番号は、各国/地域内でのみ機能します。**</span><span class="sxs-lookup"><span data-stu-id="380a6-175">**Toll free numbers only operate within each country/region.**</span></span> <span data-ttu-id="380a6-176">たとえば、ユーザーはオーストラリアの外からオーストラリアの無料電話番号を発信することはできません。</span><span class="sxs-lookup"><span data-stu-id="380a6-176">For example, your users won't be able to call an Australian toll-free number outside of Australia.</span></span>
    
- <span data-ttu-id="380a6-177">**ユニバーサル国際フリーフォン番号 (UIFN) の取得または移植はサポートされていません。**</span><span class="sxs-lookup"><span data-stu-id="380a6-177">**Acquiring or porting Universal International Freephone Numbers (UIFN) isn't supported.**</span></span>
    
- <span data-ttu-id="380a6-178">**多くの国/地域では、国/地域の規制機関/電気通信機関は、番号を保持するために、各無料電話番号が毎月少なくとも 100 分の使用を維持する必要があります。**</span><span class="sxs-lookup"><span data-stu-id="380a6-178">**In many countries/regions, the regulator/telecommunication agency in the country/region requires each toll free phone number to maintain at least 100 minutes of usage per month in order to retain the number.**</span></span>
    
    > [!NOTE]
    > <span data-ttu-id="380a6-179">無料電話番号を取得して、その番号の使用時間がこれらの最低要件を満たさない場合、Microsoft は規制機関または通信局の指示に従って、お客様に対して当該番号の返還を要求する場合があります。</span><span class="sxs-lookup"><span data-stu-id="380a6-179">In the event you get a toll free number and the usage of the number doesn't meet these minimum requirements, Microsoft may be compelled by the regulator/telecommunication agency to reclaim the number from you.</span></span> 
  
- <span data-ttu-id="380a6-180">**無料電話番号への有線、固定回線、携帯電話ネットワークによるアクセスは、完全に、または部分的に制限されます。**</span><span class="sxs-lookup"><span data-stu-id="380a6-180">**Wireline, fixed line, and mobile network access to toll-free numbers may be fully or partially restricted.**</span></span> <span data-ttu-id="380a6-181">ダイヤル形式では、無料電話番号を使用して通話を発信するために、各国/地域内で必要なアクセス コードが記述されています。</span><span class="sxs-lookup"><span data-stu-id="380a6-181">The dialing format describes the required access codes within each country/region to place calls using the toll free number.</span></span>
    
- <span data-ttu-id="380a6-182">**北米の番号付けプランの無料電話番号:** 北米番号プランの無料電話番号の分単位料金は、発信元の国によって決まります。</span><span class="sxs-lookup"><span data-stu-id="380a6-182">**North America Numbering Plan Toll Free Numbers:** Per-minute rates for North America Numbering Plan toll free numbers are determined by the originating country.</span></span> <span data-ttu-id="380a6-183">米国から発信された通話の 1 分あたりの無料通話料金は、"北米" として定義された料金にマップされます。</span><span class="sxs-lookup"><span data-stu-id="380a6-183">The toll free per-minute rate for calls that originate from the United States map to the rate defined as "North America."</span></span> <span data-ttu-id="380a6-184">ただし、カナダ、プエルトリコなどの他の北米の国から発信された通話には、特定の無料料金が適用されます。</span><span class="sxs-lookup"><span data-stu-id="380a6-184">However, calls that originate from other North American countries such as Canada, Puerto Rico, etc. have specific toll free rates.</span></span>

> [!NOTE]
> <span data-ttu-id="380a6-185">さらに追加で電話番号が必要な場合は、「[一般法人向け Office 365 のサポートへのお問い合わせ - 管理者向けヘルプ](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)」をご覧ください。</span><span class="sxs-lookup"><span data-stu-id="380a6-185">If you need to get more telephone numbers than this, please [contact support for business products - Admin Help](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)</span></span>
    
## <a name="related-topics"></a><span data-ttu-id="380a6-186">関連トピック</span><span class="sxs-lookup"><span data-stu-id="380a6-186">Related topics</span></span>
[<span data-ttu-id="380a6-187">Skype for Business および Microsoft Teams のサービス電話番号の取得</span><span class="sxs-lookup"><span data-stu-id="380a6-187">Getting service phone numbers for Skype for Business and Microsoft Teams</span></span>](./getting-service-phone-numbers.md)

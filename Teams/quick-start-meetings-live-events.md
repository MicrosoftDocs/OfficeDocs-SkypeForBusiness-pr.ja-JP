...
会議やライブ イベントの編成、スケジュール、主催するユーザーには、「[Microsoft Teams サービスの説明](/office365/servicedescriptions/teams-service-description)」に記載されているライセンス プランのいずれかが必要です。 

既に Teams を使用している場合は、会議やライブ イベントの編成および主催に必要なライセンスを持っている可能性があります。

...
ms.locfileid: "58608794"
---
# <a name="see-a-list-of-phone-numbers-in-your-organization"></a>組織の電話番号のリストを表示する

ユーザーや他のサービス (サービス番号) に割り当て可能な電話番号には、Microsoft 365 や Office 365 の電話会議など、さまざまな種類があります。
...
2. In the left navigation, go to **Voice** > **Phone numbers**.
    ...
    > [!IMPORTANT]
    > Microsoft Teams 管理センターの左側のナビゲーションに [音声] オプションを表示するには、まず、少なくとも 1 つの **Enterprise E5** ライセンス、1 つの **電話システム** アドオンライセンス、または 1 つの電話会議アドオン ライセンスを購入する必要があります。

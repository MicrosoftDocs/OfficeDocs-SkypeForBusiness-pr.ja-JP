...
このコードは、英国の通信規制に従って、Microsoft 365またはOffice 365通話プラン サービス ("サービス") に関して、英国 (英国) の小規模企業顧客 (従業員 10 人以下の組織) に適用されます。 その他の Skype for Business サービスは、Microsoft とのサービス規約、および特定のサービスの使用に適用されるその他の規約によって管理されます。
...
オンライン: Microsoft 365 管理センターにサインインし、[**サポート**] で [新しいサービス要求] を選択して **サービス要求を** 送信します。
...
お客様の満足と優れたサービスが弊社の最優先事項です。 ただし、苦情が発生した場合、弊社はお客様が早急に問題を解決できるように努めます。 [Microsoft 365またはOffice 365の通話プラン - 英国 (英国) の苦情処理コード](complaint-handling-code-for-the-united-kingdom-u-k.md)ページでは、小規模企業が弊社に苦情を申し立てる手順と、独立した紛争解決スキームについて詳しく説明しています。
...
通話プランMicrosoft 365またはOffice 365は、ブロードバンド接続に依存します。 ブロードバンド接続で電源の中断や障害が発生した場合は、電話を発信することができません。 これらの障害の原因は、弊社の制御対象外である場合があります。

## <a name="6-emergency-calls"></a>6. 緊急通話

Skype for Business では、999/112 公共緊急通話サービスを、イングランド、ウェールズ、スコットランド、北アイルランドのお客様に提供します。 ただし、999 または 112 への緊急通話は、従来の電話サービスとMicrosoft 365またはOffice 365通話プラン サービスでは動作が異なります。 お客様は、これらの違いについて、Microsoft 365サービスまたは通話プラン サービスOffice 365各ユーザーに通知する必要があります。

違いは次のとおりです。(i) Skype for Business呼び出し元の実際の場所がわからない場合があります。これにより、緊急サービスが間違った場所に発送される可能性があります。(ii) Skype for Business ユーザーが緊急通報をダイヤルすると、緊急通報の適切なルーティングと緊急サービスの発送を支援するために、オペレーターから現在の場所を指定するよう求められる場合があります。(iii) ユーザーのデバイスに電源がない場合、電源が切れた場合、または何らかの理由でインターネットにアクセスできない場合、ユーザーはMicrosoft 365またはOffice 365通話プラン サービスを介して緊急通話を行うことができません。(iv) Microsoft 365およびOffice 365 通話プラン サービスは、インターネット接続が利用可能な世界のどこでも使用できます。通話は適切な緊急サービスにルーティングされない可能性があるため、ユーザーは 999 または 112 をイングランド、ウェールズ、スコットランド、北アイルランドの外に呼び出すべきではありません。
...
月額プランと利用料金 (プレミアム レート サービスと国営通訳サービスの番号料金を含む) の情報は、[Skype for Business の Web サイト](https://go.microsoft.com/fwlink/?LinkID=820709&amp;clcid=0x809)に記載されています。

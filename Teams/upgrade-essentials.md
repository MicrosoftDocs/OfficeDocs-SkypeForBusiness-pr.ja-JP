...
# <a name="about-the-upgrade-essentials-checklist"></a>Essentials のアップグレードのチェックリストについて 

小規模な組織やビジネス オンラインの Skype を使用する (チャット) の IM と会議だけのために設計された、Essentials のアップグレードのチェックリストを含むコア、高速化されたアクション ・ プランを選択し、活動を推奨を実装するためのリソースに関連付けられている、チームにビジネス用の Skype から正常に移動します。

10 の簡単な手順は、アップグレードの成功のために必要なすべてを提供します。 タイムラインは、概算値です。組織のアップグレードのスケジュールを基に調整する必要があります。

チームに精通していないでしょうか。 [方法についてチーム](https://products.office.com/en-us/microsoft-teams/group-chat-software)の会話、会議、ファイル、Office アプリケーション、およびサード ・ パーティ統合をまとめて-Office 365 のチームワークで 1 つのハブを提供することです。

アップグレードについて質問があるでしょうか。 についての FAQ を表示します。

<a name="step-1"></a>

## <a name="step-1-notify-your-key-stakeholders"></a>手順 1 です。 主要な関係者に通知します。

*(アップグレード前に約 4 ~ 6 週間)*


シニア ・ リーダーとは、会社の成功に責任を持つ削除しないときは、通知がテクノロジーの変化のことを確認します。 (たとえば、最高経営責任者、IT プロフェッショナル、マーケティング、およびヘルプデスクの潜在顧客) には、関係者に通知する必要がありますので、誰も受信またはアップグレードの適格性の通知を読むことはできますが、アップグレードの計画を開始する前にします。

**リソース:**

-   [電子メールのサンプル: 利害関係者のコミュニケーション](#step-1-email)
 
[先頭へ戻る](#about-upgrade-essentials)

<a name="step-2"></a>

## <a name="step-2-envision-your-organization-on-teams"></a>手順 2 です。 チーム、組織のビジョン化します。

*(アップグレード前に約 4 ~ 6 週間)*

チームは、ビジネス機能の互換性のある Skype を提供しています-IM (チャット)、会議など、方がもっと多く操作も実行できますが、します。 チームワークの真のハブ、としては、チームは、プロジェクト、ファイル、会話、および 1 つの場所ですべてのアプリケーションを管理するためにワークグループを使用できます。 組織はチームを使用し、成功のための環境を有効にする方法を決定します。

> [!Note]
> ビジネス顧客の既存の Skype、として、現在のネットワーク インフラストラクチャはチームが既に構成されています。 これを確認するのには下にリンクされている「技術的な計画を完了する」のガイダンスに従うことができます (省略可能です)。

**リソース:**

-   [Teams の概要](https://docs.microsoft.com/MicrosoftTeams/Teams-overview)
-   [チームとのチャンネルについてください。](https://docs.microsoft.com/MicrosoftTeams/teams-channels-overview)
-   [技術的な計画を完了します。](https://docs.microsoft.com/MicrosoftTeams/quick-start-enable-teams#step-3-complete-technical-planning)
...
## <a name="step-3-know-your-skype-for-business-users"></a>ステップ 3 です。 ビジネス ユーザー向けに、Skype を知っています。

*(約 4 週間以内のアップグレードの前に)*

ユーザーは、ビジネスの Skype の採用は深くには、少しの時間や、チームへの移行の支援を必要があります。 ビジネスを使用するため現在 Skype、その他のサポートが必要な最上位のユーザーを識別して、アップグレード後の番号を追跡する使用量の基準を確立するための確認に時間がかかります。
...
## <a name="step-4-notify-your-users-that-skype-for-business-is-becoming-teams"></a>手順 4 します。 ビジネス用の Skype がチームになっていることをユーザーに通知します。

*(アップグレード前に約 2 ~ 3 週間)*

ユーザーに十分な注意を与えると、その時間は正のユーザー エクスペリエンスの結果として、生産性に悪影響を及ぼすことがなくチームについて理解するのにします。 通信からの変更点、変更理由がするは通知を送信します。

> [!Note]
> 必要な場合は、この時点で、Office 365 管理ポータルを使用して、ユーザーのチームを有効にできます。

**リソース:**

-   [組織内のチームの機能を管理します。](https://docs.microsoft.com/microsoftteams/enable-features-office-365)
-   [電子メールのサンプル: ビジネス用の Skype についてユーザーにお知らせ](#step-4-email)
...
ビジネス クライアントのビジネス用の Skype がチームになっているため、Skype で視覚的な警告を提供する、管理ポータルを使用してユーザーのアップグレードの通知を有効にすると、アップグレードの勢いを維持します。
...
## <a name="step-6-remind-your-users-that-skype-for-business-is-becoming-teams"></a>手順 6。 ビジネス用の Skype がチームになっていることをユーザーに通知します。
*(アップグレード前に約 5 日)*
...
-   [電子メールのサンプル: チームを開始するユーザーに通知](#step-6-email)

[先頭へ戻る](#about-upgrade-essentials)

<a name="step-7"></a>

## <a name="step-7-upgrade-users-to-teams"></a>手順 7 です。 チームにユーザーをアップグレード!

*(1 日にアップグレードします)*

今日は、組織が正式に、コミュニケーションとコラボレーションのソリューションとしてチームにアップグレードの日です。 Office 365 管理ポータルでは、アップグレードを有効にします。 ビジネス クライアントがチームにアップグレードされているため、Skype では、ユーザーは通知を受け取ります。

すべてのユーザーがアップグレードされた後、チームを歓迎する電子メールを送信することをお勧めします。

**リソース:**

-   ユーザーの利用方法: Irinel をアップグレードへのリンクですか。 – 機能とドキュメントのリリースを待っています。
-   [電子メールのサンプル: ユーザーがチームの開始](#step-7-email)

[先頭へ戻る](#about-upgrade-essentials)

<a name="step-8"></a>

## <a name="step-8-monitor-teams-usage-against-your-baseline"></a>手順 8 です。 ベースラインに対してチームの使用率を監視します。

*(については、アップグレード後の 1 つまたは 2 つの週)*

新しいテクノロジーを調整すると、時間がかかることができます。 ユーザーが同時にチームを使用していることを確認する使用状況を確認、またはそれ以上-レベルのビジネス用の Skype と同様にします。 期待どおりのレベルでチームを使用していないユーザーを使用して確認してください。
...
## <a name="step-9-measure-user-satisfaction"></a>手順 9。 ユーザーの満足度を測定

*(については、アップグレード後の 1 つまたは 2 つの週)*

従業員の満足度は、保持期間などの生産性に影響を与えると、最終的に、ビジネスの成果。 アップグレードおよびチームに顧客満足度に関するユーザーのある意見を評価するため、ユーザーにアクセスします。

**リソース:**

-   [電子メールのサンプル: ユーザーが確認](#step-9-email)、さらに[ユーザー アンケート](#step-9-surveys)
...
-   [電子メールのサンプル: ユーザーがチームをさらに調査をお勧め](#step-10-email)
...
## <a name="sample-surveys-for-the-check-in-email-in-step-9"></a>アンケートは、手順 9 でチェックイン時にメールのサンプル

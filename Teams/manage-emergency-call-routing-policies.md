...
緊急通話ルーティング ポリシーを管理するには、Microsoft Teams管理センターで [音声緊急] ポリシーに移動するか  >  、Windows PowerShell。 ポリシーは、ユーザーとネットワーク サイトに [割り当てることができます](cloud-voice-network-settings.md)。

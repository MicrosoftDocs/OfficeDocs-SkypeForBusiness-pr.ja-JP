...
- 共通エリア電話。 [「Microsoft Teams 用の共通エリア電話を設定する」を](./set-up-common-area-phones.md)参照してください。 ダイレクト ルーティングを使用して共通エリア電話を設定する場合、通話プラン ライセンスは必要ありません。

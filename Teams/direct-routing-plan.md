...
|Microsoft 365またはOffice 365組織|ユーザー Microsoft 365ユーザー Office 365、SBC への構成と接続をMicrosoft Teamsに使用する組織です。|
...
- 任意Teamsクライアント。 
- 共通領域電話。 「Common [Area 電話 ライセンスを設定する」をMicrosoft Teams。](./set-up-common-area-phones.md) 直接ルーティングを使用して共通領域のライセンスを設定する場合は、通話電話は必要ない点に注意してください。
...
1 つのテナントに複数の SIP アドレス空間がある可能性があります。 たとえば、会社が SIP アドレス空間 contoso.com 2 つ目の SIP アドレス空間として fabrikam.com を使用している場合があります。 一部のユーザーはアドレス user@contoso.com 持ち、一部のユーザーはアドレスアドレスを持 user@fabrikam.com。 

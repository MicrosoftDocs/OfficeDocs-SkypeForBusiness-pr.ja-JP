...
![組織のネットワークと Office 365 サービスの間の関係: オンプレミスのネットワークとデバイスは、相互接続ネットワークに接続されます。これは、Office 365 クラウドの音声と電話会議サービスに接続します。](media/Qos-in-Teams-Image1.png)
...
![利用可能な帯域幅の合計は、複数のキュー (オーディオ、ビデオ、その他のトラフィック) で分割されます。これには、さまざまな優先順位が割り当てられています。](media/Qos-in-Teams-Image2.png "利用可能な帯域幅の合計は、複数のキュー (オーディオ、ビデオ、その他のトラフィック) で分割されます。これには、さまざまな優先順位が割り当てられています。")
...
4. [**表示フィルター** ] フィールドで、通話を行った PC のソース IP アドレスを使用し、次の例に示すように、検索条件として DSCP 値 46 (hex 0xb8) を定義してフィルターを絞り込むことができます。
    ...
    ![適用するフィルターが表示された、ネットワークモニターの [表示フィルター] ダイアログボックスのスクリーンショット。](media/Qos-in-Teams-Image4.png "適用するフィルターが表示された、ネットワークモニターの [表示フィルター] ダイアログボックスのスクリーンショット。")
...
7. [**フレームの詳細**] ウィンドウで、[IPv4] リスト項目を展開し、 **DSCP**で始まる行の末尾の値をメモします。
    ...
    ![ネットワークモニターの [フレームの詳細] ダイアログボックスのスクリーンショット。 DSCP 設定が強調表示されています。](media/Qos-in-Teams-Image5.png "ネットワークモニターの [フレームの詳細] ダイアログボックスのスクリーンショット。 DSCP 設定が強調表示されています。")

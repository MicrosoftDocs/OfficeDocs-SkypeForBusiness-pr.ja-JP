...
- Phone System
- Calling Plans
description: タークス・カイコス諸島で利用Office Skype for Business および Microsoft Teams 用の Microsoft 365 および 365 のサービスを以下に示します。
...
---
# <a name="availability-in-turks-and-caicos-islands"></a>タークス・カイコス諸島の空き時間

[[別の国または地域を検索]](country-and-region-availability-for-audio-conferencing-and-calling-plans.md) するか、国および地域ごとの電話会議および通話プランの利用可能性の詳細をご確認ください。

タークス・カイコス諸島で利用Office Skype for Business および Microsoft Teams 用の Microsoft 365 および 365 のサービスを以下に示します。

...
ms.custom:
  ...
  - Phone System
  - Calling Plans
description: 次に、Microsoft 365とOffice 365、およびSkype for BusinessサービスMicrosoft Teamsを示します。
---
...
次に、Microsoft 365とOffice 365、およびSkype for BusinessサービスMicrosoft Teamsを示します。
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?   | マティ ([要求に応じて](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md))<br/> |

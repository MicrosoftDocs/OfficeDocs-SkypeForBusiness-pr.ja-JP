...
ms.custom:
  ...
  - Phone System
  - Calling Plans
description: 以下は、Microsoft 365、Office 365とSkype for BusinessサービスMicrosoft Teams提供されています。
---

# <a name="availability-in-jamaica"></a>ジャマイカでの空き時間情報

[[別の国または地域を検索]](country-and-region-availability-for-audio-conferencing-and-calling-plans.md) するか、国および地域ごとの電話会議および通話プランの利用可能性の詳細をご確認ください。

以下は、Microsoft 365、Office 365とSkype for BusinessサービスMicrosoft Teams提供されています。

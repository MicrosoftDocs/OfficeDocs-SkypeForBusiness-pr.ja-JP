...
- Phone System
- Calling Plans
description: インドネシアで利用できるSkype for BusinessとMicrosoft TeamsのMicrosoft 365サービスとOffice 365 サービスを次に示します。
...
インドネシアで利用できるSkype for BusinessとMicrosoft TeamsのMicrosoft 365サービスとOffice 365 サービスを次に示します。
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?  <br/> |([要求に応じて](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md)) <br/> |

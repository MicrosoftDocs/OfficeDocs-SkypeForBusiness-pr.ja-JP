...
- Phone System
- Calling Plans
description: 以下に、Microsoft 365、Office 365とSkype for Business、Microsoft Teamsサービスを示します。
...
以下に、Microsoft 365、Office 365とSkype for Business、Microsoft Teamsサービスを示します。
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?  <br/> |Na[要求に応じて](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md))  <br/> |

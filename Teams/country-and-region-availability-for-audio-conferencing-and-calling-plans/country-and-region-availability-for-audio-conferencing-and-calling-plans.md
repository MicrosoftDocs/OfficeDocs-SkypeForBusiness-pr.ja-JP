...
> - [タークス諸島とカイコ諸島](availability-in-turks-and-caicos-islands.md)
...
**すべての国と地域を含むスプレッドシートを探している場合は、[Cloud 音声機能の国/地域の可用性スプレッドシート](https://download.microsoft.com/download/d/b/6/db6992c5-ec9a-4b02-8742-59df17dd90a7/country-and-region-availability-(v-19OCT2021)-(en-us).xlsx)をダウンロードして保存します**。
...
## <a name="want-to-learn-more-about-these-services"></a>これらのサービスの詳細を確認する
...
> [!IMPORTANT]
> 電話会議のすべてのダイヤルイン番号のリストを含んでいるリソースはありません。 ご利用のエリアまたは国/地域で利用可能なダイヤルイン電話番号があるかどうかを知るには、[**Skype for Business 管理センター**] > [**音声**] > [**電話番号**] に移動して、[**追加**] をクリックしてから [**新しいサービス番号**] をクリックします。 [**国/地域**]、[**都道府県/地域**]、[**市区町村**] のリストを使用して、検索をフィルタします。 無料のサービス番号をお探しの場合は、**都道府県/地域** の一覧から **フリーダイヤル** を選択します。
...
電話会議では、他のユーザーがダイヤルイン会議に参加できるようにするために "*Call Me*" 機能が使用されます。 この記事のドロップダウン リストを使用して、国/地域を検索し、この機能が利用できるかどうかを確認します。

> [!CAUTION]
> 一部のフリーダイヤル番号は、国内の特定の国または地域からのみ機能するため、無料または無料の電話番号にダイヤルアウトできない場合があります。 たとえば、米国からブラジルのフリーダイヤル番号にダイヤルアウトした場合、呼び出しがブラジル内またはブラジル内の特定のリージョンから発信されなかったため、通話が成功しない可能性があります。 フリーダイヤル番号にダイヤルアウトする機能は、ダイヤルされたフリーダイヤル番号の制限によって大きく異なります。 残念ながら、この動作を制御することはできません。その結果、ダイヤルされたフリーダイヤル番号とフリーダイヤル番号の制限によって、お客様のエクスペリエンスが異なる場合があります。
  
会議から、以下に記載されていない世界の他の国/地域へのダイヤルアウトは、 [Communication Credits](../what-are-communications-credits.md) を使用して利用できます。 これらのユーザーの場合は、 [組織の通信クレジットを設定する必要があります](../set-up-communications-credits-for-your-organization.md)。
...
### <a name="toll-and-toll-free-phone-numbers-for-services"></a>サービスの有料電話番号とフリーダイヤル電話番号

個々のユーザーの電話番号を取得するだけでなく、電話会議 (会議ブリッジ用)、自動応答、通話キューなどのサービスの有料電話番号または無料電話番号を検索して取得することもできます。 これらはサービス番号と呼ばれます。
  
電話会議と通話プランで使用する有料サービス番号を取得できる首都および主要都市のリストを以下に示します。 Skype for Business **管理センター** を使用して、これらの場所から有料サービス番号を取得します。
  
有料または無料のサービス番号を取得する場合は、 [サービス電話番号の取得](../getting-service-phone-numbers.md)に関するページを参照してください。 別のプロバイダーから転送する有料または無料のサービス番号が既にある場合は、「 [組織の電話番号を管理する](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md)」を参照してください。
...
コミュニケーション クレジットを設定してユーザーにライセンスを割り当てず、組織の時間が (通話プランまたは電話会議プランまたは国/地域に応じて) 不足している場合、通話や会議からのダイヤルアウトはできなくなります。 推奨される利用可能残高などの詳細については、「[コミュニケーション クレジットについて](../what-are-communications-credits.md)」をご覧ください。

...
ここでは、Skype for Business および Microsoft Teams 用の Microsoft 365 と Office 365 サービスをラトビアで利用できるようにする方法について説明します。
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?  <br/> |([要求時](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)) <br/> |

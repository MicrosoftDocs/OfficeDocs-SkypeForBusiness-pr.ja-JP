...
|電話番号は自動的に電話会議に割り当てられますか?  <br/> |はいの場合。<br/><ul><li> ブリュッセル</ul>専用の電話番号が必要な場合は、「[Skype for Business および Microsoft Teams のサービス電話番号の取得](/SkypeForBusiness/what-is-phone-system-in-office-365/getting-service-phone-numbers)」をご覧ください。  <br/> |
...
|無料電話番号は使用できますか?  <br/> |あり  <br/> |
 ...
 オーディオ会議のための有料電話番号と無料電話番号を取得する場合は、自動応答、および呼び出しキューを参照してください[ビジネスおよびマイクロソフトのチームの Skype のサービス電話番号を取得](/SkypeForBusiness/what-is-phone-system-in-office-365/getting-service-phone-numbers)します。

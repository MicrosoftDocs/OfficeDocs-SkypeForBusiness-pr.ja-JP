...
- Phone System
- Calling Plans
description: ロシアで利用可能なSkype for BusinessとMicrosoft TeamsのMicrosoft 365サービスとOffice 365 サービスを次に示します。
ms.openlocfilehash: 661b635b16e3fb724da77be10fd80165660b2a9c
ms.sourcegitcommit: 9ef6e36eeba7db70971f4eb1a45f0ded394b1fe6
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 01/25/2022
ms.locfileid: "62190848"
---
# <a name="availability-in-russia"></a>ロシアでの利用可能性

[[別の国または地域を検索]](country-and-region-availability-for-audio-conferencing-and-calling-plans.md) するか、国および地域ごとの電話会議および通話プランの利用可能性の詳細をご確認ください。

ロシアで利用可能なSkype for BusinessとMicrosoft TeamsのMicrosoft 365サービスとOffice 365 サービスを次に示します。
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?  <br/> |<ul><li>モスクワ <li>St. Petersburg ([リクエストに応じて](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md))</ul>|

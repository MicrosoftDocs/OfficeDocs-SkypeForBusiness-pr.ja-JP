...
以下に、ba大Microsoft 365でOffice 365サービスとSkype for BusinessサービスMicrosoft Teamsを示します。
...
通話プランを購入できない場合は、ダイレクト ルーティング の使用 [を検討してください](../direct-routing-landing-page.md)。 ダイレクト ルーティングでは、事実上すべてのテレフォニー 電話システムを使用できます。

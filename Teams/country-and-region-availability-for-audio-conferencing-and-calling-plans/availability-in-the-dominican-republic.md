...
ここでは、Microsoft Teams の Office 365 サービスと、ドミニカ共和国で利用できる Microsoft Teams を示します。
...
|電話番号は自動的に電話会議に割り当てられますか?  <br/> |あり (サンティアゴの場合) 専用の電話番号が必要な場合は、「[Skype for Business および Microsoft Teams のサービス電話番号の取得](/SkypeForBusiness/what-is-phone-system-in-office-365/getting-service-phone-numbers)」をご覧ください。  <br/> |

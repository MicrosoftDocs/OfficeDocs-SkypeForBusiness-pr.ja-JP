...
- Phone System
- Calling Plans
description: ここでは、Microsoft 365 と、クウェートで利用できる Microsoft Teams 用の Microsoft および Office 365 サービスを紹介します。
ms.openlocfilehash: 53c1771ea78e70c8ae15cb34a56bc19c39999a9d
ms.sourcegitcommit: 1c2359f10ad5f5ec10dc52508ef4774c04b631ab
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 05/14/2020
ms.locfileid: "44231106"
---
# <a name="availability-in-kuwait"></a>クウェートでの可用性

[[別の国または地域を検索]](country-and-region-availability-for-audio-conferencing-and-calling-plans.md) するか、国および地域ごとの電話会議および通話プランの利用可能性の詳細をご確認ください。

ここでは、Microsoft 365 と、クウェートで利用できる Microsoft Teams 用の Microsoft および Office 365 サービスを紹介します。
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?   | クウェートシティ <br/> |

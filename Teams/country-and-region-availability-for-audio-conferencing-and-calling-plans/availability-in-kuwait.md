...
ここでは、クウェートで利用できる Skype for Business および Microsoft Teams の Office 365 サービスを紹介します。
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?   | クウェート City ([要求時](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)) <br/> |

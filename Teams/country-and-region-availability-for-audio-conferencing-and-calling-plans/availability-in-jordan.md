...
- Phone System
- Calling Plans
description: ここでは、Microsoft 365 と、microsoft Teams で利用可能な microsoft Teams 用の Microsoft および Office 365 サービスをご紹介します。
ms.openlocfilehash: 18919a481796f80ddb6557b5c9cf2351d2529c69
ms.sourcegitcommit: 1c2359f10ad5f5ec10dc52508ef4774c04b631ab
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 05/14/2020
ms.locfileid: "44230906"
---
# <a name="availability-in-jordan"></a>ヨルダンでの利用可能性

[[別の国または地域を検索]](country-and-region-availability-for-audio-conferencing-and-calling-plans.md) するか、国および地域ごとの電話会議および通話プランの利用可能性の詳細をご確認ください。

ここでは、Microsoft 365 と、microsoft Teams で利用可能な microsoft Teams 用の Microsoft および Office 365 サービスをご紹介します。
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?  <br/> |Amman ([要求時](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md))  <br/> |

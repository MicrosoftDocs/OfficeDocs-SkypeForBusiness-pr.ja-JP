...
f1.keywords:
- NOCSH
description: 主要な利害関係者、ビジネスMicrosoft Teams、成功の対策、キャンペーンの管理を識別することで、変更管理戦略を作成します。
appliesto:
- Microsoft Teams
...
|![サービス所有者アイコン。](media/Create_a_change_management_strategy_for_Microsoft_Teams_image2.png)     |**サービス所有者は** 、ユーザーがサービスを使用し、そのサービスから価値を得る責任を負います。 組織のサービス所有者を設定することが、組織または組織のビジネス目標Microsoft 365実現Office 365重要です。         |
|![チャンピオン アイコン。](media/Create_a_change_management_strategy_for_Microsoft_Teams_image3.png)     |組織全体のすべてのユーザーから購入を得るのは難しい課題です。 **チャンピオン** は、この課題を軽減し、チームやチームの導入において重要Microsoft 365役割Office 365。 知識が豊富で、専門知識の向上に取り組み、ピア コーチングとサポートを提供します。 チームは、Microsoft 365やOffice 365の現実に翻訳するのに役立ちます。         |
...
Microsoft Technical Community サイトの Driving [Adoption](https://techcommunity.microsoft.com/t5/Driving-Adoption/ct-p/DrivingAdoption)コミュニティで、Teams および Microsoft 365 または Office 365 のサービス導入に関する質問を共有します。 お客様の導入について、お客様からご意見をいただくことや、お客様にサポートを提供することができるよう、常に準備を整えております。

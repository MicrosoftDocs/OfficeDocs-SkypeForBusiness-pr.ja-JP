...
1. コミュニティに招待する招待メールを送信し、
2. 早期導入者プログラムの目標と成果を共有するための開始呼び出しをホストします。
3. チームワーク チャンピオン チームのフィードバック チャネルと、使用できるその他の内部ソーシャル ネットワーク ツールに確実にアクセスします。 
4. 対象となる情報を収集する定期的なアンケートを作成して完了することを検討してください。
...
![次の手順を表すアイコン。](media/teams-adoption-next-icon.png) 次へ: [サポートをオンボードします](teams-adoption-onboard-support.md)。

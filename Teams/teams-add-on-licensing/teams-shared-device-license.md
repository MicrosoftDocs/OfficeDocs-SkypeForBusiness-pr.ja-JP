...
sup1 を&します。以前は *電話システム* と呼ばれます。 </br>
sup2 を&します。一般的なエリア電話は、会議の開催者が提供するダイヤルイン番号を使用して、音声会議に参加できます。 </br>
sup3 を&します。クラウドベースのボイスメール機能のみ。

## <a name="teams-shared-devices-license-availability"></a>Teams 共有デバイスライセンスの可用性

**Teams 共有デバイス** ライセンスは、商用、公共セクター、GCC、GCC High、DoD テナントに対して世界中で購入できます。

**Teams 共有デバイス** ライセンスを購入するには、EA、EAS、EES、CSP、Web Direct、NCE - Customer led、NCE - Partner led の任意の購入チャネルを選択できます。
...
次の記事は、 **Teams 共有デバイス** ライセンスを使用するさまざまなデバイスを設定するのに役立ちます。

- [共通領域電話をセットアップする](/microsoftteams/set-up-common-area-phones)
- [Microsoft Teams パネル](/microsoftteams/devices/teams-panels)
- [Microsoft Teams の表示](/microsoftteams/devices/teams-displays)

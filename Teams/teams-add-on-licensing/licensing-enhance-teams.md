...
Teams Premium試用版ライセンスを持つ組織には、ユーザーに割り当てる 25 個のライセンスがあります。 これらの 25 人のユーザーは、使用可能になるとTeams Premium機能を体験してテストできます。 また、管理者は、25 人のライセンスを持つユーザーのTeams Premium機能を管理できます。

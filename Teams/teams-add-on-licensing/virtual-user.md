...
ms.locfileid: "58734196"
---
# <a name="microsoft-365-phone-system--virtual-user-license"></a>Microsoft 365 電話システム – 仮想ユーザー ライセンス

ライセンスを電話システムを持つ組織は、無料の Microsoft 365 電話システム – 仮想ユーザー ライセンスまたは有料のユーザー ライセンスをリソース 電話システムに割り当てできます。 通話プランは必要ありません。 すべての自動応答または通話キューには、関連付けられているリソース アカウントが必要です。 電話番号を必要とするリソース アカウントには、リソース アカウントに電話番号を適用する前に、無料の Microsoft 365 電話システム – 仮想ユーザー ライセンスまたは有料 電話システム ユーザー ライセンスが必要です。
...
組織に割り当Microsoft 365 電話システム – 全体的なサイズに応じて仮想ユーザー ライセンスが割り当てされます。 1 つ以上のライセンスを持つ組織 (電話システム を含む)、または 電話システムが追加された組織には、無料で 25 の仮想ユーザー ライセンスが利用可能です。 組織内のユーザー ライセンスを 10 電話システム追加すると、もう 1 Microsoft 365 電話システム – 仮想ユーザー ライセンスが利用可能になります。

> [!NOTE]
> 電話システムは、Microsoft 365 および E3 でOffice 365 E1ライセンスです。 電話システムは、Microsoft 365 E5、Office 365 E5、Microsoft 365 Business Voiceの一部として含まれます。
...
Contoso, Inc. は、従業員ごとに 1 電話システム含む 600 ライセンスを購入しました。 Contoso には、最初の 25 と 60 Microsoft 365 電話システム – 仮想ユーザー ライセンス (合計 85) が割り当てされます。 組織には、電話番号を含む 90 の通話キューと自動応答があります。 すべての仮想ユーザー ライセンスを割り当Microsoft 365 電話システム、5 つの正規価格のライセンスを取得電話システムがあります。

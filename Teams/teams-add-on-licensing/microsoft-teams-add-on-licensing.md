---
title: Teams アドオン ライセンスのMicrosoft
author: DaniEASmith
ms.author: danismith
manager: serdars
ms.reviewer: mikedav
...
アドオン ライセンスは、特定のMicrosoft Teams 機能のライセンスです。 この機能を使用すると、必要な組織内のユーザーに対してのみ機能を柔軟に追加できます。 機能を追加するには、使用するユーザーごとに 1 つのアドオン ライセンスを購入します。

使用できるアドオン ライセンス オプションは、Microsoft 365 プランによって異なります。 使用できる音声通話と電話会議のオプションを確認するには、この記事の[「プランで使用できるMicrosoft機能](#which-microsoft-capabilities-are-available-with-my-plan)」セクションを参照してください。
...
すべてのMicrosoft 365 プランでは、Teams ユーザーが VoIP テクノロジを使用して組織内でピアツーピア通話を行うことができます。 ただし、PSTN 番号の呼び出しや PBX の設定などの機能について、さまざまなライセンスを追加できます。
...
- Microsoft 365 Business、E1/E3、A1/A3、G1/G3 プランを購入し、**Teams Phone with Calling Plan** バンドル ライセンスを追加します。
  - このモデルでは、Teams 電話システム PBX 機能とMicrosoft国内通話プランが提供されます。
  - すべての電話番号管理と課金をMicrosoftで処理する場合は、この設定を選択します。
...
- E1/E3、A1/A3、G1/G3 プランを購入し、**Teams 電話スタンダード ライセンスを** 追加し、Microsoftスタンドアロン通話プランまたはサードパーティの PSTN 通信事業者を選択します。
...
- E5/A5/G5 プランを購入し、**通話プランMicrosoft** 追加するか、サード パーティの PSTN 接続プロバイダーに接続します。
  - Microsoft 365 E5、A5、G5 の各プランには Teams 電話システムが含まれていますが、組織は引き続き [PSTN 接続オプション](../pstn-connectivity.md)を選択する必要があります。

Microsoft 365 プランに基づいて、購入する音声ライセンスと通話ライセンスMicrosoft概要を次に示します。

<table>
<thead>
<tr class="header">
<th><strong>基本計画</strong></th>
<th><strong>PSTN 通信事業者としてMicrosoftする</strong></th>
<th><strong>サード パーティの PSTN 通信事業者を使用する</strong></th>
</tr>
</thead>
<tbody>
<tr>
<td>Teams Essentials (AAD ID) <br/> <br/>Teams を含む任意のMicrosoft 365 プラン <br/> </td>
...
Microsoftプランの詳細を確認し、組織の種類に応じてガイダンスを取得します。

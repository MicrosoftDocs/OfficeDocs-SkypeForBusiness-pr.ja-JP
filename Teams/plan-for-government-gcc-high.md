...
このガイダンスは、米国連邦政府機関の法人またはその他の法人に Office 365 の展開を推進する IT プロフェッショナルを対象としています。ここでは、Microsoft 365 Government – GCC High の使用が適しています。これらの要件を満たすため。
...
| | クラウド内 (GCCH と GCCH) フェデレーション会議 | 利用可能 |

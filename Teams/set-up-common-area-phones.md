...
6. ライセンスをユーザーに割り当てます。 同じページで、**[製品ライセンス]** をクリックして展開してください。 共通領域電話の電源を入れ、 **国内通話プラン** または **国内および国際通話プラン** を選択します。 
    ...
    ![国内通話プランと国内および国際プランのオプションが強調表示されたライセンス割り当てを示すスクリーンショット](media/set-up-common-area-phone-image2.png)
...
6. [**保存**] をクリックすると、ユーザーが以下のように表示されます。
   ...
   ![ユーザー ライセンスの割り当てのサンプルを示すスクリーンショット](media/set-up-common-area-phone-image3.png)

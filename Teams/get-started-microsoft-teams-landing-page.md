---
title: マイクロソフトのチームで開始します。
description: マイクロソフト チーム チャット、チームとチャネル、および会議の使用を開始するためにチームの最初のいくつかをロールアウトするためには、この規範的なガイダンスを使用します。
layout: LandingPage
...
ms.locfileid: "26215913"
---
# <a name="get-started-with-microsoft-teams"></a>マイクロソフトのチームで開始します。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>クイック スタート</h3>
                        <p>手順を説明する小規模なチームのロールアウト チームについて説明し、組織全体の展開を計画</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>最初のチームとのチャネルを作成します。</h3>
                        <p>最初のチームとチャンネルの設定に関するヒント集</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>オンボードの早期導入</h3>
                        <p>最初のユーザーを作成した新しいチームで実行されているを取得します。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>モニターの使用方法およびフィードバック</h3>
                        <p>早期にチームを使用している方法を参照してください。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>次の場所</h3>
                        <p>チームを組織全体に展開する準備ができたら、紹介する方法</p>
                    </div>
                </div>
            </div>
        </div>

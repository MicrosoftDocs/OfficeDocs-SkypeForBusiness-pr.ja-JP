...
- Microsoft Teams Rooms システムまたは Cloud Video Interop (CVI) サービスを使用して、ビュー専用ルームに参加します。
- オーディオまたはビデオを共有すること。
- 会議チャットを参照または参加すること。
...
- 表示専用の出席者は、"自分のみ"、"組織内のユーザーとゲスト"、"組織内のユーザーと信頼できる組織、およびゲスト"、"すべてのユーザー" というロビー ポリシーでのみサポートされます。 表示専用の出席者をサポートしていないロビー ポリシーを使用している場合、表示専用の出席者は会議から拒否されます。 

...
ms.custom:
- Calling Plans
description: 次の表を使用して、ベルギーでのMicrosoft Teamsの電話番号の取得と管理に関する情報を確認します。

...
電話番号サービス (TNS) サービス デスクと対話する新しいプロセスがあります。 Teams 管理センターと統合された 1 つの場所で、チケットの作成、チケットの表示、コミュニケーションの追跡を行えるようになりました。 この記事では、サービス デスクに問い合わせるために知っておくべきことをすべて説明します。

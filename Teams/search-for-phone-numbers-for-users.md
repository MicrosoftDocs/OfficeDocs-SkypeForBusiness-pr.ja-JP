...
Microsoft が提供する電話番号をユーザーに割り当てる前に、[新しい電話番号の取得] ページを使用して、使用可能な電話番号を検索する必要があります。 国 (市場 **)**、数値の **種類**、場所で検索し、ユーザーに必要な電話番号の数を入力できます。このページでは、まだ取得できる数量に基づいて、数量が自動的に制限されます。 

電話番号の取得方法と管理方法は、PSTN 接続オプション (Microsoft 通話プラン、オペレーター プラン、または直接ルーティング) によって異Connect異なります。 

この記事は、Microsoft 通話プランにのみ適用されます。 すべてのオプションの詳細については、「組織の電話番号を [管理する」を参照してください](/microsoftteams/manage-phone-numbers-landing-page)。


  
## <a name="search-for-telephone-numbers"></a>電話番号を検索する
...
8. [番号 **の取得] ページ** で、必要な電話番号を選択し、[番号の取得] をクリックして、[次へ] を **クリックします**。
    ...
    > [!IMPORTANT]
    > Microsoft ライセンスを持っている電話番号よりも多くの電話番号を取得できます。 取得できる電話番号の数を確認するには、Microsoft 通話プランのライセンス数を取得し、ライセンス数の 10% を追加してから、10 を追加してから、既に取得した電話番号を削除します。 たとえば、100 マイクロソット国内通話プランや **Microsoft** 国際通話プランのライセンスがある場合、100 人のユーザーの電話番号をまだ取得していない場合は、120 の電話番号を予約できます。 詳細については、「取得できる電話番号 [の数」を参照してください。](./how-many-phone-numbers-can-you-get.md)

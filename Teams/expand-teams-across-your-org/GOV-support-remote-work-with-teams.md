...
組織内で Teams を準備する方法について説明します。
  ...
  - 組織で使用を開始する方法については、「**[Teams での会議](https://docs.microsoft.com/MicrosoftTeams/tutorial-meetings-in-teams)**」を参照してください。
...
## <a name="learn-more"></a>詳細情報
  ...
  - Teams を展開して管理する方法については、「**[Teams の管理者向けドキュメント](https://docs.microsoft.com/MicrosoftTeams/)**」を参照してください。

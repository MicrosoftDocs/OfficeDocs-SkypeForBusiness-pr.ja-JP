...
* * *
    ...
    応答: {"resourceType": "バンドル"、"id": "<バンドル id>", "「"」と入力して、「検索」、「集計」、「20」、「入力」の順に入力します。 [{"リソース": {"resourceType": "<" と "id": "リソース id>", "カテゴリ": {"コード": {"コーディング": [{"system": "http://loinc.org", "code": "39156-5", "display": "", "表示": "bmi"} ":" effectiveDateTime ":" 2009-12-01 "," valu"指定した値": {"値": 34.4, "unit": "kg/m2", "システム": "http://unitsofmeasure.org", "code": "kg/m2"}},},}
        .
        .
      ] }

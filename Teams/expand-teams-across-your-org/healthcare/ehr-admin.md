...
- 患者が患者ポータル内または SMS 経由で仮想予定Teams参加できるようにします。
...
EHR ポータルから仮想予定を管理する方法の概要については、このビデオを参照してください。
...
エピックの顧客アナリストは、エピックで仮想予定の構成を完了するために、これらのレコードをエピックに提供する必要があります。 詳細については、[エピック Microsoft Teams Telehealth 統合ガイド](https://galaxy.epic.com/Search/GetFile?Url=1!68!100!100100357)を参照してください。
...
- プロバイダーは、特定の予定の接続と切断を行う参加者のリアルタイムの更新を確認できます。 プロバイダーは、患者がいつ予定に接続されているかを確認できます。
  ...
  ![患者との予定のプロバイダーエクスペリエンス。](media/ehc-provider-experience-6.png)
...
このコネクタは、MyChart Web とモバイルを介して予約に参加する患者をサポートします。 予約の時点で、患者は **[仮想訪問の開始** ] ボタンを使用して MyChart から予定を開始できます。
...
- 患者は、予定に参加する前にロビーでビデオとマイクをテストできます。
  ...
  ![予定の患者エクスペリエンス。](media/ehc-virtual-visit-5.png)

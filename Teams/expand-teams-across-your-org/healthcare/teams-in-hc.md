...
| [Teams ポリシー パッケージ](#teams-policy-packages)| クリニカル ワーカー、情報ワーカー、患者室のデバイスが Teams の機能に適切にアクセスできる状態を確保します。| ユーザーは適切なライセンスを持っている必要があります*。 |
...
また、セキュリティで保護されたメッセージングに関連して、医療組織によってフェデレーションされる他のテナントを持つ機能により、より豊富なテナント間通信が可能になります。 (Microsoft [Teams での外部アクセス (フェデレーション) の管理を参照してください](../../manage-external-access.md))。

## <a name="teams-templates-for-healthcare-organizations"></a>医療組織向け Teams テンプレート

Teams を作成するための新しいテンプレートは病院の設定に適用するために開発され、まもなくその他のテンプレートが期待されます。 これにより、医療従事者がさまざまな部門や部署の患者の治療を調整するために使用するチームを簡単に作成できます。 詳細については、「医療組織向け Teams テンプレートの使用を [開始する」を参照してください](healthcare-templates.md)。 チームは、カーディロジカルなどの内部部門、またはケア ワード用に開始できます。また、開発中のテンプレートも多く提供されています。
...
- 正常性チームのメンバーに電話して、会います。 Teams の音声、ビデオ、画面共有、記録、およびトランスクリプション機能の両方を使用して、個別の会議を設定するか、チャネル会議を使用して毎日の会議を管理します。
...
組織の承認アプリを許可し、チームに追加することができます。 詳細については、「Teams 承認アプリの可用性 [」を参照してください](../../approval-admin.md)。
...
## <a name="help-your-clinical-and-information-workers-get-going-with-teams"></a>臨床および情報の作業者が Teams を使用して作業を行うのを支援する

組織内のすべてのユーザーが Teams の使用に快適に取り組むのに役立つ多くのリソースがあります。

- Teams を [使用して](https://adoption.microsoft.com/microsoft-teams/) 組織の旅を開始する場合、または Teams を組織のより多くの領域に展開する場合は、Teams の導入センターにアクセスして、Teams の展開に関するアドバイスを受けることができます。

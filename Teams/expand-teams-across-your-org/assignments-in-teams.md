...
---
# <a name="assignments-in-teams-for-education"></a>教育のチームの割り当て

チーム、機関、学校作成共同学校の教室、本格的な学習のコミュニティに接続し、学校の職員との通信。 管理リソースを正常に展開し、採用、および、学校のチームを管理するためここで使用します。  

## <a name="assignments-in-the-teams-admin-center"></a>チームの管理センターでの割り当て
...
チーム管理センターの管理者の設定を持つ生徒と教師の側の組織内で利用できる次の機能をオンまたはオフにします。 割り当てに関連する設定は、次のように。
...
画面の指示を実行した後に、TurnitinApiKey が与えられます。 このキーをコピーし、チームの管理ページに貼り付けます。 

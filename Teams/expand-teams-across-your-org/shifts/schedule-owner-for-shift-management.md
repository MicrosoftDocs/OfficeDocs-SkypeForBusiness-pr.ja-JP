...
[所有者のスケジュール] 機能を使用すると、チーム メンバーのアクセス許可を昇格して、従業員をチーム所有者にせずにスケジュールを管理できます。 所有者のスケジュール権限を使用すると、従業員はチーム チャネルの更新、編集、削除などの他のチーム プロパティを変更することなく、チームのスケジュールを管理できます。
...
*スケジュール所有者がいなくても*、部門管理者にはチーム所有者とまったく同じ権限が与えられる必要があります。 最近、部門管理者は情報を移動し、チャネルの名前を変更し、ストア マネージャーの作業に複雑な問題を引き起こしています。 ストア マネージャーは、部門マネージャーがスケジュールを整理できる必要がありますが、シフト以外のチームで他の変更を行うのを望んでいません。

*スケジュール所有者を* 使用すると、他のチーム所有者特権を持たなくても、部門マネージャーにスケジュール権限を付与できます。

...
> [!NOTE]
> Teams 管理センターで移植プロセスに問題が発生した場合は、手動で TNS サービス デスクに [ポート注文を送信](manually-submit-port-order.md) できます。 手動でポート注文を送信する必要があるフォームを取得するには、[ [組織の電話番号の管理](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md)] のドロップダウン リストで国または地域を選択します。

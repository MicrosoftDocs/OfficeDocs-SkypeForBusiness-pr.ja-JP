...
7. アプリをピン留めするには、次の手順を実行します。
    ...
    3. アプリを Teams に表示する順序で並び、[保存] を選択 **します**。
...
管理ピンは常に優先されます。 [ユーザーの **ピン留め** を許可する] オプションがオンになっている場合、ユーザーは、管理者ピン留めされたアプリの下にピン留めされたアプリを保持します。 [ユーザー **の** ピン留めを許可する] オプションがオフになっていると、ユーザーは既存のピンを失い、管理者がピン留めしたアプリだけがアプリ バーに表示されます。

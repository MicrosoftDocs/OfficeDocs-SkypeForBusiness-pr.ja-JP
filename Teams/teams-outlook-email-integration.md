...
ユーザーは、チーム内の不在着信した会話を把握するのに役立つ、利用可能な不在時のメールを自動的に取得します。 [不在時のアクティビティ] メールには、不在着信メッセージの後に送信されたメッセージなど、スレッドからの最新の返信が表示されます。ユーザーは [ **返信** ] をクリックして、Outlook 内から直接返信することができます。 詳細については、「 [Outlook からの不在時のメールに返信する](https://support.office.com/article/reply-to-missed-activity-emails-from-outlook-bc0cf587-db26-4946-aac7-8eebd84f1381)」を参照してください。 

> [!NOTE]
> この機能は、Outlook for Mac または古いバージョンの Outlook for Windows ではサポートされていません。 詳細については、「 [Outlook および Office 365 グループで](https://docs.microsoft.com/outlook/actionable-messages/)操作できるメッセージ」を参照してください。

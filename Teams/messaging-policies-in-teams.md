...
- **開封確認** 開封確認メッセージを使用すると、1:1 で受信者がメッセージを読み取り、グループ チャットが 20 人以下になったときに、チャット メッセージの送信者に通知を受け取ります。 メッセージ読み取りメッセージは、メッセージが読み取られたかどうかに関する不確かさを取り除き、チームのコミュニケーションを改善します。 開封確認は電子情報開示レポートにキャプチャされません。  

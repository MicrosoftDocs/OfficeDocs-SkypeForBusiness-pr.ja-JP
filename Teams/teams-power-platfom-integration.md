...
- アプリとサービスの間に自動化されたワークフローを作成して、ファイルの同期、通知の取得、データの収集など、 を使用 **Power Automate。**
...
- アプリケーションのライセンス要件の詳細については、「要件」Power BI[を参照してください](/power-bi/collaborate-share/service-collaborate-microsoft-teams)。

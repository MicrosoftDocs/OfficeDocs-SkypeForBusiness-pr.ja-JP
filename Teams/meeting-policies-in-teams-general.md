...
このポリシーは既定でオフになっています。開催者は、設定した会議やウェビナーを誰が登録して参加したのか確認できます。 管理センターでこれを有効Teams、[会議会議ポリシー] に移動し、[エンゲージメント レポート] 設定を [有効]  >  に **設定します**。 
...
- 匿名 **Whoを** 含むすべてのユーザーが、組織内のユーザーが設定したウェビナーの登録と参加を許可する場合は、[すべてのユーザー] に登録できます。

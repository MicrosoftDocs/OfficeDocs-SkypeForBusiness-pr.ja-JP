...
|  **チーム名/説明の編集**   |    あり     |     いいえ      |
|          **チームを削除する**          |    あり     |     いいえ      |
|          **標準チャネルを追加する**          |    はい     |    Yes<sup>2</sup>|
| **標準チャネルの名前と説明を編集する** |    はい     |    Yes<sup>2</sup>|
|        **標準チャネルを削除する**         |    はい     |    Yes<sup>2</sup>|
|          ***プライベートチャネルを追加する**          |    はい     |    Yes<sup>2</sup>|
| ***プライベートチャネルの名前と説明を編集する** |    いいえ     |    該当なし|
|        ***プライベートチャネルを削除する**         |    あり     |    いいえ|
...
* プライベートチャネルの権限の詳細については、「 [Teams のプライベートチャネル](private-channels.md)」を参照してください。

...
Microsoft 365 または Office 365 で電話会議を設定および構成する場合、発信者が Skype for Business または Microsoft Teams 会議にダイヤルインするときに使用される第 1 言語と第 2 言語 (最大 4 言語) を選択できます。 電話会議でサポートされている言語の一覧を示します。 

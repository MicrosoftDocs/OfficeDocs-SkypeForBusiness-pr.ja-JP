...
組織全体のチームが作成されると、すべてのグローバル管理者と Teams サービス管理者がチーム所有者として追加され、すべてのアクティブ ユーザーがチーム メンバーとして追加されます。 ライセンス未付与のユーザーもチームに追加されます。 ライセンスのないユーザーが初めて Teams にサインインすると、ユーザーには Exploratory ライセンスMicrosoft Teams割り当てられます。 探索的ライセンスの詳細については、「探索的ライセンスの管理[」をMicrosoft Teamsしてください](teams-exploratory.md)。 

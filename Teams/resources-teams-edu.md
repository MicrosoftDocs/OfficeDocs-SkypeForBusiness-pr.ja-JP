...
これらの資料を使用 [する前に、条件を](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/license_agreement_teams_for_education.pdf?raw=true) お読みください。

### <a name="physical-assets"></a>現物資産
...
チームを最大限に活用するには、必ず [デジタルツールキットのガイダンス](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/digital-toolkit-guidance.zip?raw=true) を確認してください。 

|  |  |
|---------|---------|
|[メールテンプレート](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/email-templates.zip?raw=true)<br> ![とる](media/edu-adoption-email-templates.png)    |[Gif](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/gifs.zip?raw=true) <br> ![GIF のスクリーンショット](media/edu-adoption-gifs.png)      |
|[Web バナー](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/web-banners.zip?raw=true)<br>![Web バナーのスクリーンショット](media/edu-adoption-web-banners.png)    |[ビデオ](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/videos.zip?raw=true)<br>![とる](media/edu-adoption-videos.png)          |
|[デジタルスクリーン広告](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/digital-screen-adverts.zip?raw=true)<br>![デジタルスクリーンの広告のスクリーンショット](media/edu-adoption-digital-screen-adverts.png)   |      |

## <a name="call-to-action"></a>実施すべき内容

- トレーニング、ビデオ、対話型デモについては、「 [教育機関向けのチーム」ページ](https://www.microsoft.com/en-us/education/products/teams/default.aspx) を参照してください。
- [Microsoft 365 管理センター](https://portal.office.com/adminportal/home#/Settings/ServicesAndAddIns)で Teams を有効にする (Office 365 管理者としてサインインする)

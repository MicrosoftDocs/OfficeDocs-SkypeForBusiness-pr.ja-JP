...
|開催者: **オン**<br><br>参加者: **オフ** |参加者: **送信ビデオと受信ビデオが有効**         |**IP ビデオ設定** が優先されます。 参加者は、受信ビデオのみを見ることができ、ビデオの送信はできません。         |
|開催者: **オン**<br><br>参加者: **オフ** |参加者: **無効**         |**IP ビデオのモード** 設定が優先されます。 参加者には、受信または送信ビデオが表示されません。|
|開催者: **オフ**    |       |**IP ビデオ設定** は、開催者に対してオフになっているため、優先されます。 このポリシーが割り当てられているユーザーによって開催される会議では、誰もビデオをオンにすることはできません。         |
...
|会議の参加者に対してオーディオとビデオを有効にする    |IP オーディオ用モード: **オーディオの送受信が有効** (既定)<br> IP ビデオ用モード: **ビデオの送受信が有効** (既定)<br>IP ビデオ: **オン** (既定)    |
...
モバイル クライアントTeamsユーザーの場合、会議中に写真やビデオを共有する機能は **、IP** ビデオまたは IP ビデオ モードの設定 **によっても決定** されます。 優先されるポリシー設定によっては、ビデオや写真を共有する機能を利用できません。 これは、画面の共有には影響しません。「[スクリーン共有モード](meeting-policies-content-sharing.md#screen-sharing-mode)」設定を使用して別個に構成します。 また、モバイル ユーザーが携帯電話接続を介して IP ビデオを使用できないように、[Teams モビリティ ポリシー](/powershell/module/skype/new-csteamsmobilitypolicy) を設定できます。これは WiFi 接続を使用する必要があること意味します。
...
テナントごとに使用するカスタム背景イメージを追加できます。 この機能により、企業は企業のブランドを会議にTeamsできます。
...
会議の出席者には、会議に出席するときに使用できる背景画像の選択が表示されます。

> [!NOTE]
> 変更が有効にな最大 24 時間かかる場合があります。

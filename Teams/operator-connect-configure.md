...
1. オペレーターに問い合わせ、番号をオペレーターに移植Connect。 オペレーター [Microsoft 365の web Connectを見つけるには、](https://cloudpartners.transform.microsoft.com/practices/microsoft-365-for-operators/directory)オペレーターのディレクトリに関するページを参照してください。

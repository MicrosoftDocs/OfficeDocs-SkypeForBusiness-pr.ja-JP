...
Microsoft Teams 4.x.x シリーズ以降の PowerShell モジュール (TPM) バージョンのみが現在サポートされています。 以前のすべてのバージョンは、2022 年 6 月 15 日以降完全に廃止&動作を停止します (参照用のメッセージ センターポスト - MC350371)。 

PowerShell モジュールの最新バージョンTeams更新することをお勧めします。
...
- 関連する変更
  - TPM 3.x.x 以降でのGet-CsOnlineUser & Get-CsOnlineVoiceUserの更新 – [Get-CsOnlineUser](/powershell/module/skype/get-csonlineuser) & [Get-CsOnlineVoiceUser](/powershell/module/skype/get-csonlinevoiceuser) (メッセージ センターポスト – MC340774) の詳細。

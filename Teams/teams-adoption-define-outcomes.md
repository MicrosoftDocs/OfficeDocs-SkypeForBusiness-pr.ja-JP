...
- **チームの設定を選ぶ**: 新しい Microsoft 365 または Office 365 の顧客組織では、新しいテクノロジを複数回学習することによって生じた変更の疲労を最小限に抑えるため、多くの場合、チームの大きなアプローチを取ることをお勧めします。 主要なコラボレーションと会議、SharePoint、OneDrive、Planner、その他のワークロードの両方について Teams を有効にすると、チームの展開のコンテキストで従業員がそのことを知ることができるので、最大のメリットが得られます。 
...
ベストプラクティス: カスタムソリューションの開発を検討する前に、組織が Microsoft 365 または Office 365 の既定の機能を完全に使用していることを確認してください。 カスタムソリューションの開発は、IT とサポート部門にとって長期的な料金を常に負担しています。
...
![次の手順を示すアイコン ](media/teams-adoption-next-icon.png) :[フィードバックの最適化とレポート](teams-adoption-optimize-feedback-and-reporting.md)

...
![4つの結果カテゴリ](media/teams-adoption-outcomes.png)
...
![商の変更](media/teams-adoption-change-quotient.png)
...
![判断ポイント アイコン。](media/teams-adoption-decision-icon.png) 決定: Microsoft Teams のビジネスの成果を最大限にサポートし、テクニカル実装チームが有効にできる有効化戦略を選択します。 これは、IT 主導、プログラム管理のリーダー、ユーザー導入の専門家の間での共同での意思決定です。 この決定は、多くの場合、Microsoft Teams または組織内のコラボレーションサービスの最終的な成功の所有者である役員関係者になります。
...
![判断ポイント アイコン。](media/teams-adoption-decision-icon.png) 決定: 会社の文化と連携して、関係者と通信するためのリズムと方法を決定します。 組織全体で、さまざまなレベルの契約と関心をお客様に伝えます。 
...
![大規模企業導入チームモデル](media/teams-adoption-large-scale-model.png)
...
![次の手順](media/teams-adoption-next-icon.png)のアイコン:[フィードバックとレポートの最適化](teams-adoption-optimize-feedback-and-reporting.md)

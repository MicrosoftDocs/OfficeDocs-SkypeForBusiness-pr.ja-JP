...
Teams の通話フローは、HTTPS 経由の [セッション記述プロトコル (SDP) RFC 8866](https://datatracker.ietf.org/doc/html/rfc8866) オファーと応答モデルに基づいています。 呼び出し先が着信呼び出しを受け入れると、呼び出し元と呼び出し先はセッション パラメーターに同意します。

...
- GCC高: 電話会議 - 組織GCC電話会議の高テナント ライセンス - GCCユーザーの高ライセンス。
...
> [!IMPORTANT]
> ダイヤルイン電話番号が設定されるまで、ユーザーは直接ルーティングを使用した電話会議を有効にすることはできません。 この記事で説明するダイヤルイン電話番号を設定するまで、GCC High ライセンスまたは DoD ライセンスの直接ルーティングを使用した電話会議をユーザーに割り当てないでお勧めします。  このガイダンスに従う必要が生じない場合は、クライアントでダイヤル パッドが完全にTeamsがあります。
...
組織の電話会議番号の一覧を表示するには、「電話会議の電話番号の一覧を表示する」を参照[Microsoft Teams。](see-a-list-of-audio-conferencing-numbers-in-teams.md)
...
- 名前の記録を使用して通知を開始および終了します。 直接ルーティングを使用した電話会議では、会議の入退出通知がトーンとして再生されます。

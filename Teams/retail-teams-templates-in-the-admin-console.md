...
---
# <a name="use-teams-retail-templates-in-the-admin-center"></a>管理センターで Teams 小売用テンプレートを使用する
...
## <a name="organize-a-store"></a>ストアを整理する
...
## <a name="manager-collaboration"></a>上司との共同作業

...
|パラメーター  |ワークステーションのオペレーティング システム  |サーバーのオペレーティング システム  |
|---------|---------|---------|
...
DisallowCalling 通話ポリシーおよび AllOff 会議ポリシーをユーザーに割り当てるには、次の手順を実行します。
...
AllowCalling 通話ポリシーおよび AllOn 会議ポリシーをユーザーに割り当てるには、次の手順を実行します。

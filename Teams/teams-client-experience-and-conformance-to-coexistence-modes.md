...
audience: admin
description: Teams クライアントのエクスペリエンスと共存モードへの準拠 (SfBOnly、SfBWithTeamsCollab、SfBWithTeamsCollabAndMeetings) について説明します。
...
プレゼンスはチャットと通話を通じて到達可能性を示すため、チャットと通話が無効になっていると、Teams での自己プレゼンス (つまり、ユーザーの画像内の Teams クライアントでの自分のプレゼンスの表示) も非表示になります。 
...
![Teams モードの並べて比較。](media/teams-mode-comparison.png)

...
- **VoIP 通話と PSTN への転送Teams 1:1 の場合** は、次の点に注意してください。
  ...
  - 転送が許可されるかどうかは、次に基づいています。
    ...
    - 転送された呼び出しを受信したユーザーのLocation-Basedルーティング設定。
    - エンドポイント ネットワーク サイトの場所。
    - 場所が Location-Based ルーティングに対して有効になっているかどうか。

    転送された通話を受信したユーザーが、同じ PSTN ゲートウェイを使用してその PSTN 通話を現在の場所で行うことができる場合、転送が許可されます。
...
次の表は、Location-Based ルーティングが、通話を PSTN エンドポイントに転送または転送する異なる場所のユーザーに対して、Site1 で User1 から VOIP 通話のルーティングに影響を与える方法を示しています。  

|通話の転送または転送を開始するユーザー  |PSTN に転送する  |PSTN に転送する  |
|---------|---------|---------|
|同じネットワーク サイト、Location-Based ルーティングが有効なサイト (User2)   |通話転送は、User2 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます         |転送は、User2 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。         |
|異なるネットワーク サイト、Location-Based ルーティングが有効なサイト (User3)    |通話転送は、User3 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。         |転送は、User3 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。         |
|異なるネットワーク サイト、Location-Based ルーティングに対してサイトが有効になっていない (User4)    |通話転送は、User4 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。         |転送は、User4 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。         |
|不明な内部ネットワーク (User5)     |通話転送は、User5 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。         |転送は、User5 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。         |
|不明な外部ネットワーク (User6)   |通話転送は、User6 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。        |転送は、User6 の音声ルーティング ポリシーに基づいて、Site1 でルーティングが有効なゲートウェイ 1 Location-Based経由でのみルーティングできます。         |
...
次の表は、サイト 1 にある User1 から PSTN 番号に同時リングが設定された異なる場所のユーザーへの受信 VoIP 通話のルーティング動作をLocation-Based示しています。 

|呼び出されたユーザー エンドポイントの場所  |同時リング ターゲットは PSTN エンドポイントです |
|---------|---------|
|同じネットワーク サイト、Location-Based ルーティングが有効なサイト (User2)    |通話は、User2 の音声ルーティング ポリシーに基づいて、Site1 のルーティング ゲートウェイ 1 Location-Based経由でのみルーティングできます。       |
|Location-Based ルーティングに対して有効になっている別のネットワーク サイト (User3)    |呼び出しは、User3 の音声ルーティング ポリシーに基づいて、Site1 のルーティング ゲートウェイ 1 Location-Based経由でのみルーティングできます。        |
|Location-Based ルーティングに対して異なるネットワーク サイトが有効になっていない (User4)    |通話は、User4 の音声ルーティング ポリシーに基づいて、Site1 のルーティング ゲートウェイ 1 Location-Based経由でのみルーティングできます。         |
|不明な内部ネットワーク (User5)    |呼び出しは、User5 の音声ルーティング ポリシーに基づいて、Site1 のルーティング ゲートウェイ 1 Location-Based経由でのみルーティングできます。         |
|不明な外部ネットワーク (User6)   |呼び出しは、User6 の音声ルーティング ポリシーに基づいて、Site1 の Location-Based ルーティング ゲートウェイ 1 経由でのみルーティングできます         |

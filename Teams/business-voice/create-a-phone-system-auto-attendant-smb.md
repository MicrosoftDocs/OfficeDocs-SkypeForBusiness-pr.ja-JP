...
> [手順 2 - 自動応答の一般的な>](/microsoftteams/business-voice/create-a-phone-system-auto-attendant-smb?tabs=general-info#steps)
...
> [!div class="nextstepaction"]
> [手順 3 - コール フロー >](/microsoftteams/business-voice/create-a-phone-system-auto-attendant-smb?tabs=call-flow#steps)
...
> [!div class="nextstepaction"]
> [手順 5 - 休日のコール フロー >](/microsoftteams/business-voice/create-a-phone-system-auto-attendant-smb?tabs=holidays#steps)
...
> [!div class="nextstepaction"]
> [手順 7 - リソース アカウントを割り当>](/microsoftteams/business-voice/create-a-phone-system-auto-attendant-smb?tabs=resource-accounts#steps)

...
ms.locfileid: "58582481"
---
# <a name="step-5-assign-business-voice-phone-numbers-to-your-users"></a>手順 5: Business Voice の電話番号をユーザーに割り当てる

ユーザーが通常の電話回線Teams通話を送受信するには、ユーザーに電話番号を割り当てる必要があります。 このMicrosoft Teamsユーザーに割り当てる電話番号は、ユーザーが [通話] をクリックすると、ダイヤル パッドに表示 **されます**。 電話番号が必要なユーザーごとに、次の操作を行います。
...
1. [番号 **電話] ページ** で、一覧で未割り当て番号を選択し、[編集] を **クリックします**。  

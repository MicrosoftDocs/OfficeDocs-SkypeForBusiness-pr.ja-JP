...
- **ファイアウォールを開き、Microsoft 365をTeams。** ネットワークのファイアウォールを開き、Microsoft 365 URL と IP アドレスTeamsに関するページで説明Office 365トラフィック[を送信および送信します](/microsoft-365/enterprise/urls-and-ip-address-ranges)。
...
4. SIP デバイスで、登録機能コードに続いて確認コードをダイヤルします。 たとえば、登録機能コードが 55* で、確認コードが有効123456場合は、55 123456にダイヤルしてデバイス \* \* \* を登録します。
...
SIP ゲートウェイは IPv4 のみをサポートします。 Microsoft Teamsとクライアントは、IPv4 と IPv6 の両方をサポートします。 グループへの通信を制御する場合Microsoft Teams URL と IP アドレス範囲で IP [Microsoft 365を使用します](/microsoft-365/enterprise/urls-and-ip-address-ranges)。

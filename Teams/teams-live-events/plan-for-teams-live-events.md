...
>
> さらに、最大 10 万人の参加者がいるライブイベントを、MIcrosoft 365 のライブイベント支援プログラムを通じて計画できます。 チームは各要求を評価し、お客様と協力して利用可能なオプションを決定します。 [詳細情報を参照してください](https://aka.ms/Stream/Blog/LiveEventOptions)。 

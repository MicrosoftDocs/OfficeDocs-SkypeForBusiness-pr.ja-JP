...
ms.locfileid: "44665189"
---
# <a name="what-are-cloud-auto-attendants"></a>クラウドの自動応答とは

電話システムは自動応答機能を提供します。これを使用すると、外部および内部の発信者がメニューシステムを介して、組織内のユーザーや部署への通話を検索して、その場所に移動することができます。
...
電話システムの自動応答を設定するには、「[クラウド自動応答](create-a-phone-system-auto-attendant.md)をセットアップする」を参照してください。

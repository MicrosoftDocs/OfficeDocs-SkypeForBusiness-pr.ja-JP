...
チーム所有者は、Microsoft Teams でチーム全体の設定を直接管理できます。 [設定] には、チームの画像を追加したり、チームメンバー間で標準および[プライベートチャネル](private-channels.md)を作成するためのアクセス許可を設定したり、タブとコネクタの追加、チームまたはチャネル全体の @mentioning、gif、ステッカー、ミームの使用などを行うことができます。

...
ライブ トランスクリプションでは、Teams 会議中の音声テキスト変換がほぼリアルタイムで表示されます。 テキストは、発表者の名前やタイム スタンプなど、会議ビデオの一緒に表示されます。 詳細については、「Teams 会議でライブ [トランスクリプションを表示する」を参照してください](https://support.microsoft.com/office/view-live-transcription-in-a-teams-meeting-7a1401ec-73b4-431d-875a-8b6af82b3e15)。

...
Daniela は、彼女が開催者だった場合でも、ポリシーがオフに設定されているので記録できません。 ポリシー設定を有効にしている Amanda は、Daniela が開催した会議でも会議を記録できます。 Amanda が会議を開催すると、その会議を記録することができますが、ポリシー設定が無効になっている Daniela と、外部ユーザーである John は、その会議を記録できません。

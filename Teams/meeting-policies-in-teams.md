...
トランスクリプションを許可するポリシーはユーザーごとのポリシーです。 この設定では、このユーザーの会議を文字起こしできるかどうかを制御します。

:::image type="content" source="media/live-transcription.png" alt-text="トランスクリプション オプションを示すスクリーンショット":::
現在、記録された会議の議事書きは、Teams で言語が英語に設定されているユーザーと、会議で英語が話されている場合にのみサポートされます。

ライブ トランスクリプションでは、会議中に音声コンテンツの音声テキストがほぼリアルタイムで表示されます。 テキストは、発表者の名前やタイム スタンプなど、会議ビデオの一緒に表示されます。 詳細については、「Teams 会議でライブ [トランスクリプションを表示する」を参照してください](https://support.microsoft.com/office/view-live-transcription-in-a-teams-meeting-7a1401ec-73b4-431d-875a-8b6af82b3e15)。
...
|---------|---------|---------|
|**オン**|**オン**|[ **トランスクリプションの** 開始] オプションは会議で使用できます。 会議の開催者または会議の参加者は、議事の開始と停止を行います。 [ **レコーディングの開始]** オプションは会議で使用できます。 会議の開催者または会議の参加者は、記録を開始および停止できます。 |
|**オン**|**オフ**|[ **トランスクリプションの** 開始] オプションは会議で使用できます。 [ **レコーディングの開始** ] オプションは、会議では使用できません。 |
|**オフ**|**オン**|[ **レコーディングの開始]** オプションは会議で使用できます。 [ **トランスクリプションの** 開始] オプションは、会議では使用できません。|
|**オフ**|**オフ**|レコーディングとトランスクリプションは会議では使用できません。  |

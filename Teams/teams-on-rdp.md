...
現在、Teamsとチャット機能のサポートを利用して、リモート デスクトップ サービス環境での共有を利用できます。 最適なユーザー エクスペリエンスを確保するには、この記事のガイダンスに従ってください。
...
3. [設定 **の編集]** を選択し、必要な変更を加え、[適用] を **選択します**。

または、次の手順を実行できます。

1. Microsoft Teams 管理センターの左側のナビゲーションで、割り当てるポリシーに移動します。 次に例を示します。

    - **[VoiceCalling** >  **ポリシー] に移動し**、[**DisallowCalling] を選択します**。
    - [ **会議** > **][会議ポリシー] に移動し、[** すべてオフ] **を選択します**。

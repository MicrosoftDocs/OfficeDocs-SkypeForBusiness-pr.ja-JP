...
ユーザーは、ベトナムのローカルブランチ オフィスに割り当てられ、オンプレミスで、Teams経由で直接ルーティング電話を発信します。
...
![トラフィック フローのローカル メディア最適化を再び示す図。](media/direct-routing-media-op-3.png "Traffic flow in proxy SBC with connected downstream SBC with connected Downstream SBC when user is in the &quot;home&quot; network")

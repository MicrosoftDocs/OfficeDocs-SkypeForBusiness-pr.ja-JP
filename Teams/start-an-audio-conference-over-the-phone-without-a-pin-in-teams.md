---
title: デバイスで PIN を使用せずに電話で電話会議を開始Teams
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.reviewer: oscarr
...
Microsoft Teams 会議の開催者が会議を開始しないので、会議にダイヤルインするユーザーが会議のロビーで音楽を聴いていると、いら立つ場合があります。 

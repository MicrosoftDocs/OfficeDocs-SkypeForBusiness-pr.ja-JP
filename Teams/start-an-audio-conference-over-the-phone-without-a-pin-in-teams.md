...
Microsoft Teams 会議の開催者が会議を開始しないので、会議にダイヤルインするユーザーが音楽を聴いて会議のロビーで開催されるのは、不満な場合があります。 

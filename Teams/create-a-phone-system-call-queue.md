...
> [!NOTE]
> ID の呼び出しに使用されるリソース アカウントには、仮想Microsoft 365 電話システムライセンスが割り当てられている必要があります。
>
...
> 
> プレゼンス ベースのルーティングSkype for Business有効になっている場合、クライアントを使用するエージェントは、呼び出しルーティング リストに含まれません。 このサービスを使用するエージェントSkype for Business、プレゼンス ベースの呼び出しルーティングを有効にすることはできません。

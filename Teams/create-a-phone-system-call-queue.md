...
> [!TIP]
> **プレゼンス ベースのルーティング** を **オンに** 設定することをお勧めします。
...
> [!TIP]
> **エージェントのアラート時間** を最小 **20 秒** に設定することをお勧めします。
...
- **エージェントのアラート時間:** **20 秒** 以上

### <a name="call-queue-feature-compatibility"></a>通話キュー機能の互換性

|機能                          |Teams Desktop<sup>1</sup> |Teams Web | Teams Mobile<sup>2</sup> |Skype for Business |IP 電話 | 標準呼び出しキュー |チャネル ベースの呼び出しキュー | コメント |
|:--------------------------------|:------------------------:|:--------:|:--------------:|:---:|:--------:|:--------------------:|:------------------------:|:--------|
|**エージェント ルーティング方法**        |                          |          |                |     |          |                      |                          |   |

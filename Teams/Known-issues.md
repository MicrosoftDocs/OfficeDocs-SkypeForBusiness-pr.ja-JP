...
|**問題のタイトル**|**動作 / 症状**|**既知の回避策**|**発見日**|
|:-----|:-----|:-----|:-----|
|すべての URL の URL のプレビューが表示されないことが  <br/> |いくつかの URL では、プレビューは表示されませんがあります。  これは、プレビューを表示する権限を持つ元の URL に依存します。 <br/> |回避策なし。 <br/> |9/1/18 <br/> |
...
|**問題のタイトル**|**動作 / 症状**|**既知の回避策**|**発見日**|
|:-----|:-----|:-----|:-----|
|ブロードキャストのミーティング中にコンテンツを共有している間は出ない  <br/> |(Youtube のリンクまたは保存されているビデオ ファイル) は、共有のコンテンツからのオーディオのブロードキャストの会議の中でコンテンツを共有することはできませんが参加者が再生されます。  <br/> |仕様では、次のように [なし] です。  チームは、コンテンツの共有からのオーディオを現在サポートしていません  <br/> |10/9/18  <br/> |

...
ローカル メディアの最適化を構成するには、次の手順が必要です。 Teams 管理 センターまたは PowerShell を使用できます。 詳細については、「 [ネットワーク トポロジの管理」を参照してください](manage-your-network-topology.md)。

...
|            |  SBC 7000         | 8.2  |
|            |  SBC SWe          | 8.2  |
| [リボンの SBC エッジ](https://support.sonus.net/display/UXDOC81/Microsoft+Teams+Direct+Routing+-+On+Premises+Deployment)  |  SBC 1000         | 8.1.1、ビルド527 |
|            |  SBC 2000         | 8.1.1、ビルド527 |
|            |  SBC SWe Lite     | 8.1.0、ビルド222 |

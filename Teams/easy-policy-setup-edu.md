...
1. 新しいアカウントを作成する場合Teamsウィザードが自動的に起動します。 それ以外の場合は、ダッシュボードからいつでもウィザードを開始できます。 Microsoft Teams 管理センターの左側のナビゲーションで、[ホーム] に移動し、[安全な学習環境の簡単なポリシー設定] タイルで、[クイック セットアップ]**を選択します**。

...
> [!NOTE]
> 管理者の場合は、オプションの接続エクスペリエンスを使用するユーザーの権限を制限する方法については、[プライバシーコントロールの管理](https://docs.microsoft.com/deployoffice/privacy/manage-privacy-controls)の記事を参照してください。
...
- [Microsoft 365 Apps for enterprise のプライバシー コントロールの概要](https://docs.microsoft.com/deployoffice/privacy/overview-privacy-controls)
- [Teamsのポリシーコントロールの概要](policy-control-overview.md)
- [プライバシーと Microsoft Teams](teams-privacy.md)
- [Office の必要なサービス データ](https://docs.microsoft.com/deployoffice/privacy/required-service-data)

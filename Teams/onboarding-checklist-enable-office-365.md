...
|----|-----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1  | 組織をMicrosoft 365またはOffice 365する| 組織が組織の利点を利用するには、Teamsまたは組織にMicrosoft 365するOffice 365があります。 組織の管理者または組織がMicrosoft 365場合Office 365、[追加情報] 列のガイダンス **を参照** してください。 | | [一Microsoft 365またはOffice 365を設定する](https://support.office.com/article/Set-up-Office-365-for-business-6a3a29a0-e616-4713-99d1-15eda62d04fa) <br/><br/>[追加のサポートが必要な場合は、Microsoft FastTrack または Microsoft 365 チームOffice 365サポートを受けてください。](https://fasttrack.microsoft.com/office) |
| 2  | ライセンスMicrosoft 365またはOffice 365購入する | Teams Envision フェーズで行った作業の結果に基づいて、調達グループと作業して、組織が必要なライセンス SKU またはアドオン サービスを購入し、テナントに割り当てる準備ができていることを確認します。 | | [Microsoft Teamsの説明](/office365/servicedescriptions/teams-service-description) <br/><br/>[Microsoft 365 または Office 365 for Business サブスクリプションのライセンスを購入する](https://support.office.com/article/Buy-licenses-for-your-Office-365-for-business-subscription-36081d8d-b3fa-4948-8c34-e217bba825e1) |
...
| 9  | 通話品質ダッシュボード (CQD) にサインインし、建物情報をアップロードします。 | すべてのTeamsデプロイでは、CQD を活用して、CQD を使用するすべての呼び出しの品質と信頼性に関する分析情報をTeams。 <br><br>[追加情報] 列に記載されている CQD ガイダンスを使用して、このツールのメリットを最も高くします。  | | [サービス管理と品質の計画](./prepare-network.md) <br/><br/>[品質エクスペリエンスのレビュー ガイド](./quality-of-experience-review-guide.md) <br/><br/>[品質エクスペリエンス レビュー テンプレート](https://aka.ms/qertemplates) <br/><br/>[通話品質ダッシュボードをオンにして使用して、Microsoft TeamsオンラインSkype for Businessする](https://support.office.com/article/Turning-on-and-using-Call-Quality-Dashboard-for-Microsoft-Teams-and-Skype-for-Business-Online-553fa13c-92d2-4d5c-a3d5-41a073cb047c)<br><br>[アップロード情報](/SkypeForBusiness/using-call-quality-in-your-organization/turning-on-and-using-call-quality-dashboard#upload-building-information) |

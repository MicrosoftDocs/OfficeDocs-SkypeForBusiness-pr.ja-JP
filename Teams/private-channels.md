...
|---------|---------|---------|---------|
|はい      |はい         |Yes         |既存のチームでプライベート チャネルを作成するか、トピックごとに専用のプライベート チャネルを作成することを検討してください。         |
|はい     |必要         |不要         |既存のチームにプライベート チャネルを作成します。         |
|はい     |いいえ         |いいえ         |既存のチームにチャネルを作成します。         |
|いいえ     |いいえ         |いいえ         |新しいチームの作成を検討してください。         |
|いいえ     |×         |はい         |新しいチームの作成を検討し、そして各トピックの機密性に応じて、トピックごとに個別の標準またはプライベート チャネルの作成を検討してください。         |
|×     |はい         |いいえ         |新しいチームを作成し、プライベート チャネルを作成することを検討してください。         |
...
規定では、チーム所有者またはチーム メンバーがプライベート チャネルを作成できます。 ゲストは作成できません。 プライベートチャネルを作成する機能は、チームレベルと組織レベルで管理できます。

 1. <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">https://admin.microsoft.com</a> で管理センターにアクセスします。

 2. [ポリシー](teams-policies.md)を使用して、プライベートチャネルを作成できる組織内のユーザーを制御します。
    ポリシーを設定すると、チームの所有者は、チームの [**設定**] タブでメンバーがプライベートチャネルを作成する機能をオフまたはオンにすることができます。
...
|---------|---------|---------|---------|---------|---------|---------|
|プライベート チャネルを作成する|はい<sup>1</sup>|はい<sup>1,2</sup>|X|該当なし|該当なし|該当なし|
|プライベート チャネルを削除する|はい|不要|×|はい|不要|いいえ|
|プライベート チャネルを脱退する|該当なし|該当なし|該当なし|はい<sup>3</sup>|はい|はい|
|プライベート チャネルを編集する|X|該当なし|該当なし|はい|不要|いいえ|
|削除されたプライベート チャネルを復元する|はい|不要|×|あり|不要|いいえ|
|メンバーを追加する|X|該当なし|該当なし|はい|不要|いいえ|
|編集を設定する|X|該当なし|該当なし|はい|不要|いいえ|
|タブとアプリを管理する|X|該当なし|該当なし|はい<sup>4</sup>|はい<sup>5</sup>|いいえ|

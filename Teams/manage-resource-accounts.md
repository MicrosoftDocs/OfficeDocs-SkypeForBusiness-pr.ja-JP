...
1. サービス番号を取得します。
2. リソースアカウントを作成します。 関連付けられているリソースアカウントを持つには、自動応答または通話キューが必要です。
3. 電話システムまたは電話システムの仮想ユーザーライセンスを取得します。
4. 国内または国際通話プランを購入します。
5. 電話システムまたは電話システムの仮想ユーザーライセンスをリソースアカウントに割り当てます。
6. 通話プランのライセンスをリソースアカウントに割り当てます。
7. 通信クレジットのライセンスをリソースアカウントに割り当てます。
8. 通信クレジットを設定して、組織の自動再充電を設定します。
9. ライセンスを割り当てたリソースアカウントにサービスの電話番号を割り当てます。
10. 電話システムサービス (通話キューまたは自動応答) を作成します。
11. リソースアカウントとサービスをリンクします。
...
2. 新しいリソースアカウントを作成します。 「 [Microsoft Teams 管理センターでリソースアカウントを作成](#create-a-resource-account-in-microsoft-teams-admin-center)する」または「 [Powershell でリソースアカウントを作成](#create-a-resource-account-in-powershell)する」を参照してください。
3. 電話システムまたは電話システムの仮想ユーザーライセンスを取得します。 Microsoft 365 管理センターで、[**課金** > **購入サービス** > **アドオンサブスクリプション**] に移動し、[電話システム-仮想ユーザー] ライセンスが表示されます。 [**今すぐ購入**] を選択します。
4. 国内または国際[通話プラン](calling-plans-for-office-365.md)を購入します。
5. 電話システムのライセンスをリソースアカウントに割り当てます。 「 [Microsoft Teams ライセンスを割り当て](assign-teams-licenses.md)て、 [1 人のユーザーにライセンスを割り当てる](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/assign-licenses-to-users?redirectSourcePath=%252farticle%252f997596b5-4173-4627-b915-36abac6786dc&view=o365-worldwide#assign-licenses-to-one-user)」を参照してください。
6. 通話プランのライセンスをリソースアカウントに割り当てます。 詳細については、「 [Microsoft Teams ライセンスを割り当てる](assign-teams-licenses.md)」を参照してください。
7. サービス番号をリソースアカウントに割り当てます。 「[電話番号とサービスの割り当て/割り当て解除」を](#assignunassign-phone-numbers-and-services)参照してください。
8. 通信クレジットを設定して、組織の自動再充電を設定します。 [通信クレジットのライセンス](set-up-communications-credits-for-your-organization.md#step-3-assign-a-communications-credits-license-to-users)をリソースアカウントに割り当てます。
9. ライセンスを割り当てたリソースアカウントに[サービスの電話番号を割り当て](change-the-phone-numbers-on-your-audio-conferencing-bridge.md#steps-when-you-are-assigning-a-new-service-phone-number-to-your-conference-bridge)ます。 
10. 次のいずれかを設定します。
   - [クラウド自動応答](create-a-phone-system-auto-attendant.md)
   - [クラウド通話キュー](create-a-phone-system-call-queue.md)
11. リソースアカウントを自動応答または通話キューにリンクします。 「[電話番号とサービスの割り当て/割り当て解除」を](#assignunassign-phone-numbers-and-services)参照してください。

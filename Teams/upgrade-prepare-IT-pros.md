...
|&nbsp; |&nbsp; |
|---|---|
| ![決定ポイントを示すアイコン。](media/audio_conferencing_image7.png) <br/>判断ポイント|<ul><li>サポート スタッフのデプロイとサポートに関与する可能性が高いすべてのサポート スタッフTeams。</li><li>アップグレードの進行に合わせ、追加のスタッフをオンボードするトレーニング 計画を作成しましたか?</li></ul> |

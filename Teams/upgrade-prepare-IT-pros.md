...
Office 365 テナント管理者、技術責任者、およびサポート デスクは、高品質のユーザー エクスペリエンスの推進に責任を負います。 ネットワーク チーム、ユーザー、チームを構成して、効果的にトラブルシューティングを行うし、発生する可能性がある問題を解決することをサポートするために準備が整っていることを確認が含まれます。
...
-   [Microsoft Teams 管理者のためのクイック スタート ガイド](quick-start-guides.md)
...
|    |     |
|-----------|------------|
| ![](media/audio_conferencing_image7.png) <br/>意思決定ポイント|<ul><li>導入およびサポート チームに参加する可能性のあるユーザーすべてのサポート スタッフを関与するでしょうか。</li><li>契約時の他のスタッフのトレーニング計画、アップグレードの進行に合わせて開発したでしょうか。</li></ul> |

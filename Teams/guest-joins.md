...
> [!NOTE]
> チームを去って組織/テナントから guest アカウントを削除しません。 組織から自分自身を削除する方法[、組織からゲスト ユーザーとして](https://docs.microsoft.com/en-us/azure/active-directory/b2b/leave-the-organization)参照してください。 または、組織の管理者は、テナントからゲスト ユーザーを削除できます。

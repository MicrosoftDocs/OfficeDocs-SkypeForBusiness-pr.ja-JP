...
デバイス構成の変更、デバイスの再起動、更新プログラムの管理、デバイスと周辺機器の正常性の表示など、デバイスを管理するには、次の Microsoft 365 管理者ロールのいずれかを割り当てる必要があります。

- Microsoft 365 グローバル管理者
- Teams サービス管理者
- Teams デバイス管理者

Teams の管理者ロールの詳細については、「チーム [管理者ロールを使用してチームを管理する](../using-admin-roles.md)」を参照してください。
...
デバイスを管理するには、 [Microsoft Teams 管理センター](https://admin.teams.microsoft.com)の左側のナビゲーションで、[ **デバイス** ] に移動して、デバイスの種類を選びます。 各種類のデバイスにはそれぞれ専用のセクションがあります。これらの各デバイスで個別に管理することができます。
...
## <a name="manage-phones-collaboration-bars-and-teams-displays"></a>電話、コラボレーションバー、チームの表示を管理する 

Teams 管理センターでは、組織のチームに登録されている電話、コラボレーションバー、チームの表示を表示して管理できます。 各デバイスに表示される情報には、デバイス名、製造元、モデル、ユーザー、状態、操作、最後の表示、履歴が含まれます。 目的に合った情報が表示されるように、ビューをカスタマイズすることができます。

電話、コラボレーションバー、チームの表示は、サインアップした場合、Microsoft Intune に自動的に登録されます。 デバイスが登録されると、デバイスのコンプライアンスが確認され、条件付きアクセスポリシーがデバイスに適用されます。

ここでは、組織での電話、コラボレーションバー、チームの表示を管理する方法の例をいくつか示します。  

|操作方法  |操作 |
|---------|---------|
| デバイスの情報を変更する               | [ **編集** ] > デバイスを選択します。 デバイス名、アセットタグ、メモの追加などの詳細を編集できます。     |
| ソフトウェアの更新を管理する                 | **更新** > デバイスを選択します。 デバイスで利用可能なソフトウェアとファームウェアの更新プログラムの一覧を表示し、インストールする更新プログラムを選ぶことができます。 デバイスの更新の詳細については、「[チームデバイスをリモートで更新](remote-update.md)する」を参照してください。   |
| Teams の電話を Teams のディスプレイにアップグレードする                | [ **IP 電話** ] ページで、1つ以上の Teams 電話 > **アップグレード** を選択します。 このオプションは、Teams ディスプレイへのアップグレードをサポートしている電話に対してのみ使用できます。 詳細については、「チーム [の電話を teams のディスプレイにアップグレードする](upgrade-phones-to-displays.md)」を参照してください。   |
| 構成ポリシーを割り当てる、または変更する | [ **構成の割り当て** ] > 1 つ以上のデバイスを選択します。                                                                                                                                                                                                                   |
| デバイスタグを追加または削除する               | 1つ以上のデバイスを選択して、 **タグ > 管理** します。 デバイスタグの詳細については、「 [Teams デバイスタグを管理](manage-device-tags.md)する」を参照してください。                                                                                                      |

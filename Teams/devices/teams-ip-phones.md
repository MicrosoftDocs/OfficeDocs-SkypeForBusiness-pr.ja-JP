...
デバイスに新しいファームウェア バージョンをインストールすると、インストールされている対応するMicrosoft Teams アプリ、ポータル サイト、管理 エージェントのバージョンを確認できます。インストールされているバージョンは、**製品リリースの [付属製品リリース**] 列で確認します。 次に、上記の **アプリバージョン** の表で製品リリースを調べます。

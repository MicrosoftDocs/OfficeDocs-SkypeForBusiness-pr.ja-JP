...
> [!IMPORTANT]
> Microsoft Teams デバイス認定プログラムは、認定されたデバイスがハードウェアの設計とパフォーマンスに関する特定の要件のみを満たしていることを保証します。 認定プログラムでは、機能レベルまたはクラウド環境のサポートは評価されません。
>
> クラウド環境のサポートを含め、Windows と Android 用のTeams RoomsのTeams Roomsでサポートされる機能の詳細については、[Windows と Android の機能の比較に関するTeams Roomsを](../rooms/teams-devices-feature-comparison.md)参照してください。

認定プログラムは、すべての認定デバイスが、Teams および Teams 管理センターに必要な機能セットを使用して Android バージョンを実行するように設計されています。 認定終了日は、認定プログラムに入ったときにデバイスで実行されている Android OS バージョンに基づいています。 OEM パートナーは、Android OS のバージョンをアップグレードして再認定するか、最新の新しいモデルをリリースすることで、認定の有効期間を延長することに取り組んでいます。

認定期間を超えて、Microsoft は、認定期間の終了後 2 年間、このようなデバイスで Teams クライアントの最新バージョンをサポートすることに取り組んでいます。
...
| レストロン UC-2                          |`1.0.1.46`                                                  | 2023 年 8 月 5 日               | 9 |
| Lenovo ThinkSmart View                 | `CD-18781Y.200410.067`                                     | 2022 年 12 月 5 日             | 8.1 |
| PolyTrio C60、Trio C60 NR、Trio C60 ND | `5.9.3.6155`                                              | 2023 年 8 月 5 日               | 9 |
| Poly CCX400                            | `1.0.0.0200`                                               | 2023 年 8 月 5 日               | 9 |
| Poly CCX600                            | `5.9.12.1122`                                              | 2023 年 8 月 5 日               | 9 |
| Poly CCX500                            | `5.9.12.1122`                                              | 2023 年 8 月 5 日               | 9 |                                                                                                                                                        
| MP56、MP58、VP59 で Yealink EXP50 がサポートされている| サポートされている各デバイス モデルについては、更新プログラム #7 ファームウェアのバージョンに関する記事を参照してください。 | 2023 年 8 月 5 日      | 9 |
...
| Logitech Rally Bar Mini | `1.2.982`     |   2024 年 9 月 3 日  |    小会議室 (4.5 m x 4.5 m) | 10 |
...
| デバイス モデル| ファームウェアのバージョン | 現在の認定終了日 | Android OS バージョン |                                         
|:------------------------|:-----------------|:--------------|-----------------------|
|コントロール パネルを展開する   | `1.2.22206.03` | 2024 年 9 月 3 日 | 10 |
|端正なパッド パネル    | `NFA1.20220211.1400` | 2023 年 8 月 5 日 | 9 |
|レストロン TSS-770 | `2.001.0058` |2024 年 9 月 3 日  | 10 |
|レストロン TSS-1070 | `2.001.0058`|2024 年 9 月 3 日 | 10 |
|Yealink RoomPanel | `147.15.0.1`|2023 年 8 月 5 日   | 9 |
|Logitech TAP Scheduler | `1.3.111` |2024 年 9 月 3 日 | 10 |

### <a name="product-release-information-for-teams-phones"></a>Teams Phone の製品リリース情報

Teams の最新の電話アプリとファームウェアのバージョンを次に示します。
...
| 2022 更新プログラム #2   | 2022 年 3 月 21 日   | `1449/1.0.94.2022030501` |`5.0.5304.0` | `322` |
...
デバイスに新しいファームウェア バージョンをインストールすると、Microsoft Teams アプリ、ポータル サイト、管理 エージェントの対応するインストール済みバージョンを確認できます。 **[含まれている製品リリース**] 列で製品リリースを見つけ、前の **「アプリのバージョン**」の表で製品リリースを検索します。
...
|PolyTrio C60 | `7.3.1.0813` | 2022 Update #1C |
...
| PolyTrio C60   | `7.2.1.1975`  | 2022 Update #1C                        |
| Poly CCX400/CCX500/CCX600   | `7.2.1.1971`  | 2022 Update #1C            |
| アレストロン UC-P8/I/C/CI     | `1.0.4.82`    | 2022 Update #1A |
| アレストロン UC-P10/I/C/CI    | `1.0.4.82`    | 2022 Update #1A |
| PolyTrio C60   | `7.2.1.1831`  | 2022 Update #1B                        |
| Poly CCX400/CCX500/CCX600   | `7.2.1.1826`  | 2022 Update #1B                 |
|レストロン UC-2     | `1.0.4.75`    | 2022 Update #1A |
...
|PolyTrio C60      | `7.1.3.0985`            | 2021 Update #3  |
|Poly CCX400/CCX500/CCX600 | `7.1.3.0991`     | 2021 Update #3  |
|レストロン UC-2      | `1.0.4.57`              | 2021 Update #3  |
...
| PolyTrio C60           | `7.0.3.0517`      | 2021 Update #2      |
...
| レストロン UC-2  | `1.0.3.66` | 2021 Update #2 |
| PolyTrio C60   | `7.0.2.1071`  | 2021 Update #1                        |
...
| PolyTrio C60       | `6.2.23.0202`          | 2020 Update #7          |
...
| エポポス EXPAND Vision 3T |`1.5.22242.02`   | 2022 Update U2A |
...
| エポポス EXPAND Vision 3T |`1.2.4.22042.05`   | 2022 Update #1 |
...
| エポポス EXPAND Vision 3T |`1.2.2.21182.10`   | 2021 Update #2 |
...
| デバイス モデル  | ファームウェアのバージョン | 付属の製品リリース|
|:--------------|:-----------------|:-------------------------|
|端正なパッド パネル | `NFA1.20220914.1206` | 2022 更新#3A  |
|Logitech Tap Scheduler | `1.7.200` |2022 更新#3A  |
...
|端正なパッド パネル |NFA1.20220512.2158 | 2022 更新プログラム #2 |
|Logitech Tap Scheduler | `1.6.215` |2022 Update #1A  |
|レストロン Touchpanel /770-T/1070-T | `1.006.0046 ` | 2022 Update #1|
|Yealink RoomPanel | ` 147.15.0.30 ` | 2022 Update #1 |
|ストロン -TSS770  | `1.004.0115` |2021 Update #1 |
|ストロン TSS1070  | `1.004.0115` |2021 Update #1 |
...
認定プログラムに参加しようとしているベンダーの場合は、「要件と使用可能なプログラム [に参加する方法](/skypeforbusiness/certification/how-to-join) 」を参照してください。

...
> [!NOTE]
> ポリシー操作を送信すると、ポップアップ ダイアログ ボックスで確認を求めるメッセージが表示されます。 これには、ポリシーの割り当て、既存のポリシーの変更、および新しいカスタム ポリシーの作成が含まれます。 ポリシー操作を開始することを確認する必要があります。または、キャンセルして後で戻ることもできます。
...
このビデオでは、ユーザーに割り当てられた効果的なポリシーを表示および管理する手順を示します。

...
チームの管理ツールは、Microsoft Teams 管理センターの [**Teams**] ノードの下にあります。 (管理センターで Teams を選択 **します** > 。**チームを管理** します。)各チームは Microsoft 365 グループによってサポートされており、このノードには、組織内で Microsoft Teams が有効になっているグループのビューが表示されます。
...
- **所有者** - このチームの所有者の数。
- **ゲスト** - このチームのメンバーである Azure Active Directory B2B ゲストの数。
...
このビデオでは、新しいチームとチャネルを作成する手順を示します。
...
このビデオでは、既存のチームの詳細を表示および編集する手順を示します。
...
- [Microsoft 365 管理センターの概要](/microsoft-365/admin/admin-overview/admin-center-overview)

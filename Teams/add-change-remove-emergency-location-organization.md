...
どの国や地域にいても、緊急対応の場所に場所や場所を追加して、緊急対応の場所を削除できます。 組織の物理的な場所の数に応じて、建物、フロア、オフィスの場所を作成できます。 「緊急 [通話を管理する」を参照してください](what-are-emergency-locations-addresses-and-call-routing.md)。
...
4. 国または地域を選択し、住所を入力します。
   ...
   > [!NOTE]
   > ベルギー、フランス、ドイツ、アイルランド、オランダ、スペインでは、Microsoft 365 または Office 365 で電話番号を正常にアクティブ化するには、緊急対応の場所に設定された住所 (番号の取得に使用される) が電話番号の市番と一致している必要があります。
...
[New-CsOnlineLisSkyicAddress を参照してください](https://docs.microsoft.com/powershell/module/skype/new-csonlineliscivicaddress)。
...
[「Set-CsOnlineLisSkyicAddress」を参照してください](https://docs.microsoft.com/powershell/module/skype/set-csonlineliscivicaddress)。
...
[Remove-CsOnlineLisSkyicAddress を参照してください](https://docs.microsoft.com/powershell/module/skype/remove-csonlineliscivicaddress)。

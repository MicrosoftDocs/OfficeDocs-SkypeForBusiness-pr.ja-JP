...
7. チーム管理者の役割が初めての場合は、「[Teams の管理者トレーニング](itadmin-readiness.md)」をご覧ください。


1. ユーザーが、はっきりと視聴できるデバイスを所有していることを確認します。 個人用スペースと共有スペースに [Teams が認定したデバイス](https://aka.ms/TeamsDevices)があることをご確認ください。


### <a name="known-issue---china-dialing-into-skype-for-business-or-teams-conference-ids"></a>既知の問題 - 中国: Skype for Business または Teams 会議 ID へのダイヤルイン

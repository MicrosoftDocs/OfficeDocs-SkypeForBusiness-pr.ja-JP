---
title: Connectボーダー コントローラー (SBC) を直接ルーティングに接続する
ms.reviewer: ''
ms.author: crowe
author: CarolynRowe
manager: serdars
...
ms.locfileid: "58608994"
---
# <a name="connect-your-session-border-controller-sbc-to-direct-routing"></a>Connectボーダー コントローラー (SBC) を直接ルーティングに接続する

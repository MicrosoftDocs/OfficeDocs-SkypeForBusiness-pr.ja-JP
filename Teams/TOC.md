...
# [チームを展開する方法](How-to-roll-out-teams.md)
...
## [手順 4: 組織全体にわたる展開を計画します。](get-started-with-teams-resources-for-org-wide-rollout.md)
...
## [医療のチーム テンプレート](healthcare/healthcare-templates.md)
...
## [アプリケーション、コンポーネント、& コネクタ](deploy-apps-microsoft-teams-landing-page.md)
### [アプリケーションのアクセス許可および考慮事項](app-permissions.md)
...
#### [チームの割り当てライセンス](assign-teams-licenses.md)
#### [チーム アドオン ライセンス](teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
##### プランに基づいたライセンスオプション
###### [Office 365 ビジネス プレミアム](teams-add-on-licensing/office-365-business-premium.md)
...
## [会議出席依頼をカスタマイズする](customize-meeting-invitations.md)
...
### [電話システムを設定します](setting-up-your-phone-system.md)
### [共通エリア電話機を設定する](set-up-common-area-phones.md)
### ボイス メール
#### [電話システム ボイスメールをセットアップする](set-up-phone-system-voicemail.md)
#### [ボイス メールの既定の言語を変更します。](change-the-default-language-for-greetings-and-emails.md)
...
### [組織の計画を呼び出すことを設定します。](set-up-calling-plans.md)
### [クイック スタート ガイド: プランの呼び出しを構成します。](configuring-teams-calling-quickstartguide.md)
...
## 参照
### [国および地域の可用性の計画を呼び出す](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)
#### [アルゼンチン](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-argentina.md)
#### [オーストラリア](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-australia.md)
#### [オーストリア](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-austria.md)
#### [バーレーン](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-bahrain.md)
...
### [クラウドの音声ガイダンス](cloud-voice-landing-page.md)
#### [自分の成功を定義します。](1-envision-define-my-success-cloud-voice.md)
#### [意思決定、サービスの計画を呼び出すと、電話システム](calling-plan-landing-page.md)
#### [意思決定、サービスの電話システムの直接のルーティング](direct-routing-landing-page.md)
...
### [Microsoft 365 政府の DoD を計画します。](plan-for-government-dod.md)

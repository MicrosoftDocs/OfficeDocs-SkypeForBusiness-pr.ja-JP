...
管理者は、Teams 会議ポリシーを設定して、会議の開催者が会議出席レポートをダウンロードできるかどうかを制御します。 既定では、レポートのダウンロード機能はオフになっています。 この機能をオンにする手順については、「[会議ポリシーの設定 - エンゲージメント レポートを許可する](../meeting-policies-in-teams-general.md#engagement-report)」を参照してください。

...
- または、アプライアンス PC をワークグループに残しておくことも可能です。 としてビジネスのクライアント、デスクトップのマイクロソフトのチームまたは Skype でこの必要があります Skype ルーム システム アプライアンス PC のルート証明書チェーンを手動でインポートするのには。 展開が (たとえばと Entrust、VeriSign) のパブリック証明書を使用する場合は、ルート証明書チェーンをインポートするのにはしていない必要があります。 

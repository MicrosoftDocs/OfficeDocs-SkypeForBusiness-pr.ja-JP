...
[マイクロソフト チーム ルームの展開](room-systems-v2.md)で説明したようにアカウントを作成し、[マイクロソフト チームの会議室のコンソールの構成](console.md)で説明したように、ミーティング コンソールの設定、展開が含まれます。 
...
> [!NOTE]
> マイクロソフト チームの会議室はマイクロソフトのチームやビジネス サーバー 2019 の Skype、Skype ビジネス サーバー 2015 年のビジネス オンラインの Skype での使用を目的としています。 <br><br>Lync Server 2013 のような以前のプラットフォームは、マイクロソフト チームの会議室を使用する必要もありません。
...
マイクロソフト チームの会議室のイメージを作成するには、するには、[マイクロソフト チームの会議室のコンソールの構成](console.md)の指示に従います。 指示に従って、インストール プロセスのすべての必要なソフトウェアをダウンロードします。 

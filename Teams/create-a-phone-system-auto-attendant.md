...
[ユーザー電話番号] フィールドに拡張子を入力するために必要な形式は、" *+ \<phone number> ext = \<extension>* " または " *+ \<phone number> x \<extension>*" のいずれかです。
例: Set-MsolUser-UserPrincipalName usern@domain.com-Phonenumber "+ 15555555678; ext = 5678"。

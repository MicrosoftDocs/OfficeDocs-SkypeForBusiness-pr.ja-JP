...
![営業時間の通話処理。](media/2a33b1f7-d362-47a7-bf32-ef702bc878e8.png)
営業時間の通話処理は続行し![ます。](media/2a33b1f7-d362-47a7-bf32-ef702bc878e8b.png)
...
![数値 1](media/sfbcallout1.png) [**含める**] オプションには、次の2つのオプションがあります。

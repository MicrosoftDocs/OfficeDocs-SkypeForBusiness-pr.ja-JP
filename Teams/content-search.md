...
description: Microsoft 365 コンプライアンス センター でコンテンツ検索を使用して、Exchange Online、SharePoint Online、OneDrive for Business、OneNote に保存されている Microsoft Teams コンテンツを検索する方法について学習します。
appliesto:
- Microsoft Teams

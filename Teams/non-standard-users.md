...
### <a name="allow-anonymous-users-to-use-apps-in-meetings"></a>匿名ユーザーが会議でアプリを使用できるようにする

既定では、匿名ユーザーは会議で既存のアプリと対話できます。 匿名ユーザーは、新しいアプリを会議に追加できません。 アプリを操作するための匿名ユーザーを禁止できます。

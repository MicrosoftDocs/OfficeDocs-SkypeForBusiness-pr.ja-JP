...
Microsoft Teams fournit des pages d'aide avec des raccourcis clavier et des instructions de navigation pour les utilisateurs de lectours d'écran :
...
en outre, la fonction de chat des équipes de Microsoft Teams est compatible avec un large éventail de technologies d'assistance, notamment les lecturs d'écran, les logiciels de dictée, le contrôle visuel (sous Windows 10), le contrôleの声 (sous iOS et Android),les agrandisseurs d'écran et les commutateurs d'accté (sous iOS et Android).

Skype entreprise dans Office 365 également en charges diverses fonctionnalités d'accessibilité. Pour les personnes qui utilisent des lecturs d'écran, l'interface utilisateur de Skype Entreprise peut êtreourue à l'aide du clavier, et des pages d'aide sont fournies pour expliquer :

...
チームの機能は、ビジネス管理センターの PowerShell またはマイクロソフトのチームと Skype を使用して管理できます。 

> ![メモ]チームの機能のすべては、チームのコネクタ モジュールを使用して管理できます。 Business connector は、Skype を使用する必要があります。 [ダウンロードしてインストール、Skype のオンライン ビジネスのコネクタ](https://docs.microsoft.com/skypeforbusiness/set-up-your-computer-for-windows-powershell/download-and-install-the-skype-for-business-online-connector)を参照してください。

### <a name="step-1-prerequisites"></a>手順 1: 前提条件

PowerShell を使用して、マイクロソフトのチームのリモート管理は、次のオペレーティング システムのいずれかの操作を実行している 64 ビット コンピューター上でのみサポートされます。
...
サポートされているオペレーティング ・ システムだけでなく、また実行するコンピューター、次の。
  
- PowerShell 3.0 以降
    
- チーム PowerShell コネクタ モジュール

...
Microsoft Teams の称賛アプリを使用すると、ユーザーは組織または教室のメンバーに対する感謝を示すことができます。 選択して、独自のバッジを作成するためのオプションを選択すると、称賛は、チームユーザーが作成するさまざまな作業について、教師と Firstline 員の間で行う作業を認識できるように設計されています。

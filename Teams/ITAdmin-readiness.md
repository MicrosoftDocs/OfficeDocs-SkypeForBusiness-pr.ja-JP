...
| ダイレクト ルーティング | [ビデオ 1: ダイレクト ルーティングの計画 (Teams](https://aka.ms/teams-dr-plan)<br>[ビデオ 2: ダイレクト ルーティングの構成と管理Teams](https://aka.ms/teams-dr-config)<br>[ビデオ 3: 直接ルーティングへの移行 (Teams](https://aka.ms/teams-dr-migrate)  | [デッキ](https://aka.ms/teams-direct-routing-deck) |
...
| モジュール 8: Microsoft Teams会議室 - ヒント、テクニック、およびトラブルシューティング (18:14 分)|[ビデオ](https://www.youtube.com/watch?v=W3b-iRrFECA)  | [デッキ](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/rooms/module-8a-tips-tricks-troubleshooting.pdf?raw=true)|
...
| タイトル                                                                       | 要約                                                                                                                                                                                                               |  ガイドへのリンク                             |
|-----------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|
| Id、Access Management & Threat Protection for Teams                   | Microsoft 管理センターと PowerShell を使用してアクセスポリシーと ID ポリシーを構成する方法と、Office 365 Advanced Threat Protection を有効にする方法についてTeams                                                            | [Teams セキュリティ ガイド](https://aka.ms/teamsesecurityinteractiveguide)         |
...
| Teams でのコンプライアンスのTeams                                                | Microsoft 365 セキュリティ、Microsoft 365 コンプライアンス、Microsoft Teams 管理センター、Windows PowerShell を使用して、Office 365 組織の Microsoft Teams ポリシーと設定。 | [コンプライアンスの管理 (Teams ガイド)](https://aka.ms/complianceinteamsinteractiveguide)      |
| TeamsAdvisor: チャット、チーム、チャネル、アプリをデプロイMicrosoft Teams | Teams Advisor を使用して環境を評価し、チャット、チーム、チャネル、アプリをデプロイするための計画を作成する方法について学習します。                                                                                         |  [TeamsAdvisor ガイド](https://aka.ms/MicrosoftTeamsAdvisorInteractiveguide)  |
| PowerShell とTeamsを使用した管理の合理化        | 静的メンバーシップOffice 365グループを動的に変換し、Windows PowerShell を使用して新しいアプリのアクセス許可ポリシーをすべてのメンバーに割り当てる。                                                                         |  [管理ガイドTeamsの合理化](https://aka.ms/StreamliningTeamsadminInteractiveGuide) |
...
| 構成Teams 電話システム: 自動応答 & キュー                   | 呼び出しキューを作成してデプロイし、自動応答管理センターを使用Microsoft Teams呼び出しのMicrosoft Teams手順を実行します。                                                          |  [電話Teamsガイドを構成する](https://aka.ms/TeamsPhoneInteractiveGuide)             |
...
| Microsoft Teams でガバナンスを構成する                                     | 組織のメッセージング保持ポリシー Teams作成する方法と、個々のメッセージをアーカイブ、削除、復元する方法について説明Teams                                                                                   |  [管理ガイドでガバナンスMicrosoft Teams構成する](https://aka.ms/TeamsGovernanceInteractiveGuide)        |
| 会議の構成とMicrosoft Teams展開                          | 会議のワークロードをデプロイするプロセスをMicrosoft Teams。                                                                                                                                       |  [会議の構成とMicrosoft Teamsガイド](https://aka.ms/TeamsMeetingsInteractiveGuide)          |
| 電話会議を構成する Microsoft Teams                            | 会議ブリッジとダイヤルイン電話番号を割りTeams会議の機能について説明します。                                                                                          |  [ビデオ ガイド用の電話会議Microsoft Teams構成する](https://aka.ms/AudioConferencingInteractiveGuide)      |
...
| 最前線の従業員の ID: IT、マネージャー、およびフロントライン ワーカーを支援する                    | 既存の人事システムMicrosoft Teams統合し、軽量の委任 ID 管理を構成し、共有デバイスを使用するユーザーに対して簡単なサインインとシームレスな移行を構成する方法について説明します。                                                                                                                  | [Frontline worker ID ガイド](https://aka.ms/FLWIdentityIG)              |
...
|認定 Android デバイスTeams操作する|電話、ディスプレイ、Microsoft Teams、Microsoft Teams、Microsoft Teams パネルを管理およびMicrosoft Teamsします。|[認定 Android Microsoft Teamsの操作](https://aka.ms/teamsandroiddeviceslab)|

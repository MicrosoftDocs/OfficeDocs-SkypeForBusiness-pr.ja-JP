...
ms.service: msteams
ms.reviewer: landerl
description: 詳細な環境検出を実行して、環境の詳細な検出を実行する方法をSkype for BusinessからMicrosoft Teams。
f1.keywords:
- NOCSH
...
> | 質問 | 回答 | コメント |
> |---|---|---|
> | 実稼働環境のMicrosoft 365<br/>またはOffice 365の名前と ID<br/>を選択します。 その他の情報がある場合<br/>に関連付けられている 1 つ以上のテナント<br/>すべての ID を書き込む必要があります。 | テナント名: <br/>テナント ID:| |
...
> | ユーザーに対して有効になっているライセンス レベルSkypeします。 <br/>Business Online ユーザー | <input type="checkbox"> E1/G1 <br/> <input type="checkbox"> E2/G2 <br/> <input type="checkbox"> E3/G3 <br/> <input type="checkbox"> E4/G4 E5 | ユーザー数 <br/>各 SKU に対して次の条件を実行します。 |
...
該当する場合は、次のサンプル 表を使用してSkype for Businessデプロイの詳細をキャプチャします。 オンプレミスにデプロイしていないSkype for Business、このセクションをスキップしてください。
...
## <a name="networking-and-access-to-microsoft-365-and-office-365-services"></a>ネットワークとサービスMicrosoft 365サービスOffice 365アクセス

次の表を使用して、組織のネットワークの詳細と、ユーザーが Microsoft 365 サービスやサービスに接続Office 365します。
...
> | アクセスが Microsoft 365またはOffice 365場合は、<br/>プロキシ サーバー。プロキシをバイパスする方法はありますか。 | <input type="checkbox"> うん <br/> <input type="checkbox"> 違います | |
...
> | 質問 | 回答 | コメント |
> |---|---|---|
> | Lync Server の運用モデルは何か。 <br/>Skype for Business Server、Microsoft 365 デプロイ、 <br/>または現在Office 365デプロイを開始しますか? | | |
...
> | Lync Server を監視する方法、Skypeする方法 <br/>Business Server、Microsoft 365デプロイ、または <br/>Office 365デプロイですか? | | |

...
Office 365 のオーディオ会議サービスを導入するお客様に追加のメリットとして提供していますから、Office 365 のオーディオ会議のサブスクリプションに割り当てられているユーザーによって開催されるミーティングに関連するその他の補完的利点2019年 6 月をライセンスします。 この無料期間中に Microsoft により、ミーティングの開催者または出席者が権限のある会議にダイアル アウトをかけるからミーティング内で、premium 以外の電話番号を以下に示す 44「ゾーン A」の国でのポリシー設定で定義されています。 この給付金は、オーディオ会議毎月のサブスクリプション ライセンスには適用し、オーディオ会議の 1 分あたりの支払のライセンスには適用されません。
...
注: チームと Skype の管理センターでのビジネス管理センターの Skype で発信分のプールに対する使用率を監視することがあります > レガシ管理センター > レポート > PSTN 分のプールです。  この無料分プールはレポートに「発信呼び出しにゾーン A の国」として。

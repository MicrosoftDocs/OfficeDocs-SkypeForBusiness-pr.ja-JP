...
Microsoft Teams ミーティング関連の連絡を転送するヘルプデスク キューを検討し、ヘルプデスク チームに FAQ を提供して、Microsoft Teams ミーティングの使用方法と主要なトラブルシューティング手順を理解してもらいます。 この FAQ の出発点として、[組織内の](known-issues.md)[ユーザーヘルプ](https://support.office.com/article/Skype-Room-Systems-version-2-help-e667f40e-5aab-40c1-bd68-611fe0002ba2)とサポートチームが挙げられます。

...
Microsoft Teams ミーティング関連の連絡を転送するヘルプデスク キューを検討し、ヘルプデスク チームに FAQ を提供して、Microsoft Teams ミーティングの使用方法と主要なトラブルシューティング手順を理解してもらいます。 この FAQ の開始点としていいのは、[ユーザー ヘルプ](https://support.office.com/article/Skype-Room-Systems-version-2-help-e667f40e-5aab-40c1-bd68-611fe0002ba2)と[既知の問題リスト](known-issues.md)です。

...
1 つの表示を使用して Teams Room の両方 `<MainFoRDisplay>` と `<ExtendedFoRDisplay>` コンテナーを一緒に使用する `<ExtendedFoRDisplay>` 場合、コンテナーは無視されます。 詳細については、上記の XML と要素の例の表を参照してください。

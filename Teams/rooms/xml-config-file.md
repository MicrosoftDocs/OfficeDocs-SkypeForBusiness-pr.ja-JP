...
| \<NoiseSuppressionDefault\>                 | ブール値 &#x2777;            | First &#x2776; | 既定では、true が有効になっています。 false の場合は、Microsoft AI ベースのノイズ抑制 (NS) のみがオフになります。 HW にノイズ抑制が組み込まれている場合、オンにすると Microsoft NS が連鎖します。 OEM 提供の NS のみを使用する場合は、管理者は Microsoft AI ベースの NS を無効にする必要があります。

...
追加の構成では、「 [Microsoft teams のルーム管理を Azure monitor と計画](azure-monitor-plan.md)する」、「 [microsoft teams](azure-monitor-deploy.md)のルーム管理を azure モニターと共に展開する」、「azure モニターを使用して microsoft teams[室](azure-monitor-manage.md)の管理を展開する」の説明に従って microsoft azure モニターを使用してリモート管理を行うことができます。 

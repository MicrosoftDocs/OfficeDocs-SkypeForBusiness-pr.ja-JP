...
- [チャネルで今すぐ会議を](meeting-policies-in-teams.md#allow-meet-now-in-channels)許可する: ユーザーがチャネルで一時会議を開始できるかどうかを制御します。

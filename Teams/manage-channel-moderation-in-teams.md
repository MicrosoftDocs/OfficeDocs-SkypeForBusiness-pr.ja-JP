...
Microsoft Teams では、チーム所有者は標準チャネルのモデレーションを有効にし、新しい投稿を開始し、そのチャネルの投稿に返信できるユーザーを制御できます。
...
Teams for Education では、サイエンス教師がチャネルを使用して、特定の教室のトピックに関する集中したディスカッションに学生を参加したいと考えました。

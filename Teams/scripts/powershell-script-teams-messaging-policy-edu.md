...
> [!NOTE]
> また、バッチポリシーの割り当てを使用して、メッセージングポリシーを多数のユーザーに割り当てることもできます。 詳細については、「[学校の多数のユーザーにポリシーを割り当て](../batch-policy-assignment-edu.md)、 [Teams のユーザーにポリシーを割り当てる](../assign-policies.md)」を参照してください。

...
このスクリプトを使用して、Teams設定をリセットします。 これには、ユーザーまたはアプリによって設定された値Teams含まれます。 既定では、Teamsがインストールされた後にコンピューターにログインすると、自動的に起動されます。
...
- [新しいTeamsを使用Microsoft 365 Apps for enterprise](/deployoffice/teams-install)
---
title: マイクロソフトのチームに直接ルーティングを構成するための契約時のチェックリスト
author: rmw2890
ms.author: MyAdvisor
manager: serdars
ms.date: 06/07/2018

...
ms.locfileid: "27283761"
---
# <a name="shared-line-appearance-in-microsoft-teams"></a>マイクロソフトのチームでの共有の線の外観
...
|------------|---------------|---------------|----------------------|-----------------------------|----------------|
| 委任を設定します | あり | あり | あり | なし | なし |
| 代理人の呼び出しを受信します。 | あり | あり | あり | あり | あり |
| 代理人の電話番号を呼び出す | あり | あり | あり | あり | あり |
| 代理人のチームのユーザーを呼び出し | あり | あり | あり | あり | あり |
| 共有回線の管理ビューを参照してください。 | あり | あり | あり | なし | なし |
| マネージャーの待機活動の管理ビューを参照してください。 | あり | あり | あり | なし | なし |
| 代理人のマネージャーのビューを参照してください。 | あり | あり | あり | なし | なし |
| 管理者またはマネージャーを保持したり、再開 | あり | あり | あり | なし | なし |

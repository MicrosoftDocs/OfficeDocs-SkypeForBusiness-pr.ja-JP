...
- 管理者が初めて組織全体のテンプレートを作成すると、グローバル管理者やチームのサービス管理者を含む、テナントのすべての管理者に対して新しい Teams チームが自動的に作成されます。 これらの管理者はチームの所有者として追加され、組織のテンプレートを共同管理できます。 チームの作成後に組織に新しい管理者を手動でチーム所有者として追加して、組織全体のテンプレートを管理する権限を同じに設定する必要があります。
...
1. 管理センター Teamsの **[アプリの** 管理] で、[承認] アプリ **を** 選択し、[アプリ] を選択 **設定。**

...
- 管理者が初めて組織全体のテンプレートを作成すると、グローバル管理者やチームのサービス管理者を含む、テナントのすべての管理者に対して新しい Azure Active Directory(AAD) グループが自動的に作成されます。 これらの管理者はグループの所有者として追加され、組織のテンプレートを共同管理できます。 チームの作成後に組織に新しい管理者をグループ所有者として手動で追加する必要があります。そのため、組織全体のテンプレートを管理する権限は同じです。
...
承認アプリから作成された電子署名の承認は、選択したプロバイダーのクラウド環境に保存されています。 電子署名による契約に関連するストレージの詳細については、選択したプロバイダーのストレージのドキュメントを参照してください。

承認アプリの電子署名機能を使用するには、次のアイテムが必要です。

- 使用するよう選んだ特定の電子署名プロバイダーのライセンス。 組織用にライセンスを取得するには、プロバイダーのサイトにアクセスする必要があります。

承認で電子署名機能を利用するため、Teams 承認アプリに既定でサード パーティの署名パートナーが表示されます。 Teams 管理センターのアプリ設定にアクセスして、特定の電子署名プロバイダーを無効にできます。

1. Teams 管理センターで、**[アプリの管理]** で **[承認アプリ]**、**[設定]** の順に選択します。

2. 各電子署名プロバイダーの隣にトグルがあり、既定ではオンの位置 (右) にあります。 特定の電子署名プロバイダーを無効にするには、トグルを左にスライドします。 Teams 管理者がプロバイダーを無効にすると、ユーザーが承認を作成する時にプロバイダーが表示されなくなります。 また、エンド ユーザーは、そのプロバイダーによって作成された電子署名要求を表示できなくなります。

承認アプリから作成された電子署名の承認は、選択したプロバイダーのクラウドに保存されます。 そのため、電子署名に関するデータをエクスポートするには、プロバイダーのサイトにアクセスする必要があります。 これらの契約のエクスポートと保持については、プロバイダーのドキュメントを参照してください。

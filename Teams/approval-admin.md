...
- 管理者が初めて組織全体のテンプレートを作成すると、グローバル管理者やチームのサービス管理者を含む、テナントのすべての管理者用に新しい Teams チームが自動的に作成されます。 これらの管理者はチームの所有者として追加され、組織のテンプレートを共同管理できます。 チームの作成後に組織に新しい管理者を手動で追加して、組織全体のテンプレートを管理する権限が同じになっている必要があります。

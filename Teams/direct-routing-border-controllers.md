...
|                                                       仕入先                                                        |       Product       | 非メディア バイパス | メディア バイパス | ソフトウェア バージョン | E911 プロバイダーとの間の vaidated | ELIN 対応
|---------------------------------------------------------------------------------------------------------------------|---------------------|------------------|--------------|------------------|-----------------|------------------|
...
新機能のアイデアなど、チームについての製品フィードバックを提供するには、「 [Uservoice](https://microsoftteams.uservoice.com)のバージョンに付与された認定資格を確認する」を参照してください。 つまり、メジャーバージョンに従った SBC ファームウェアで任意の数のファームウェアがサポートされていることを意味します。

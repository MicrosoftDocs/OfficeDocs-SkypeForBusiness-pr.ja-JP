...
|Microsoft Edge (Chromium ベース) の最新バージョンと、その前の 2 つのバージョン     | オーディオと共有は完全にサポートされます <br><br>受信および送信ビデオはサポートされません (近日対応予定)    |完全にサポートされます         |
|Google Chrome の最新バージョンと、その前の 2 バージョン       |オーディオと共有は完全にサポートされます <br><br>受信および送信ビデオはサポートされません (近日対応予定) |完全にサポートされます <br> <br>Chrome バージョン 72 以降では、あらゆるプラグインや拡張機能なしで、画面の共有がサポートされます。       |

...
## <a name="decision-point-iconmediateams-adoption-decision-iconpngdecisions"></a>![判断ポイント アイコン。](media/teams-adoption-decision-icon.png)行う
...
![次のステップ](media/teams-adoption-next-icon.png)アイコン次:[使用シナリオの定義](teams-adoption-define-usage-scenarios.md)

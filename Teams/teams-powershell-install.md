...
> [!NOTE]
> 最新のプレビューバージョンは、 [Powershell ギャラリー](https://www.powershellgallery.com/packages/MicrosoftTeams) または powershell で、"Find-Module microsoft Teams-allowprerelease リリース" を実行して確認できます。

...
PowerShell モジュールMicrosoft Teams、すべてのプラットフォームで PowerShell 5.1 以降が必要です。 オペレーティング システム用 [の PowerShellavailable](/powershell/scripting/install/installing-powershell)  の最新バージョンをインストールします。 

...
- **ゲスト ユーザーのアクセス許可を制限する**: このポリシーによってディレクトリ内のゲストのアクセス許可を決定します。 3 つのポリシー オプションがあります。

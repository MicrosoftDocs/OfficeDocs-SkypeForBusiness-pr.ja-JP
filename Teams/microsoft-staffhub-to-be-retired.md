...
効果的な 2019 年 10 月 1日マイクロソフトの StaffHub は廃止されます。 StaffHub 機能、マイクロソフトのチームに、スケジュールとタスクの管理などが進められています。 チームのモバイル アプリケーションには、shift キーを管理し、ホーム画面の操作性が含まれています。 先頭行の作業者の他の機能ロール チームに時間の経過と共にします。 

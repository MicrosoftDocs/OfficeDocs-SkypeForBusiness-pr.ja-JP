...
管理者Microsoft 365設定されているグループグループの名前付けポリシーは、ユーザーがチーム名を作成または編集Teamsに適用されます。 これには必須のプレフィックスやサフィックス、禁止された単語の除外などの事項が含まれます。

詳細については、Microsoft 365 グループの名前付け[ポリシーに関する記事をTeams。](https://support.office.com/article/Office-365-Groups-Naming-Policy-6ceca4d3-cad1-4532-9f0f-d469dfbbb552)

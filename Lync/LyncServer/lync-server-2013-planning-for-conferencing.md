...
> [!NOTE]  
> Office Communicator 2007 R2 クライアント (Microsoft Office Outlook 用 Live Meeting コンソールまたは電話会議アドインを含む) を使用して開催された会議が展開に含まれている場合は、Lync Server 2013 に移行した後、次のような制限があります。 
> <UL>
> <LI>

...
このセクションでは、各 Lync Server 2013 クラスに含めることができるスキーマ属性と、他のクラスに含めることができるクラスについて説明します。 すべてのクラスとその説明の一覧については、「 [Lync Server 2013 のスキーマクラスと説明](lync-server-2013-schema-classes-and-descriptions.md)」を参照してください。 すべての属性とその説明の一覧については、「 [Lync Server 2013 のスキーマの属性と説明](lync-server-2013-schema-attributes-and-descriptions.md)」を参照してください。
...
<p>msRTCSIP-Msrtcsip-mcufactoryaddress です</p>
<p>msRTCSIP-ServerVersion</p></td>
</tr>
<tr class="even">
...
<p>msRTCSIP-Msrtcsip-trustedservicelinks です</p></td>
</tr>
<tr class="odd">
...
<td><p>msRTCSIP-Trustedwebコンポーネント Serverdata</p>
<p>msRTCSIP-Trustedwebコンポーネント Serverfqdn</p>
<p>msRTCSIP-TrustedServerVersion</p></td>
</tr>
<tr class="even">
...
<td><p>msRTCSIP-Webコンポーネントデータ</p>
<p>msRTCSIP-Msrtcsip-webcomponentspooladdress</p>
<p>msRTCSIP-ServerVersion</p></td>
</tr>
<tr class="even">
<td><p>ユーザー</p></td>
...
<p>msRTCSIP-Trustedwebコンポーネントサーバー</p>

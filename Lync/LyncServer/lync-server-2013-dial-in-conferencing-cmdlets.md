...
ダイヤルイン会議は、電話会議の音声部分に参加するために、ユーザーが "通常の" 電話 (公衆交換電話網上のデバイス) を使用できるようにします。

<div>

## <a name="dial-in-conferencing-cmdlets"></a>Dial-In Conferencing Cmdlets

ダイヤルイン会議を許可しない場合は、Get-csconferencingpolicy コマンドレットを使用し、Enabledial Inコンファレンスプロパティを False に設定することによって、この機能を無効にすることができます。 既定では、すべてのユーザーは、ダイヤルイン会議を含む会議をホストすることを許可されています。

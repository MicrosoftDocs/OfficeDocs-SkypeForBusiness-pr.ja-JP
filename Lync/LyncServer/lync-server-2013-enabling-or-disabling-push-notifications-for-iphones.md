...
## <a name="to-enable-push-notifications-for-iphone"></a>IPhone のプッシュ通知を有効にするには
  ...
  - IPhone のプッシュ通知を有効にするには、EnableApplePushNotificationService プロパティの値を True ($True) に設定します。 以下に例を示します。
...
## <a name="to-disable-push-notifications-for-iphone"></a>IPhone のプッシュ通知を無効にするには
  ...
  - IPhone のプッシュ通知を無効にするには、EnableApplePushNotificationService プロパティの値を False ($False) に設定します。 以下に例を示します。

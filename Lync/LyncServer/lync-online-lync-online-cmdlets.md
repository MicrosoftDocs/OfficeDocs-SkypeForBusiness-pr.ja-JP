...
このページでは、Microsoft Lync Online テナントの管理者が利用できるすべての Windows PowerShell コマンドレットを一覧表示します。

<div>

## <a name="cmdlets-available-only-to-lync-online-administrators"></a>Lync Online 管理者のみが利用可能なコマンドレット
...
Windows PowerShell を使用して Lync Online で管理するようにコンピューターを構成する方法については、「 [Windows Powershell を使用して Lync online を管理](https://technet.microsoft.com/en-us/library/Dn362831(v=OCS.15))する」を参照してください。

</div>

<div>

## <a name="other-cmdlets-available-to-lync-online-administrators"></a>Lync Online 管理者が利用できるその他のコマンドレット

これらのコマンドレットは、Lync Online または Lync Server 2013 のオンプレミスバージョンのいずれかで使用できます。

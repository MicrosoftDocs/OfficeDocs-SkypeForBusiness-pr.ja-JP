...
description: 'Lync Online: Lync Online のコマンドレット。'
ms.reviewer: ''
ms.author: serdars
author: serdarsoysal
f1.keywords:
...
ms.locfileid: "48569533"
---
# <a name="lync-online-cmdlets"></a>Lync Online のコマンドレット
...
このページには、Microsoft Lync Online テナントの管理者が使用できるすべての Windows PowerShell コマンドレットの一覧が表示されます。

<div>

## <a name="cmdlets-available-only-to-lync-online-administrators"></a>Lync Online 管理者のみが使用できるコマンドレット

次のコマンドレットは、Lync Online でのみ使用できます。
...
Windows PowerShell を使用して Lync Online を管理するようにコンピューターを構成する方法については、「 [Windows powershell を使用して Lync online を管理](https://technet.microsoft.com/library/Dn362831(v=OCS.15))する」のヘルプトピックを参照してください。

</div>

<div>

## <a name="other-cmdlets-available-to-lync-online-administrators"></a>Lync Online 管理者が使用できるその他のコマンドレット

これらのコマンドレットは、Lync Online または Lync Server 2013 の社内バージョンで使用できます。

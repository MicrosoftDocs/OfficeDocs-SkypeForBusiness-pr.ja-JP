...
# <a name="supported-hardware-for-lync-server-2013"></a>Lync Server 2013 でサポートされているハードウェア
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Lync Server 2013 でのファイル記憶域のサポート](lync-server-2013-file-storage-support.md)

...
description: 'Lync Server 2013: ネットワーク帯域幅ポリシープロファイルの管理'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48553523"
---
# <a name="managing-network-bandwidth-policy-profiles-in-lync-server-2013"></a>Lync Server 2013 でのネットワーク帯域幅ポリシープロファイルの管理

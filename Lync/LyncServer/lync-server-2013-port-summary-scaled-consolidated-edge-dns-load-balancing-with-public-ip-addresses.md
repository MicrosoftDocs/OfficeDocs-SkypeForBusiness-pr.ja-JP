...
TOCTitle: ポートの概要 - 拡張統合エッジ、パブリック IP アドレスによる DNS 負荷分散
ms:assetid: f7cbd0f1-841d-4116-8d17-e9d991daa4a8
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205394(v=OCS.15)
ms:contentKeyID: 48274096
ms.date: 05/19/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# ポートの概要 - Lync Server 2013 拡張統合エッジ、パブリック IP アドレスによる DNS 負荷分散
...
**拡張統合エッジ、パブリック IP アドレスを使用した DNS 負荷分散のためのエンタープライズ境界ネットワーク**

![拡張統合エッジ](images/Gg412756.96f5a8f5-16d2-464d-b86e-7c7ecfc89ead(OCS.15).jpg "拡張統合エッジ")
...
### 拡張統合エッジ、パブリック IP アドレスを使用した DNS 負荷分散のためのファイアウォールの概要: 外部インターフェイス - ノード 1 およびノード 2 (例)
...
### 拡張統合エッジ、パブリック IP アドレスを使用した DNS 負荷分散のためのファイアウォールの概要: 内部インターフェイス - ノード 1 およびノード 2 (例)

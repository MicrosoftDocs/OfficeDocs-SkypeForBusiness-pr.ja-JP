...
常設チャットサービスと常設チャットのコンプライアンスサービスは、Lync Server 2013 トポロジの一部であり、Windows PowerShell コマンドレットを使用して、Windows PowerShell コマンドレットを******使って、監視、停止、開始することができます。"CsWindowsService**" と "**スタート-CsWindowsService**" をそれぞれ停止します。

...
この問題を回避するには、Web コンポーネントと .NET framework を含むフォルダーをウイルス対策スキャン対象から除外します。 詳細については、「Microsoft サポート技術情報の記事312592、「PRB: ASP.NET で、アプリケーションが再起動[https://go.microsoft.com/fwlink/p/?linkid=3052\&kbid=312592](https://go.microsoft.com/fwlink/p/?linkid=3052%26kbid=312592)しています」というエラーを参照してください。

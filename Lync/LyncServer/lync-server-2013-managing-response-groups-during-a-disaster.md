...
---
# <a name="managing-response-groups-in-lync-server-2013-during-a-disaster"></a>障害時に Lync Server 2013 で応答グループを管理する
...
Lync Server 2013 は、障害復旧時にバックアッププール内の応答グループの実行をサポートします。 このセクションでは、停止中に応答グループを計画する方法、停止中に応答グループがどのように機能するか、および応答グループのフェールオーバーとフェールバックに必要な手順について説明します。
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Lync Server 2013 でのプール障害時の応答グループの動作](lync-server-2013-response-group-experience-during-pool-failure.md)

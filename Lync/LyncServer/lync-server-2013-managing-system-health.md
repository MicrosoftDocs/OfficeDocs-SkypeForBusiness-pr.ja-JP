...
システム正常性の管理と監視は、全体的な Lync Server 2013 の正常性の管理と監視に統合されています。 詳細については、「 [Lync Server 2013 の正常性の構成](lync-server-2013-health-configuration-in-lync-server.md)」を参照してください。

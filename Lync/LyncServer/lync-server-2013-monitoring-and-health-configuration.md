...
description: 'Lync Server 2013: 監視および正常性構成。'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48562093"
---
# <a name="monitoring-and-health-configuration-in-lync-server-2013"></a>Lync Server 2013 の監視および正常性構成
...
このセクションのトピックでは、Lync Server 2013 コントロールパネルおよび Lync Server 2013 管理シェルで実行できる監視および正常性構成タスクの詳細な手順について説明します。
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Lync Server 2013 の QoE (Quality of Experience)](lync-server-2013-quality-of-experience-qoe.md)

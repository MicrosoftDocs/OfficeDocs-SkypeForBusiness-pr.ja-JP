...
Lync Server 2013 のセキュリティと認証を管理するには、以下の手順を使用します。

<div>

## <a name="in-this-section"></a>このセクションの内容

  - [Lync Server 2013 で運用プロセスの証明書を管理する](lync-server-2013-managing-certificates-for-operational-processes.md)
  ...
  - [Lync Server 2013 での PIN 設定の管理](lync-server-2013-managing-pin-settings.md)

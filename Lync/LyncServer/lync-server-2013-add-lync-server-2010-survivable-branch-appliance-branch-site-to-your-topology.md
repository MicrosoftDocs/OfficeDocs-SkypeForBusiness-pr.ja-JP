...
---
# <a name="add-lync-server-2010-survivable-branch-appliance-branch-site-to-your-topology"></a>Lync Server 2010 存続可能 Branch Appliance ブランチサイトをトポロジに追加する
...
Microsoft Lync Server 2010 存続可能 Branch アプライアンス (SBA) は、バックアップレジストラーとして Microsoft Lync Server 2013 フロントエンドプールに関連付けることができます。 Microsoft Lync Server 2010 SBA を Microsoft Lync Server 2013 フロントエンドプールに接続する方法の詳細な手順については、「移行」のセクション「 [connect a 存続可能 Branch Appliance](connect-a-survivable-branch-appliance.md)」を参照してください。

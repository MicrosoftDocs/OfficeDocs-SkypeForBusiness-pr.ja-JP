...
ホストされるプロバイダーのインスタントメッセージング (IM) 接続により、組織内のユーザーは IM を使用して、ホストされたプロバイダーが提供する IM サービス (Microsoft 365 と Lync Online など) のユーザーと通信できるようになります。
...
6.  [**編集 SIP フェデレーション プロバイダー**] ページで、次の設定を入力または編集できます。
      ...
      - **このプロバイダー**     との通信を有効にするこの設定を選択すると、このプロバイダーのユーザーとの通信が有効になります。

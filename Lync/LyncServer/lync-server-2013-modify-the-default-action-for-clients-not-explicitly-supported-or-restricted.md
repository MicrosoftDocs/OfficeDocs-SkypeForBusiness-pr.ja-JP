...
5.  [**クライアント バージョン構成の編集**] ダイアログ ボックスで [**バージョン管理を有効にする**] チェック ボックスがオンになっていることを確認し、[**既定のアクション**] で次のいずれかを選択します。
      ...
      - **ブロック**    クライアントバージョンが [**クライアントバージョンポリシー** ] リスト内のフィルターと一致しない場合に、クライアントのログオンを禁止します。
    
      - URL を含む**ブロック**    クライアントバージョンが [**クライアントバージョンポリシー** ] リスト内のフィルターと一致しない場合にクライアントのログオンを禁止し、新しいクライアントをダウンロードできる URL を含むエラーメッセージを表示します。
    
      - URL の使用**を許可する**    クライアントバージョンが [**クライアントバージョンポリシー** ] リスト内のフィルターと一致しない場合にクライアントのログオンを許可します。また、新しいクライアントをダウンロードできる URL を含むエラーメッセージが表示されます。

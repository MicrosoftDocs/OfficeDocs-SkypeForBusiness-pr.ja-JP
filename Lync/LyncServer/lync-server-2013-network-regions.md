...
# <a name="network-regions-in-lync-server-2013"></a>Lync Server 2013 のネットワーク地域
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Lync Server 2013 でのネットワーク地域情報の表示](lync-server-2013-viewing-network-region-information.md)

...
# <a name="configure-voice-quality-of-service-for-lync-phone-edition-in-lync-server-2013"></a>Lync Server 2013 で Lync Phone Edition のサービスの音声品質を構成する
...
Lync Server 2013 に接続する IP 電話の QoS レベルを設定することによって、プール内の Lync Phone Edition デバイスの音声品質サービス (QoS) の要件を構成できます。

<div>

## <a name="to-configure-voice-quality-of-service-for-lync-phone-edition"></a>Lync Phone Edition のサービスの音声品質を構成するには
...
2.  左側のナビゲーション バーで [**クライアント**] をクリックし、[**デバイス構成**] をクリックします。

3.  [**デバイス構成**] ページのデバイス構成の一覧で、QoS 設定を変更する構成をダブルクリックします。

4.  [**デバイス構成の編集**] の、[**音声のサービス品質**] で、QoS レベルを指定します。 既定のレベルは **40** です。

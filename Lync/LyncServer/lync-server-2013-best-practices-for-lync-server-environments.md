...
システムの実行中の操作には、次の一般的な原則を適用する必要があります。
  ...
  - **Mof mof を理解して活用**   することは、ベストプラクティス、原則、およびモデルの集合であり、毎日の Lync Server 2013 操作などの IT 資産の管理に関する技術的なガイダンスを組織に提供します。 MOF の次のガイドラインは、Microsoft 製品のミッションクリティカルな運用システムの信頼性、可用性、サポート性、および管理性を実現するのに役立ちます。 詳細については、「 [Microsoft Operations Framework 4.0](https://go.microsoft.com/fwlink/p/?linkid=40939)」を参照してください。

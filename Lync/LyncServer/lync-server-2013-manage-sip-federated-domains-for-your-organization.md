...
# <a name="manage-sip-federated-domains-for-your-organization-in-lync-server-2013"></a>Lync Server 2013 での組織の SIP フェデレーションドメインの管理
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Lync Server 2013 で許可された外部ドメインのサポートを構成する](lync-server-2013-configure-support-for-allowed-external-domains.md)

  - [Lync Server 2013 で禁止された外部ドメインのサポートを構成する](lync-server-2013-configure-support-for-blocked-external-domains.md)

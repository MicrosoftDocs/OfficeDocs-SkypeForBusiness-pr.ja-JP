...
description: 'Lync Server 2013: 音声アプリケーションのコマンドレット。'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
VoIP アプリケーションはフロント エンド サーバーのアプリケーション サービスで実行されます。 これらのアプリケーションは、通話のパーク、割り当てられていない番号の処理、Exchange ユニファイドメッセージング (UM) による調整、および応答グループアプリケーションの実行を許可することにより、着信と発信の通話を管理するのに役立ちます。

<div>

## <a name="voice-application-cmdlets"></a>VoIP アプリケーションのコマンドレット

以下は、VoIP アプリケーションに対応するコマンドレットの一覧です。

**[Lync Server 2013 のコールパークアプリケーションのコマンドレット](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Lync Server 2013 での未使用の番号のコマンドレット](lync-server-2013-unassigned-number-cmdlets.md)**

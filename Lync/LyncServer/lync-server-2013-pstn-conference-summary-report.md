...
Microsoft Lync Server 2013 の PSTN 会議とは、少なくとも1人の参加者が PSTN (公衆交換電話網) 電話を使用してオーディオ部分にダイヤルインする会議のことです。 (PSTN 電話とは、"有線電話網"、携帯電話、またはボイスオーバー IP を使用していないその他の電話のことです。これらの会議は、監視レポートでの PSTN 会議とも呼ばれますが、一般的には、「ダイヤルイン会議」と呼ばれます。
...
ダイヤルインユーザーを含むすべての会議の割合を判断するには、PSTN 会議の合計数と、 [Lync Server 2013 の電話会議の概要レポート](lync-server-2013-conference-summary-report.md)で見つかった電話会議の合計指標の値とを比較します。

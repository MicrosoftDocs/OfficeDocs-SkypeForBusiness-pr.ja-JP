---
title: ミーティング参加ページの構成
TOCTitle: ミーティング参加ページの構成
ms:assetid: 036c9d03-ad95-4d63-a3d8-6cae1a8ad530
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204635(v=OCS.15)
ms:contentKeyID: 48271088
ms.date: 05/19/2016
...
ユーザーが会議出席依頼の会議リンクをクリックすると、会議参加ページが、ユーザーのコンピューターに Lync 2013 クライアントが既にインストールされているかどうかを検出します。クライアントが既にインストールされている場合、そのクライアントが会議を開き、参加します。クライアントがインストールされていない場合は、2013 バージョンの Lync Web App が既定で開きます。

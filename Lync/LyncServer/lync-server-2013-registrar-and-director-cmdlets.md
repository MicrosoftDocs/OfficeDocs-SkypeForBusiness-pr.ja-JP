...
ms.locfileid: "48578603"
---
# <a name="registrar-and-director-cmdlets-in-lync-server-2013"></a>Lync Server 2013 のレジストラーおよびディレクターのコマンドレット
...
## <a name="registrar-and-director-cmdlets"></a>レジストラーおよびディレクターのコマンドレット

...
---
# <a name="syndicators-table-in-lync-server-2013"></a>Lync Server 2013 の Syndicators テーブル
...
SyndicatorsTable は、内部使用のみを対象としています。 この表は、Microsoft Lync Server 2013 で導入されました。

...
# <a name="managing-simple-urls-in-lync-server-2013"></a>Lync Server 2013 での単純な Url の管理
...
このセクションの手順を使用して、Lync Server 2013 コントロールパネルの [**トポロジ**] ページから単純な url を管理します。

<div>

## <a name="in-this-section"></a>このセクション中

[Lync Server 2013 での簡単な URL の詳細の表示](lync-server-2013-view-simple-url-details.md)

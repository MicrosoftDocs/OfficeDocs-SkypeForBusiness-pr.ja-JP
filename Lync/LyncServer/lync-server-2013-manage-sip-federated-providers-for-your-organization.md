...
# <a name="manage-sip-federated-providers-for-your-organization-in-lync-server-2013"></a>Lync Server 2013 での組織の SIP フェデレーションプロバイダーの管理
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [ホスト SIP フェデレーションプロバイダー Lync Server 2013 を作成または編集する](lync-server-2013-create-or-edit-hosted-sip-federated-providers.md)

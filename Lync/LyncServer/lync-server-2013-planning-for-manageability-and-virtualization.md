...
# <a name="planning-for-manageability-and-virtualization-in-lync-server-2013"></a>Lync Server 2013 での管理および仮想化の計画
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [仮想サーバーで Lync Server 2013 を実行する](lync-server-2013-running-lync-server-on-virtual-servers.md)

...
以下のセクションでは、展開に 2 要素認証を構成するために必要な手順について説明します。 2段階認証について詳しくは、「 [Office 365 の多要素認証を有効にする](http://go.microsoft.com/fwlink/p/?linkid=313332)」をご覧ください。 Grid ユーザー投稿

...
# <a name="deploying-conferencing-in-lync-server-2013"></a>Lync Server 2013 での会議の展開
...
ここでは、ダイヤルイン会議と Office Web Apps サーバーの設定方法について説明します。
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Office Web Apps Server および Lync Server 2013 との統合の構成](lync-server-2013-enabling-office-web-apps-server-and-lync-server-2013.md)

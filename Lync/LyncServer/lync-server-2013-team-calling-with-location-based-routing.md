...
# <a name="team-calling-with-location-based-routing-in-lync-server-2013"></a>Lync Server 2013 での場所に基づくルーティングを使用したチーム通話
...
Lync Server 2013 は、場所に基づくルーティングを使用したチーム通話をサポートしています。

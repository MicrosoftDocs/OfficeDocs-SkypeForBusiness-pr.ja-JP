...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dn720559(v=OCS.15)
ms:contentKeyID: 62227430
ms.date: 05/19/2016
...
<td><p>Deploy Call Reliability and Media Quality MonitoringCall reliability and media quality monitoring use the 監視サーバー computer as their watcher node to monitor call reliability and media quality of Lync Server. Both of these features query the 監視サーバー databases to do analysis.</p></td>
<td><p>Central Site</p>
<p>Branch Site</p></td>
</tr>
<tr class="even">

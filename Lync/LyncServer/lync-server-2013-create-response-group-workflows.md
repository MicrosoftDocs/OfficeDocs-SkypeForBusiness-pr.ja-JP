...
---
# <a name="create-response-group-workflows-in-lync-server-2013"></a>Lync Server 2013 で応答グループのワークフローを作成する
...
応答グループ構成ツールを使用して、ワークフローを作成します。 応答グループ構成ツールには、Lync Server コントロールパネルの [応答グループ] ページからアクセスできます。

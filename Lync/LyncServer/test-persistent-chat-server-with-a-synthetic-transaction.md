...
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a><span data-ttu-id="0b4a7-102">代理トランザクションを使用した常設チャット サーバー のテスト</span><span class="sxs-lookup"><span data-stu-id="0b4a7-102">Test Persistent Chat Server with a synthetic transaction</span></span>
...
<span data-ttu-id="0b4a7-103">_**最終更新日:** 2012-09-21_</span><span class="sxs-lookup"><span data-stu-id="0b4a7-103">_**Topic Last Modified:** 2012-09-21_</span></span>

<span data-ttu-id="0b4a7-104">2人のユーザー間のチャットルームでメッセージを送受信するための常設チャットサーバーをテストするには</span><span class="sxs-lookup"><span data-stu-id="0b4a7-104">To test Persistent Chat Server for sending and receiving messages in a chat room between two users</span></span>
...
<span data-ttu-id="0b4a7-105">または</span><span class="sxs-lookup"><span data-stu-id="0b4a7-105">or</span></span>
...
<span data-ttu-id="0b4a7-106">または</span><span class="sxs-lookup"><span data-stu-id="0b4a7-106">or</span></span>

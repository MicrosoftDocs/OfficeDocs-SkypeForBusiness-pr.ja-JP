...
このセクションでは、Microsoft Office Communications Server 2007 R2 または Microsoft Lync Server 2010 から Microsoft lync server 2013、microsoft lync server 2010、グループチャットから Microsoft Lync Server 2013、常設チャットサーバー、およびから移行する方法について説明します。Microsoft Office Communications Server 2007 R2 グループチャットを常設チャットサーバーに接続します。

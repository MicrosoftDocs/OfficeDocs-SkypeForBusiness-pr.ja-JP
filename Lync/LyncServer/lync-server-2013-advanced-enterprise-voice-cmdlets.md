...
description: 'Lync Server 2013: 高度なエンタープライズ Voip のコマンドレット。'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48561943"
---
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Lync Server 2013 の高度なエンタープライズ Voip のコマンドレット
...
## <a name="advanced-enterprise-voice-cmdlets"></a>高度なエンタープライズ VoIP のコマンドレット

次の一覧には、エンタープライズ VoIP 展開の高度な機能を管理するためのコマンドレットが含まれます。

**[Lync Server 2013 での通話受付管理のコマンドレット](lync-server-2013-call-admission-control-cmdlets.md)**
...
**[Lync Server 2013 の拡張9-1-1 コマンドレット](lync-server-2013-enhanced-9-1-1-cmdlets.md)**
...
**[共有回線の外観 (SLA) のコマンドレット](shared-line-appearance-sla-cmdlets.md)**
...
**[Lync Server 2013 のメディア構成のコマンドレット](lync-server-2013-media-configuration-cmdlets.md)**

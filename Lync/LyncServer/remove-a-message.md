...
# <a name="remove-a-message"></a><span data-ttu-id="7cd93-102">メッセージを削除する</span><span class="sxs-lookup"><span data-stu-id="7cd93-102">Remove a message</span></span>
...
<span data-ttu-id="7cd93-103">_**トピックの最終更新日:** 2012-04-04_</span><span class="sxs-lookup"><span data-stu-id="7cd93-103">_**Topic Last Modified:** 2012-04-04_</span></span>

<span data-ttu-id="7cd93-104">メッセージを削除するには</span><span class="sxs-lookup"><span data-stu-id="7cd93-104">To remove a message</span></span>

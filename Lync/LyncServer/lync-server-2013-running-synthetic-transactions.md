...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dn720911(v=OCS.15)
ms:contentKeyID: 62246637
ms.date: 05/19/2016
...
[監視ノードのテスト ユーザーおよび構成設定の構成](lync-server-2013-configuring-watcher-node-test-users-and-configuration-settings.md)  
[代理トランザクションの特別なセットアップ指示](lync-server-2013-special-setup-instructions-for-synthetic-transactions.md)

...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dn720325(v=OCS.15)
ms:contentKeyID: 62221604
ms.date: 05/19/2016
...
Capacity and availability measurements are repetitive tasks that are ideally suited to automated tools and scripts such as Microsoft System Center Operations Manager (以前の Microsoft Operations Manager), which is discussed later in this document.

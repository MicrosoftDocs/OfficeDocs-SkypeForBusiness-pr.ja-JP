...
# <a name="managing-pin-settings-in-lync-server-2013"></a>Lync Server 2013 での PIN 設定の管理
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Lync Server 2013 での PIN ポリシーの管理](lync-server-2013-managing-pin-policies.md)

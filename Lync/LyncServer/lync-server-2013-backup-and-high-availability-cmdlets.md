...
バックアップおよび高可用性のコマンドレットを使用すると、管理者は Microsoft Lync Server 2013 で導入されたプールバックアップ、復元、および高可用性機能を管理できます。

<div>

## <a name="backup-and-high-availability-cmdlets"></a>バックアップおよび高可用性コマンドレット

以下に、Lync Server トポロジのバックアップと可用性の構成に直接関連するコマンドレットの一覧を示します。

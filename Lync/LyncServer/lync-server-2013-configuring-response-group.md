...
> [!TIP]  
> Lync Server 管理シェルを使用して応答グループを作成する方法の詳細については、「」の「Lync Server 管理シェルを使用して<A href="https://go.microsoft.com/fwlink/p/?linkid=204108">https://go.microsoft.com/fwlink/p/?linkId=204108</A>最初の応答グループを作成する」を参照してください。

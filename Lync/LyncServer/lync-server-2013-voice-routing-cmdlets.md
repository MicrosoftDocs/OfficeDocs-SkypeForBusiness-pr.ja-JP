...
---
# <a name="voice-routing-cmdlets-in-lync-server-2013"></a>Lync Server 2013 での音声ルーティングのコマンドレット
...
音声ルートには、Microsoft Lync Server 2013 に対して、エンタープライズ Voip ユーザーから公衆交換電話網 (PSTN) または構内交換機 (PBX) 上の電話番号への通話をルーティングする方法を指示する指示が含まれています。

<div>

## <a name="voice-routing-cmdlets"></a>音声ルーティングのコマンドレット
...
[Lync Server 2013 の PSTN 接続のコマンドレット](lync-server-2013-pstn-connectivity-cmdlets.md)  

...
デバイス更新ログは、Windows PowerShell と、ユーザーの**クリアな Deviceupdatelog**コマンドレットを使用してクリアできます。 このコマンドレットは、Lync Server 2013 管理シェルから、または Windows PowerShell のリモートセッションから実行できます。

...
> [!NOTE]  
> このトピックでは、「 <A href="lync-server-2013-define-a-mediation-server-in-topology-builder.md">lync server 2013 のトポロジビルダーでの仲介サーバーの定義</A>」 <A href="lync-server-2013-publish-the-topology.md">2013</A>および「展開」のドキュメントの「 <A href="lync-server-2013-software-prerequisites-for-enterprise-voice.md">2013 組織の前提</A>条件」に記載されている前提条件を満たしていること、および仲介サーバープール内のコンピューターが、<A href="lync-server-2013-security-and-configuration-prerequisites-for-enterprise-voice.md">企業のセキュリティおよび構成の前提条件を満たしていることを確認したことを前提とします。Lync Server 2013 の音声</A>。

...
---
# <a name="archiving-and-monitoring-cmdlets-in-lync-server-2013"></a>Lync Server 2013 でのアーカイブと監視のコマンドレット
...
アーカイブおよび監視のコマンドレットを使用すると、管理者がインスタントメッセージと会議セッションのアーカイブを管理できます。通話の詳細情報を記録するにはまた、「QoE (Quality of Experience)」を使用して Microsoft Lync Server 2013 を監視することができます。
...
## <a name="archiving-and-monitoring-cmdlets"></a>アーカイブおよび監視のコマンドレット

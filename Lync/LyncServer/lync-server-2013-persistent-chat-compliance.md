...
# <a name="persistent-chat-compliance-in-lync-server-2013"></a><span data-ttu-id="61920-102">Lync Server 2013 の常設チャットコンプライアンス</span><span class="sxs-lookup"><span data-stu-id="61920-102">Persistent Chat compliance in Lync Server 2013</span></span>
...
<span data-ttu-id="61920-103">_**トピックの最終更新日:** 2012-10-06_</span><span class="sxs-lookup"><span data-stu-id="61920-103">_**Topic Last Modified:** 2012-10-06_</span></span>

<span data-ttu-id="61920-104">新しい常設チャットのコンプライアンス構成を作成するには</span><span class="sxs-lookup"><span data-stu-id="61920-104">To create a new Persistent Chat compliance configuration</span></span>
...
<span data-ttu-id="61920-105">常設チャットのコンプライアンス構成を取得するには</span><span class="sxs-lookup"><span data-stu-id="61920-105">To get Persistent Chat compliance configuration</span></span>

    Get-CsPersistentChatComplianceConfiguration [-Identity <XdsIdentity>] [-LocalStore <Switch Parameter>]

<span data-ttu-id="61920-106">常設チャットのコンプライアンス構成を設定するには</span><span class="sxs-lookup"><span data-stu-id="61920-106">To set Persistent Chat compliance configuration</span></span>
...
<span data-ttu-id="61920-107">常設チャットのコンプライアンス構成を削除するには</span><span class="sxs-lookup"><span data-stu-id="61920-107">To remove Persistent Chat compliance configuration</span></span>

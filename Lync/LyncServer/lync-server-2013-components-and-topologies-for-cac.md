...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Lync Server 2013 を使用した MPLS ネットワーク上の通話受付管理](lync-server-2013-call-admission-control-on-an-mpls-network.md)

  - [Lync Server 2013 での SIP トランク上の通話受付管理](lync-server-2013-call-admission-control-on-a-sip-trunk.md)

  - [サードパーティの PSTN ゲートウェイまたは PBX での Lync Server 2013 での通話受付管理](lync-server-2013-call-admission-control-with-a-third-party-pstn-gateway-or-pbx.md)

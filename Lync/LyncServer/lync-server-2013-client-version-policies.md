...
クライアントバージョンポリシーは、グローバルに、または特定のサイト、プール、またはユーザーのグループに一連のクライアントバージョン管理ルールを適用するために使用されます。 Lync Server 2013 のクライアントバージョンポリシーを構成するには、以下の手順を使用します。

<div>

## <a name="in-this-section"></a>このセクションの内容

  - [Lync Server 2013 でクライアントバージョンポリシーを表示する](lync-server-2013-view-client-version-policies.md)

  - [Lync Server 2013 で新しいクライアントバージョンポリシーを作成または変更する](lync-server-2013-create-or-modify-a-new-client-version-policy.md)

...
14. [**確定**] をクリックし、[**すべて確定**] をクリックします。
    ...
    テストで採用されているダイヤルプランが、プラス記号 (+ 12065551219 など) で始まる電話番号を正規化している場合、そのプランでは音声ルーティングテストが失敗する可能性があります。 (ダイヤルプランと音声ルートは機能しますが、実際にはテスト Get-csdialplan は成功します。 ただし、音声ルーティングテストは失敗する可能性があります。)これは、音声ルートをテストするときに留意すべきことです。

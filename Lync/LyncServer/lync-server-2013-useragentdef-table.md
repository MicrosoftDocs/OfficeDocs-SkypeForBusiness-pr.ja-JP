...
TOCTitle: UserAgentDef テーブル
ms:assetid: 96c49239-d999-4045-8b64-9d1940cce8ff
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205100(v=OCS.15)
ms:contentKeyID: 48272947
ms.date: 05/19/2016
...
UserAgentDef テーブルでは、ユーザー エージェントの識別子をエージェントの説明的な名前にマップします。ユーザー エージェントは、Microsoft Lync Server 2013 への接続に使用するソフトウェア クライアントです。このテーブルは、Microsoft Lync Server 2013 で導入されました。

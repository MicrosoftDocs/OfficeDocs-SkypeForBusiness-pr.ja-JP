...
# <a name="application-table-in-lync-server-2013"></a>Lync Server 2013 のアプリケーションテーブル
...
このテーブルには、ルーティングと接続に関係する Lync Server 2013 内のさまざまなプロセスに関する情報が格納されます。

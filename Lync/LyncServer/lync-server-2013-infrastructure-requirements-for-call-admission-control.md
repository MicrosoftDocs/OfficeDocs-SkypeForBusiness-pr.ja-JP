...
特殊なネットワーク ルーターなどの追加のインフラストラクチャ要件は不要です。 Lync Server 2013 を展開すると、通話受付管理 (CAC) ポリシーを強制するために使用される帯域幅ポリシーサービスが自動的にインストールされます。 通話受付管理は、Lync を実行しているクライアントでのみ動作します。

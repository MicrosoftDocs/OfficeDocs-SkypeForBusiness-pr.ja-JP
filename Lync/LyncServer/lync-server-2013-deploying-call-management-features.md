...
エンタープライズ VoIP 通話管理機能は、着信通話のルーティング方法と応答方法を制御します。 Lync Server 2013 には、次の通話管理機能があります。
  ...
  - **グループピックアップ:** ユーザーが、通話ピックアップグループ番号をダイヤルすることによって、ピックアップグループに割り当てられた別のユーザーに対して行われた通話に応答できるようにします。
...
## <a name="in-this-section"></a>このセクションの内容
  ...
  - [Lync Server 2013 でグループ通話ピックアップを構成する](lync-server-2013-configuring-group-call-pickup.md)

  - [Lync Server 2013 で応答グループを構成する](lync-server-2013-configuring-response-group.md)

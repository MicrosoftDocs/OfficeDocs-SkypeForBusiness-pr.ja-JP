...
<td><p>' このカテゴリ</p></td>
<td><p>若干</p></td>
<td><p>ダイアログのカテゴリ: 0 は、仲介サーバーに対する Lync サーバーです。1は、PSTN ゲートウェイレグへの仲介サーバーです。</p></td>
</tr>
<tr class="odd">
...
<td><p>int</p></td>
<td><p>通話に使用されるオーディオコーデック。 <a href="lync-server-2013-payloaddescription-table.md">Lync Server 2013 の PayloadDescription テーブル</a>から参照されます。</p></td>
</tr>
<tr class="even">

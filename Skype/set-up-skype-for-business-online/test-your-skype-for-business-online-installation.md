...
- Skype for Business Online の電話会議プロバイダーがセットアップされたアカウント。詳細については、「[Skype for Business および Microsoft Teams の電話会議のセットアップ](../audio-conferencing-in-office-365/set-up-audio-conferencing-for-skype-for-business-and-microsoft-teams.md)」をご覧ください。
...
1. [ **管理者**]、[ **Office 365**]、[ **ユーザーとグループ** ] に移動し、[追加]![追加](../images/328ffb57-5f31-430a-b653-4a6b8e76d338.png) をクリックして、必要な情報を入力します。
...
詳細については、「[Skype for Business および Microsoft Teams の電話会議のセットアップ](../audio-conferencing-in-office-365/set-up-audio-conferencing-for-skype-for-business-and-microsoft-teams.md)」をご覧ください。
...
|[Lync for Office 365 についてのよく寄せられる質問 (FAQ)](https://support.office.com/article/29fa2061-f679-4e0d-902d-736b67774c8b#BKMK_ContactsFAQ) <br/> |選択した連絡先グループに、追加した連絡先が表示されます。  <br/> |

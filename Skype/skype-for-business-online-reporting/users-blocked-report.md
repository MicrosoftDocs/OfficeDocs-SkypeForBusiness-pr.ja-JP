...
テーブルでは、呼び出しからブロックされているユーザーのすべての分類を示します。 電話システムまたはそれらに割り当てられた電話会議を持っているすべてのユーザーが表示されます。 追加または削除できるテーブルの列です。
***
...
これは、すべてのユーザーのデータをエクスポートし、単純な並べ替えとフィルタ リングを詳細に分析を行うことができます。 2000 未満のユーザーをした場合は、並べ替えし、フィルター処理、レポート内のテーブル内でします。 2000 以上のユーザーは、[フィルターと並べ替えの順序である場合は場合、は、データをエクスポートする必要があります。
***

...
このレポートとは、ビジネス レポートの場合は、他の Skype 詳細を確認できます会議の活動を組織全体にわたって。 これらの詳細については、調査、計画、および、組織の他のビジネスの意思決定を行うときに非常に役に立つ。
...
***
![番号 2](../images/sfbcallout2.png)<br/>各レポートには、このレポートが生成されたときの日付があります。 レポートは、通常、活動の時間から 24-48 時間の遅延時間を反映します。 
***
...
***
![番号 5](../images/sfbcallout5.png)<br/>**分**のグラフの利用状況の傾向を理解して、オーディオ/ビデオ、およびダイヤルインとダイヤルアウト用の電話会議のために Microsoft を使用してください。 会議を整理するときに、ユーザーが使用する分の数を確認するのには対話型のグラフのデータを使用してください。プロバイダーです。 分の**オーディオ/ビデオ**会議中に使用されるが参加している数の合計に表示されます。
***

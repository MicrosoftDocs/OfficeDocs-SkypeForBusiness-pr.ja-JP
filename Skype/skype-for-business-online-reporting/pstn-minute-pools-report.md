...
f1keywords: None
ms.custom: Reporting
description: "ビジネス管理センターのレポート領域の新しい Skype では、組織内を呼び出し、オーディオ会議のアクティビティを示しています。 各ユーザーの操作に関する詳細な洞察を提供するレポートにドリル ダウンすることができます。 などのビジネス PSTN 分プール レポートの Skype を使用すると、組織内で現在の月の期間中に消費する分の数を参照してください。"
...
ビジネス管理センター**のレポート**領域の新しい Skype は、組織内を呼び出し、オーディオ会議のアクティビティを示しています。 各ユーザーの操作に関する詳細な洞察を提供するレポートにドリル ダウンすることができます。 たとえば、 **Skype**ビジネス PSTN 分プールのレポートを使用すると、組織内で現在の月の期間中に消費する分の数を参照してください。
...
***
![番号 3](../images/sfbcallout3.png)<br/>また、[ **Excel にエクスポート**] をクリックまたはタップして、レポート データを Excel の .csv ファイルにエクスポートすることもできます。 <br/><br/> これは、すべてのユーザーのデータをエクスポートし、単純な並べ替えとフィルタ リングを詳細に分析を行うことができます。 2000 未満のユーザーをした場合は、並べ替えし、フィルター処理、レポート内のテーブル内でします。 2000 以上のユーザーは、[フィルターと並べ替えの順序である場合は場合、は、データをエクスポートする必要があります。

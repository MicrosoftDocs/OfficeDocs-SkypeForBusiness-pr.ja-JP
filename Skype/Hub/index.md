                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Office 365 環境で Skype for Business Online を管理するためのリソースをご覧ください。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>組織のために Skype for Business Server を展開し、管理します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Skype for Business の PowerShell リファレンス</h3>
                                                    <p>Skype for Business と Skype for Business Online を管理するために必要な PowerShell コマンドレットを理解します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Microsoft Teams を正しく展開するために必要な計画、方法、実践的なガイダンスを入手します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>エンドユーザー</h3>
                                                    <p>support.office.com で Skype for Business ユーザー向けのヘルプ、トレーニング、テクニカル サポートをご覧いただけます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

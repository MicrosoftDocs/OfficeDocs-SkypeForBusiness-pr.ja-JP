...
description: このセクションのトピックでは、2019 年に移行を完了した後に実行するSkype for Business Serverします。
...
このセクションのトピックでは、2019 年に移行を完了した後に実行するSkype for Business Serverします。
...
- [2019 Skype for Business Serverを展開する](deploy-clients.md)

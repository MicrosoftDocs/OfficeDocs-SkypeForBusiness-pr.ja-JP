...
description: OAuth プロトコルを使用して、Microsoft 365 または Office 365 で SFB 2019 コントロールパネル認証を構成するヘルパースクリプト。
ms.openlocfilehash: 92c13da1146698d130439c1f76e3885b561bec1b
ms.sourcegitcommit: 000515147632c6278bcda4505a1038014dda8e2f
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 05/14/2020
ms.locfileid: "44232598"
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="7dda5-103">Skype for Business Server 2019 コントロールパネル認証スクリプト</span><span class="sxs-lookup"><span data-stu-id="7dda5-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="7dda5-104">このスクリプトは、新しいコントロールパネルのセットアップの一部として、Skype for Business Server 2019 の累積的な更新プログラム1をインストールした後に実行する必要があります。</span><span class="sxs-lookup"><span data-stu-id="7dda5-104">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1, as part of the set-up for the new Control Panel.</span></span> <span data-ttu-id="7dda5-105">このスクリプトは azure に Azure AD アプリケーションを作成します。</span><span class="sxs-lookup"><span data-stu-id="7dda5-105">This script will create an Azure AD Application on Azure.</span></span> <span data-ttu-id="7dda5-106">これは、新しいコントロールパネルで OAuth を使用して Microsoft 365 または Office 365 にサインインするのに役立ちます。</span><span class="sxs-lookup"><span data-stu-id="7dda5-106">This will help in signing into Microsoft 365 or Office 365 using OAuth in the new Control Panel.</span></span>

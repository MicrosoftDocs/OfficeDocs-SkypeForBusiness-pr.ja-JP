...
||コンテンツ|説明|
|:-----|:-----|:-----|
|![ドキュメントのアイコン](https://docs.microsoft.com/office/media/icons/paragraph-writing-blue.svg)|[ビジネス サーバー 2019 Skype のシステム要件](../plan/system-requirements.md)  <br/> |サーバーと Skype のビジネス サーバーの環境の要件について説明します。  <br/> |
|![ドキュメントのアイコン](https://docs.microsoft.com/office/media/icons/paragraph-writing-blue.svg)|[Skype ビジネス サーバーのトポロジの基本](../../SfbServer/plan-your-deployment/topology-basics/topology-basics.md) <br/> |ビジネス サーバーの Skype のトポロジー ・ オプションとサーバ コロケーションのシナリオについて説明します。  <br/> |

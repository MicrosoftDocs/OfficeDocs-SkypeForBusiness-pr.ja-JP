...
監視を実行しているサーバーの Reporting Services レポートの展開の詳細については、「Install [Monitoring Reports in Skype for Business Server 2015」を参照](../../deploy/deploy-monitoring/install-monitoring-reports.md)してください。

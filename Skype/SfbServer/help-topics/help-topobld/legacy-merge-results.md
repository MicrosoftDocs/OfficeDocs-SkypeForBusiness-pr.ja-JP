...
ms.locfileid: "32200166"
---
# <a name="legacy-merge-results"></a><span data-ttu-id="23b0e-104">従来のマージの結果</span><span class="sxs-lookup"><span data-stu-id="23b0e-104">Legacy Merge Results</span></span>

<span data-ttu-id="23b0e-105">ビジネス サーバーの Skype での従来の配置をマージするには、**次**の手順をクリックします。</span><span class="sxs-lookup"><span data-stu-id="23b0e-105">To begin merging a legacy deployment with Skype for Business Server, click **Next**.</span></span> <span data-ttu-id="23b0e-106">トポロジ ビルダー結合ウィザードの実行の詳細については、「移行」のドキュメントの「[Merge Using Topology Builder Merge Wizard](https://technet.microsoft.com/library/c3f3c425-dab6-4dcd-bf0e-d7fde05f2ebf.aspx)」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="23b0e-106">For details about running the Topology Builder merge wizard, see [Merge Using Topology Builder Merge Wizard](https://technet.microsoft.com/library/c3f3c425-dab6-4dcd-bf0e-d7fde05f2ebf.aspx) in the Migration documentation.</span></span>

...
中央管理ストアの詳細については、 [Lync Server 2010 中央管理サーバーは、Lync Server 2013 への移動](http://technet.microsoft.com/library/30cc98f2-1916-4dbe-99d0-8df5368ed3ec.aspx)を参照してください。

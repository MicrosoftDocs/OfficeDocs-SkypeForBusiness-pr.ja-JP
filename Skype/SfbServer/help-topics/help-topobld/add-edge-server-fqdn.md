...
また、[**単一の FQDN &amp; IP アドレスを使用**する] オプションを選択した場合は、各エッジサービス 444 (アクセスエッジサービスの場合は8057、Web 会議エッジサービスの場合は、a/V Edge サービスの場合は 443) に異なるポート番号を指定する必要があります。 このオプションを選択しなかった場合は、3つのサービスすべてに同じポート番号 (443 など) を使用できます。

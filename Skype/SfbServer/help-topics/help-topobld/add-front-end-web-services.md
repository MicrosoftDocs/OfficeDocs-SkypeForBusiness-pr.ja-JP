...
サーバーの内部 Web サービス プールの完全修飾ドメイン名 (FQDN) をStandard Editionできません。 Enterprise Edition フロントエンド プールのドメイン ネーム システム (DNS) 負荷分散を構成する場合は、別の内部ベース URL を指定できます。これは、プール FQDN (internal-\<your base URL\>など) とは異なる必要があります。

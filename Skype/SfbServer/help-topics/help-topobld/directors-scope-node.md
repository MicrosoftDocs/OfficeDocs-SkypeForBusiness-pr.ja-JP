...
[**ディレクター プール**] ノードには、トポロジ内のディレクター プールが一覧表示されます。以下のアクションを実行できます。
  
- **新しいディレクター プール**。トポロジに新しいディレクター プールを追加するときに使用する、**新しいディレクター プールの定義**ウィザードを起動します。
    
ディレクター プールのオプションに加えて、以下に示す全般的なタスクを実行できます。

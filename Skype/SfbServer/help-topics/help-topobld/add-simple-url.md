...
簡易 URL の追加の詳細については [、Skype for Business Server 2015](../../plan-your-deployment/network-requirements/simple-urls.md)の簡易 URL の DNS 要件を参照してください。

...
- **新しいサーバー**。この信頼済みアプリケーション プールに別のサーバーを追加するときに使用する、[**新しいサーバーの定義**] ウィザードを起動します。
    
- **プロパティの編集**。このサーバーの [**プロパティの編集**] ページを開きます。このページで、内部プールと外部プールの FQDN およびポートの設定、フェデレーションとネットワーク アドレス変換 (NAT) の有効化と無効化、および次ホップ プールの指定を行うことができます。

...
仲介サーバー プールまたは仲介サーバーの設定の詳細については、「展開」のドキュメントの [「Deploy a Mediation Server in Topology Builder in Skype for Business Server 2015」](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) を参照してください。

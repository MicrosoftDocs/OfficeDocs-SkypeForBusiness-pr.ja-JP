...
description: 常設チャット プールの新しい定義ウィザードを使用して、新しい常設チャット サーバーまたは常設チャット サーバー プールを作成します。 複数コンピューター プールまたは 1 台のコンピューター プールのどちらかを選択します。 1 台のコンピューター プールを選択し、後で複数のコンピューター プールが必要な場合は、単一のコンピューター プールを削除してから、複数のコンピューター プールを定義する必要があります。

...
仲介サーバープールまたは仲介サーバーの設定の詳細については、展開ドキュメントの「 [Skype For Business Server のトポロジビルダーに仲介サーバーを展開](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md)する」を参照してください。

...
プールの仲介サーバーまたは仲介サーバーの設定についての詳細は、展開に関するドキュメントで[Skype のビジネス サーバーで、トポロジ ビルダーでの仲介サーバーの展開](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md)を参照してください。

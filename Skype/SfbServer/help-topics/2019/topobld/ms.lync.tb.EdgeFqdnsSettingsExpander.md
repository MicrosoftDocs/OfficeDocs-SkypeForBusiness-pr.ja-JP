...
ms.locfileid: "41688600"
---
# <a name="edge-server-fqdns-settings-expander"></a><span data-ttu-id="b106f-103">エッジ サーバーの FQDN 設定エキスパンダー</span><span class="sxs-lookup"><span data-stu-id="b106f-103">Edge Server FQDNs Settings Expander</span></span>

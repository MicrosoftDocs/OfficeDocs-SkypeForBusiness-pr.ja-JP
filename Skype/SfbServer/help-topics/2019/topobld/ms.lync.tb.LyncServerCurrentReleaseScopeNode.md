...
ms.locfileid: "32235421"
---
# <a name="skype-for-business-server-create-new-expander"></a>Skype ビジネス サーバーの新しい展開を作成します。
 
**Skype ビジネス サーバー**を右クリックし、**新規**作成] を選択するを作成するサーバーの役割を選択するとして、トポロジ ビルダーで新しいサーバーの役割を作成できます。

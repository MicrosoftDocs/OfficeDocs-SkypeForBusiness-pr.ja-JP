...
サーバーの全体管理サーバー ストアの移動の詳細については[、「Move-CsManagementServer」](/powershell/module/skype/move-csmanagementserver?view=skype-ps)の「サーバー全体のコマンドレットリファレンスWindows PowerShell参照してください。

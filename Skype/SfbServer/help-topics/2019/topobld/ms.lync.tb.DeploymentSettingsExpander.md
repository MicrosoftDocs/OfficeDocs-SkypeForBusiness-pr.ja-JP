...
> [!NOTE]
> アクティブな URL は SIP ドメインごとに 1 つのみ使用できます。
...
中央管理ストアの移動の詳細については、次のコマンドレット リファレンスの [「Move-CsManagementServer」Windows PowerShell](https://docs.microsoft.com/powershell/module/skype/move-csmanagementserver?view=skype-ps) 参照してください。

...
---
# <a name="add-edge-server-ip-options"></a>エッジ サーバーの IP オプションを追加します。
 
Microsoft Lync Server 2013 を使用すると、エッジ サーバーおよびエッジ プールの各インタ フェースの IPv4 と IPv6 のアドレスを構成できます。 これを行うには、次の項目を行います。

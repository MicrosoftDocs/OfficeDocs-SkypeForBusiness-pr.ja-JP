...
ms.locfileid: "33910799"
---
# <a name="edge-server-scope-node"></a>エッジ サーバー スコープ ノード
 
このノードには、このエッジ プールの完全修飾ドメイン名 (FQDN) およびその他の基本設定が表示されます。以下のアクションを実行できます。
  
- **新しいサーバー**。**新しいサーバーの定義**ウィザードを起動します。このウィザードを使用して、このプールに別のエッジ サーバーを追加できます。
    
- **プロパティの編集**。このサーバーの [**プロパティの編集**] ページを開きます。このページで、内部プールと外部プールの FQDN およびポートの設定、フェデレーションとネットワーク アドレス変換 (NAT) の有効化と無効化、および次ホップ プールの指定を実行できます。

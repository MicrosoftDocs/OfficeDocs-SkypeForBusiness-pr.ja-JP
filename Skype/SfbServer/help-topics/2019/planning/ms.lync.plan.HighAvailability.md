...
高可用性のために環境を準備する方法の詳細については、「高可用性と障害復旧を計画[する」](../../../plan-your-deployment/high-availability-and-disaster-recovery/high-availability-and-disaster-recovery.md)を参照Skype for Business Server。

...
ms.locfileid: "20046110"
---
# <a name="view-gateways-import-configuration"></a>表示ゲートウェイ (構成のインポート)
 
**導入のゲートウェイ**では、選択した音声構成ファイルをインポートするゲートウェイをクリックします。

...
詳細については、サポートされている Active Directory トポロジは、サポート ドキュメントの[アクティブなディレクトリのサポート](https://technet.microsoft.com/library/28ed9ac4-586d-4803-ad45-99c4fa793f54.aspx)を参照してください。 Active Directory の準備についての詳細は、展開に関するドキュメントの[概要の Active Directory ドメイン サービスの準備](https://technet.microsoft.com/library/cdd2a652-6a0d-4728-9950-3fcaa7a80066.aspx)を参照してください。

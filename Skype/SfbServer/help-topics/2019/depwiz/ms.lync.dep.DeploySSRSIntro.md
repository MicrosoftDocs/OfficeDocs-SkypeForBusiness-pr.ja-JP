...
使用率の監視サーバーの容量を超えていない場合、サイトのすべてのプールと複数の中央サイトのプールも、同じサーバーの監視に使用します。 監視をサポートするためにトポロジの設計についての詳細は、展開に関するドキュメントで[ビジネス サーバー 2015 の Skype でのフロント エンド プールを使用して監視ストアを関連付ける](../../../deploy/deploy-monitoring/associate-a-monitoring-store.md)を参照してください。

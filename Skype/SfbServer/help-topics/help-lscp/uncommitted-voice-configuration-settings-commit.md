...
ms.locfileid: "41685660"
---
# <a name="uncommitted-voice-configuration-settings-commit"></a>コミットされていない音声構成設定: コミット
 
[**未確定の音声構成設定**] ダイアログ ボックスを使用すると、加えた変更をすべて確認することができます。ダイアログ ボックス内をスクロールして未確定の変更をすべて確認するか、矢印をクリックして別のセクションを展開または折りたたみます。終了したら、[**コミット**] をクリックしてそれらの変更をすべて確定するか、[**キャンセル**] をクリックして戻り、変更点を修正します。

...
ms.locfileid: "51099463"
---
# <a name="set-pin"></a>PIN の設定

ユーザーの PIN を生成するには、[有効な PIN を **自動的に生成する] を選択します**。
...
[ユーザー PIN](/previous-versions/office/lync-server-2013/lync-server-2013-managing-user-pins)
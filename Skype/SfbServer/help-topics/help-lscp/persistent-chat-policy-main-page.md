...
**永続的なチャット**グループの**永続的なチャットのポリシー** ] ページを使用するには既定のグローバル ポリシーを構成する 1 つまたは複数追加ユーザーとサイトのポリシーを作成するなど、グローバル、プール、サイト、またはユーザー レベルでポリシーを管理するために、展開します。 永続的なチャット サーバーのポリシーによって、ユーザーが有効な場合は、それらのクライアントに永続的なチャット サーバーの環境が表示されます。
  
> [!NOTE]
> 永続的なチャット サーバー サイトのポリシーは、トポロジはユーザーのプール、またはユーザーのサイト、または接続ユーザー数、グローバルに適用されます。 
...
ビジネス用の Skype ユーザーが有効になって場合、を有効にするか、永続的なチャット サーバーを無効にする特定のユーザーに適切なポリシーを適用できます。

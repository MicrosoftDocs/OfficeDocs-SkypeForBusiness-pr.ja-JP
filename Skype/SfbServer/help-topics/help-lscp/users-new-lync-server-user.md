...
ms.locfileid: "58591551"
---
# <a name="users-new-lync-server-user"></a>ユーザー: 新しい Lync Server ユーザー

目的に合ったトピックをクリックしてください。実行するタスクへのリンクをクリックしてください。

- [Lync Server 2010 に新しいユーザーを追加する](/previous-versions/office/lync-server-2013/lync-server-2013-add-and-enable-user-account-for-lync-server)
...
- [ユーザーごとの PIN ポリシーの割り当て (2015 年Skype for Business Server)](../../manage/authentication/assign-a-per-user-pin-policy.md)

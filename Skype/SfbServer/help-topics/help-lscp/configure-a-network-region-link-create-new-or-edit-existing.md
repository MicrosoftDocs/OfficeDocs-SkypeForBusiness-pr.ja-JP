---
title: ネットワーク地域リンクの作成または既存の編集を構成する
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
ms.locfileid: "49807357"
---
# <a name="configure-a-network-region-link-create-new-or-edit-existing"></a>ネットワーク地域リンクの構成: 新規作成または現在の形式のままで編集

...
1 つ以上のチャット ルームを管理できる常設チャット ルームの管理者は、クライアントを使用して会議室管理 Web アプリケーションを起動して、会議室を作成および管理できます (または、ユーザーが呼び出すカスタム ソリューションとワークフローを作成できます)。 常設チャット
  
常設チャット管理者は、コントロール パネルを使用したり、Windows PowerShellを使用して会議室を作成および管理することもできます。
...
[常設チャットの構成] ページで、常設チャット サーバーのオプションをグローバルに構成するか、特定のプールに対して次のタスクを実行できます。

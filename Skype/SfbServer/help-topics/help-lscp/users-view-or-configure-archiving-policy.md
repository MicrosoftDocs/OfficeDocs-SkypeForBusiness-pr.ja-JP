...
ms.locfileid: "60776557"
---
# <a name="users-view-or-configure-archiving-policy"></a>ユーザー: アーカイブ ポリシーの表示または構成

目的に合ったトピックをクリックしてください。実行するタスクへのリンクをクリックしてください。

- [アーカイブ ポリシーPer-User割り当てる](/previous-versions/office/lync-server-2013/lync-server-2013-assign-a-per-user-archiving-policy)

- [ユーザーまたはユーザー グループにアーカイブ ポリシーを適用する](/previous-versions/office/lync-server-2013/lync-server-2013-applying-an-archiving-policy-to-users)

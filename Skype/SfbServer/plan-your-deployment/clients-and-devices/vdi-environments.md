...
機能とサポートされるテクノロジの完全な一覧は、Citrix Web サイトの「[Microsoft Skype for Business XenApp および XenDesktop ユーザーに配信する」を参照してください](https://www.citrix.com/content/dam/citrix/en_us/documents/products-solutions/delivering-microsoft-lync-to-xenapp-and-xendesktop-users.pdf)。
...
Microsoft VDI プラグインは [、Microsoft Lync VDI 2013 プラグイン (32 ビット)](https://www.microsoft.com/download/details.aspx?id=35457) または [Microsoft Lync VDI 2013 プラグイン (64 ビット) で利用](https://www.microsoft.com/download/details.aspx?id=35454)できます。 このプラグインは、名前にもかかわらず、Skype for Business 2015 クライアントでサポートされています。
...
Microsoft VDI プラグインは [、Microsoft Lync VDI 2013 プラグイン (32 ビット)](https://www.microsoft.com/download/details.aspx?id=35457) または [Microsoft Lync VDI 2013 プラグイン (64 ビット) で利用](https://www.microsoft.com/download/details.aspx?id=35454)できます。
...
> [!NOTE]
> Citrix RealTime 最適化パックは、データのMicrosoft 365サポートOffice 365。 Citrix ベースの仮想環境については、サポートされている機能とバージョン[](https://docs.citrix.com/en-us/hdx-optimization/2-0/hdx-realtime-optimization-pack-about.mdl)の一覧について、Citrix の技術概要のドキュメントを参照してください。

...
ソリューションを提供するパートナーエンタープライズ VoIP詳細については[、「Microsoft Unified Communications Partners web サイト」を参照してください](https://go.microsoft.com/fwlink/p/?linkId=202836)。
  
PSTN ゲートウェイを含むハードウェア エンタープライズ VoIPを提供するパートナーの詳細については[、「Microsoft Unified Communications Partners web サイト」を参照してください](https://go.microsoft.com/fwlink/p/?linkId=202836)。

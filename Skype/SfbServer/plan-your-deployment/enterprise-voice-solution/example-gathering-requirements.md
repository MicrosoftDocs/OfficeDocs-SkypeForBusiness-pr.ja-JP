...
2. 各ネットワーク地域Skype for Business Server CAC を管理する中央サイトを特定します。
...
6. ネットワーク地域間のリンクをマップします。 リンクごとに、ネットワーク管理者がメディア トラフィックに対して設定した帯域幅容量Skype for Business Server説明します。
...
2. 各ネットワーク地域の関連付けられた中央サイトを識別します。 中央サイトには少なくとも 1 つのフロント エンド サーバーが含まれているので、ネットワーク領域の WAN 接続を通過するすべてのメディア トラフィックの CAC を管理する Skype for Business Server 展開です。
   ...
   **3 つのネットワーク地域に分けられたエンタープライズ ネットワークの例**
    ...
    前のネットワーク トポロジの例では、CAC を管理する中央サイトSkype for Business Server 3 つのネットワーク領域があります。 ネットワーク地域の適切な中央サイトは、地理的な近さによって選ばれます。 メディア トラフィックはネットワーク地域内で最も重くなるため、所有権が地理的な近さで決まることで自己完結型となり、その他の中央サイトが使用できなくなった場合でも、機能し続けます。 

    この例では、シカゴというSkype for Business展開が北アメリカ地域の中央サイトです。

    北米Skype for Businessのすべてのユーザーは、シカゴ展開のサーバーに配置されます。 次の表に 3 つすべてのネットワーク地域の中央サイトを示します。
    ...
    **ネットワーク地域と関連付けられた中央サイト**
    ...
    > [!NOTE]
    > トポロジに応Skype for Business Server、同じ中央サイトを複数のネットワーク領域に割り当てることができます。 
...
5. 帯域幅の制限がある WAN リンクに対して、次の項目を決定します。
   ...
   - すべての同時音声セッションに対して設定したい全体的な帯域幅制限。 新しいオーディオ セッションでこの制限を超える場合は、Skype for Business Serverを開始できません。

   - それぞれ個別の音声セッションに対して設定したい帯域幅制限。既定の CAC 帯域幅制限は 175 kbps ですが、管理者はこれを変更することができます。

   - すべての同時ビデオ セッションに対して設定したい全体的な帯域幅制限。 新しいビデオ セッションでこの制限を超える場合、Skype for Business Server開始できません。
   ...
   - それぞれ個別のビデオ セッションに対して設定したい帯域幅制限。 既定の CAC 帯域幅制限は 700 kbps ですが、管理者はこれを変更することができます。
     ...
     **WAN 帯域幅制限情報 (帯域幅は kbps で表示) とネットワーク サイト**
     ...
     |:-------------------|:---------------------|:------------------|:------------------|:------------------------|:------------------|:------------------------|
     | アルバカーキ  <br/> | 北アメリカ  <br/> | 5,000 人  <br/>      | 2,000  <br/>      | 175  <br/>              | 1,400  <br/>      | 700  <br/>              |
     | Reno  <br/>        | 北アメリカ  <br/> | 10,000  <br/>     | 4,000  <br/>      | 175  <br/>              | 2,800  <br/>      | 700  <br/>              |
     | ポートランド  <br/>    | 北アメリカ  <br/> | 5,000 人  <br/>      | 4,000  <br/>      | 175  <br/>              | 2,800  <br/>      | 700  <br/>              |
...
6. ネットワークのすべてのサブネットに対し、関連付けられるネットワーク サイトを指定します。
   ...
   **ネットワーク サイトと関連付けられたサブネット (帯域幅は kbps で表示)**
   ...
   |:-------------------|:---------------------|:------------------|:------------------|:------------------------|:------------------|:------------------------|:-----------------------------------------------------------------------|
   | アルバカーキ  <br/> | 北アメリカ  <br/> | 5,000 人  <br/>      | 2,000  <br/>      | 175  <br/>              | 1,400  <br/>      | 700  <br/>              | 172.29.79.0/23, 157.57.215.0/25, 172.29.90.0/23, 172.29.80.0/24  <br/> |
   | Reno  <br/>        | 北アメリカ  <br/> | 10,000  <br/>     | 4,000  <br/>      | 175  <br/>              | 2,800  <br/>      | 700  <br/>              | 157.57.210.0/23, 172.28.151.128/25  <br/>                              |
   | ポートランド  <br/>    | 北アメリカ  <br/> | 5,000 人  <br/>      | 4,000  <br/>      | 175  <br/>              | 2,800  <br/>      | 700  <br/>              | 172.29.77.0/24 10.71.108.0/24, 157.57.208.0/23  <br/>                  |
...
7. 通話Skype for Business Server管理では、ネットワーク地域間の接続は地域リンクと呼ばれる。 各地域リンクに対し、ネットワーク サイトでしたように、次の項目を決定します。
...
9. 単一のリンク (サイト間リンクと呼ばれます) で直接接続されているネットワーク サイトのペアに対して、次の項目を決定します。
   ...
   **2 つのネットワーク サイト間のサイト間リンクの帯域幅情報 (帯域幅は kbps で表示)**
   ...
   |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
   |Reno-Albu-Intersite-Link  <br/> |Reno  <br/> |アルバカーキ  <br/> |20,000  <br/> |12,000  <br/> |175  <br/> |5,000 人  <br/> |700  <br/> |

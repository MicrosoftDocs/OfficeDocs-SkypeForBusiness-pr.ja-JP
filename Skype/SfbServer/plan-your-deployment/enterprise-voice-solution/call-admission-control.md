...
- ブロックされた通話を PSTN に再ルーティングする場合、PSTN の機能と処理能力を確認します。 詳細については、[計画発信呼のルーティング](https://technet.microsoft.com/library/37c55fa4-175a-4190-b9e4-c2e5ac7b9261.aspx)を参照してください。

...
> [!NOTE]
> SIP トランキングでは、スタンドアロンの仲介サーバーを展開することを強くお勧めします。 詳細については、展開に関するドキュメントの[仲介サーバーの展開、および同等の定義](http://technet.microsoft.com/library/a684f1da-6671-4011-adf6-2db49e2528e2.aspx)を参照してください。

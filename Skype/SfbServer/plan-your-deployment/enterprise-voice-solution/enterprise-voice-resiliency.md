...
なお、ユーザー レベルのダイヤル プランと音声ポリシーを作成してから、ブランチ サイトのユーザーに割り当てることもお勧めします。 詳細についてを参照してください[を作成するビジネス サーバーの Skype のダイヤル プランを変更するまたは](../../deploy/deploy-enterprise-voice/dial-plans.md)と展開に関するドキュメントでは、[ブランチ ユーザーの VoIP ルーティング ポリシーを作成します](http://technet.microsoft.com/library/10deca9f-f870-4a42-b25d-e4fc53108658.aspx)。

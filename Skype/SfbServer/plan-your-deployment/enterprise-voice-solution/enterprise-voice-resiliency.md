...
詳細については、これらのフェーズは、展開に関するドキュメントで[、リカバリ性に優れたブランチ アプライアンスまたはサーバーを展開する](https://technet.microsoft.com/library/cb780c14-dc5f-41ba-8092-f20ae905bd16.aspx)を参照してください。

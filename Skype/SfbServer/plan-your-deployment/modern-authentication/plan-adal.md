...
この記事では、Skype for Business Server 2015 の 2016 年 3 月の累積的な更新プログラム (Skype for Business Skype for Business Server の 2016 年 3 月の累積的な更新プログラム)、または Skype for Business Server の初期リリースから確認できるモダン認証 (ADAL および OAuth 2.0 に基づく) について紹介します。2019.
...
- つまり、ユーザーにリソースへのアクセスを許可する専用の接続である OAuth 接続があります。 (OAuth は、"Server-to-Server" 認証というわかりやすい名前でも知られています。多くの場合、S2S と省略されます)。
...
ADAL は Skype for Business Server 2015 年 3 月の累積的な更新プログラムに含まれており、Skype for Business の 2016 **年 3 月** の累積的な更新プログラムをインストールする必要があります。構成を成功するために必要です。 2019 Skype for Business Server、製品の最初のリリースから利用できます。

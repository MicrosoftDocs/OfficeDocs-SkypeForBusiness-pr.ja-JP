...
ビジネス サーバーの Skype では、ダイヤルイン会議の音声案内や音楽のカスタマイズをサポートしていません。 ただし、既定のオーディオ ファイルを変更する必要がある強力なビジネスの必要性がある場合は、マイクロソフト サポート技術情報 961177、[音声案内や電話会議にダイヤルインの音楽ファイルをカスタマイズする方法](http://go.microsoft.com/fwlink/p/?linkid=3052&amp;kbid=961177)を参照してください。

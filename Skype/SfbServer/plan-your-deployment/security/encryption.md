...
> [!NOTE]
> SSL 3.0 に関するセキュリティ アドバイザリが 2014 年に公開されました。 2015 年 2015 年に SSL 3.0 を無効にSkype for Business Serverオプションです。 セキュリティ アドバイザリの詳細については、「[Disabling SSL 3.0 in Lync Server 2013 and Skype for Business Server 2015](/archive/blogs/uclobby/disabling-ssl-3-0-in-lync-server-2013)」を参照してください。<br/>
...
> [!NOTE]
> ハイブリッドのセットアップの詳細については、「ハイブリッド接続を計画 [する」を参照してください](../../../SfbHybrid/hybrid/plan-hybrid-connectivity.md?toc=/SkypeForBusiness/sfbhybridtoc/toc.json)。

...
Microsoft Exchange Server 2016、Microsoft Exchange Server 2013、Microsoft Exchange Server 2010、および SharePoint Skype for Business Server オンプレミスとオンラインの両方のサーバー。 次の表に示す機能は、特に指定しない限り、すべてのクライアントでサポートされます。 クライアントのサポートの詳細については、「Client [](../plan-your-deployment/clients-and-devices/desktop-feature-comparison.md) for Skype for Business Online および Skype for Business Online クライアント比較テーブルのデスクトップ クライアント機能の比較」[をSkype for Businessしてください](/office365/servicedescriptions/skype-for-business-online-service-description/skype-for-business-online-features)。
...
|オンライン会議をスケジュールし、会議に参加Outlook  <br/> |詳細については、「[Integrate Skype for Business Server 2015 with Exchange Server](../deploy/integrate-with-exchange-server/integrate-with-exchange-server.md)。  <br/> |
...
|連絡先リスト (統合連絡先ストア経由)  <br/> |2016 Exchange 2013 年Exchange必要です。  <br/> Lync 2013 または Skype for Businessデスクトップ クライアントが必要です。  <br/>  詳細については、「[Configure Skype for Business Server 2015 to use the unified contact store」を参照してください](../deploy/integrate-with-exchange-server/use-the-unified-contact-store.md)。  <br/> |
|Lync 2013 クライアント、クライアント、および Lync Web App Skype for Business高解像度連絡先写真。  <br/> |2016 Exchange 2013 年Exchange必要です。  <br/> 詳細については、「[Configure use of high-resolution photos in the Skype for Business Server 2015」を参照](../deploy/integrate-with-exchange-server/high-resolution-photos.md)してください。  <br/> mac および Mobile 用 Skype for Business アプリの写真の場合は、「Skype for Business Server 2015 と Exchange Server の間の統合は、「Skype for Business Server でパートナー アプリケーションを構成する」の説明に従[ってセットアップする必要があります。Exchange Server](../deploy/integrate-with-exchange-server/configure-partner-applications.md)。 <br/> |
|会議の委任  <br/> |両方のユーザーが同じフォレストにオンラインでホームされている場合、または両方がオンプレミスの場合にのみサポートされます。 詳細については、「Configure [hybrid connectivity between Skype for Business Server」を参照](../../SfbHybrid/hybrid/configure-hybrid-connectivity.md)Teams。 <br/> |
...
|Lync 2013 クライアント、クライアント、および Lync Web App Skype for Business高解像度連絡先写真。  <br/> |詳細については、「[Configure use of high-resolution photos in the Skype for Business Server 2015」を参照](../deploy/integrate-with-exchange-server/high-resolution-photos.md)してください。  <br/> mac および Mobile 用 Skype for Business アプリの写真の場合は、「Configure integration between on-premises Skype for Business Server」の説明に従って、Skype for Business Server 2015 と Exchange Server の統合を設定する[必要があります。Outlook Web App](../deploy/integrate-with-exchange-server/outlook-web-app.md)。 <br/> |
...
|ボイス メール  <br/> |詳細については、「ホストされている UM での [Lync Server 2013 Users Voice Mail の提供」をExchangeしてください](/previous-versions/office/lync-server-2013/lync-server-2013-providing-lync-server-users-voice-mail-on-hosted-exchange-um)。  <br/> |

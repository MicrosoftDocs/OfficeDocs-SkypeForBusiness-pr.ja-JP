...
されていない場合は、前提条件の[直接ルーティングの計画](plan-direct-routing.md)が読み込まれ、他の手順を確認する必要があります、Microsoft の電話システムのネットワークを構成する前にします。 

  > [!NOTE]
  > このドキュメントは、IT プロフェッショナル向けです。  
...
[直接ルーティングを計画します。](plan-direct-routing.md)

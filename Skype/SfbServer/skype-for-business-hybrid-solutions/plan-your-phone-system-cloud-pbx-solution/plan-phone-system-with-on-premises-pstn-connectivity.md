...
- **Active Directory の同期** Azure サーバー接続を使用して Active Directory 同期を構成ADがあります。 詳細については [、「Azure AD 接続」を参照してください](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-install-custom)。

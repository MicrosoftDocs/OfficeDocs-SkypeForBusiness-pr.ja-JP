...
4. 会議の構成の一覧で、変更する構成をクリックし、[編集] をクリックし、[詳細の表示] **をクリックします**。
...
パラメーターの完全な一覧を含む詳細については、「 [Set-CsMeetingConfiguration」を参照してください](/powershell/module/skype/set-csmeetingconfiguration?view=skype-ps)。

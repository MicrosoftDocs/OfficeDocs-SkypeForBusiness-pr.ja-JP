...
7. ユーザーが匿名ユーザーを会議に招待できないようにするには、**[参加者に匿名ユーザーの招待を許可する]** チェック ボックスをオフにします。 匿名ユーザーとは、組織の Active Directory ドメイン サービスに資格情報を持たないユーザーであり、したがって認証されないユーザーです。 既定では、ユーザーは匿名ユーザーを会議に招待できます。
...
20. 参加者が複数のビデオ ストリームに参加するには、[参加者が複数のビデオ ストリームに参加できる] チェック ボックス **を** オンにします。 既定では、複数のビデオ ストリームが許可されます。

...
4. [ユーザー **] ページの**  [検索] ボックスに、検索する表示名のすべてまたは最初の部分を入力し、Enter キーを **押します**。
...
5. (オプション) 結果を絞り込むための追加の検索条件を次のように指定します。
    ...
    4. テキスト ボックスに、検索結果のフィルターに使用する検索条件を入力し **、[OK] をクリックします**。
...
3. [ユーザーを有効 **にする**  >  **] に移動し**、[追加] を **クリックします**。

4. [検索 **] ボックス** に、表示名のすべてまたは最初の部分を入力し、[検索] を **クリックします**。

5. (省略可能)追加のユーザー条件を指定するには **、[+ フィルターの** 追加] をクリックし、必要なユーザー プロパティを選択し、演算子を選択し、値を入力します。 [**検索**] をクリックします。

6. 表で、ユーザーに追加するアカウントを選択Skype for Business Serverし **、[OK] をクリックします**。

7. ユーザーをプールに割り当て、追加の詳細を指定し、必要なポリシーをユーザーに割り当て、[有効にする] を **クリックします**。
...
3. [ユーザー] **[**  >  **ユーザーを有効にする**  >  **] [新しい Lync Server ユーザー] に移動し、[** 追加] を **クリックします。**
...
4. [ユーザー **] ページの** [検索] **ボックス** に、表示名のすべてまたは最初の部分を入力し、Enter キーを **押します**。
...
5. 表で、無効または再び有効にするユーザー アカウントをダブルクリックします。
    ...
    2. ユーザー アカウントのユーザー アカウントを再び有効にするにはSkype for Business Serverパネルで、[ユーザーの再有効化 **] を選択します**。 表示される次のパネルで、[保存] を **クリックします**。
...
6. [**アクション**] メニューで、次のいずれかを実行します。
   ...
   2. ユーザー アカウントを有効にするには、[Lync Server Skype for Business Server **再有効化] を選択します**。
...
- ユーザー アカウントを一時的に無効にするには、有効なプロパティの値を False ($False) に設定します。 例:
...
- 無効にしたユーザー アカウントを再び有効にするには、enabled プロパティの値を True ($True) に設定します。 例:
...
6. 表示されるパネルで、[ユーザーの削除] **をクリックします**。 表示される次のパネルで **、[OK] をクリックします**。
...
4. [ユーザー **の** 検索] ボックスに、削除するユーザー アカウントの表示名、セキュリティ アカウント マネージャー (SAM) アカウント名、SIP アドレス、または行 Uniform Resource IDENTIFIER (URI) のすべてまたは最初の部分を入力し、[検索] をクリックします。

...
このセクションの障害復旧手順では、次の操作を前提とします。
  ...
  - 「高可用性と障害復旧の計画」の説明に従って、異なるサイトにあるペアのフロント エンド プールを使用した [展開があります](../../plan-your-deployment/high-availability-and-disaster-recovery/high-availability-and-disaster-recovery.md)。 バックアップ サービスは、ペアになったプールの同期を保つためにこれらのプール上で実行されています。

...
Skype for Business Server正規化ルールでは、.NET Frameworkを使用して、ダイヤルされた電話番号を E.164 形式に変換します。つまり、正規化ルールは、ユーザーがダイヤルした電話番号を受け取り、その番号をユーザーが内部的に使用する形式Skype for Business Server。 各ダイヤル プランには、正規化ルールを 1 つ以上割り当てる必要があります。

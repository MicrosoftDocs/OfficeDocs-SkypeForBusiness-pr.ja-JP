...
---
# <a name="p2p-summary-subreport-in-skype-for-business-server-2015"></a>Skype for Business Server 2015 の P2P 概要サブレポート
 
**の概要:**ビジネス サーバー 2015、Skype の P2P 概要サブレポートについて説明します。
...
|**エラー率** <br/> |不可  <br/> |エラーが発生したピアツーピア セッションの割合です。  <br/> |

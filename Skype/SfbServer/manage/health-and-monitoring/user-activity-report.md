---
title: Skype のビジネス サーバー 25 のユーザーの活動をレポート
ms.author: jambirk
author: jambirk
manager: serdars
ms.audience: ITPro
...
description: '概要: は、ビジネスのサーバーの Skype のユーザーの活動のレポートについて説明します。'
ms.openlocfilehash: 13e5eb691e81994e2fac368244522fdcab2003df
ms.sourcegitcommit: e9f277dc96265a193c6298c3556ef16ff640071d
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/24/2018
ms.locfileid: "20981207"
---
# <a name="user-activity-report-in-skype-for-business-server"></a>Skype のビジネス サーバーのユーザーの活動をレポート
 
**の概要:** ビジネス サーバーの Skype のユーザーの活動のレポートについて説明します。

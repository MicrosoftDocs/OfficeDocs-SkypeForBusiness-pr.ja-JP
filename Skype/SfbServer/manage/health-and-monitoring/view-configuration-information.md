...
---
# <a name="view-cdr-configuration-information-in-skype-for-business-server"></a>Skype for Business Server での CDR 構成情報の表示
...
Skype for Business Server をインストールすると、CDR 構成設定の単一のグローバル コレクションが作成されます。 また管理者には、個別のサイトに適用できるカスタム設定コレクションを作成するオプションがあります。 Skype for Business Server コントロール パネルまたは [Get-CsCdrConfiguration](https://docs.microsoft.com/powershell/module/skype/get-cscdrconfiguration?view=skype-ps) コマンドレットを使用して、組織で使用されている CDR 構成設定を表示できます。

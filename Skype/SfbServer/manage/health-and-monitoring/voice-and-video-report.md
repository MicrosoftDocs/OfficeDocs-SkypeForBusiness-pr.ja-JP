...
**概要:**[音声とビデオのピアツーピア レポート] の詳細については、「Skype for Business Server。
...
- 通話の種類ごとの呼び出し (たとえば、PSTN ネットワークSkype for Business通話Skype for Business呼び出しSkype for Business呼び出しなど)
...
次の表に、仲介サーバーごとにピアツーピア音声およびビデオ レポートで提供される情報を示します。

---
title: Skype for Business Server 2015 の通話受付管理レポート
ms.author: jambirk
author: jambirk
manager: serdars
ms.date: 3/28/2016
...
description: '概要: は、ビジネス サーバー 2015 の Skype で使用される電話受付管理のレポートについて説明します。'
...
---
# <a name="call-admission-control-report-in-skype-for-business-server-2015"></a>Skype for Business Server 2015 の通話受付管理レポート
 
**の概要:**ビジネス サーバー 2015 の Skype で使用される電話受付管理のレポートについて説明します。

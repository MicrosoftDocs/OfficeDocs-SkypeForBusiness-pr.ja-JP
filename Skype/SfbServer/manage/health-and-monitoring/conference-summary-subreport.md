...
---
# <a name="conference-summary-subreport-in-skype-for-business-server-2015"></a>Skype for Business Server 2015 の電話会議の概要サブレポート
 
**の概要:**ビジネス サーバー 2015、Skype で会議の概要サブレポートについて説明します。
...
|:-----|:-----|:-----|
|**[電話会議の合計数]** <br/> |不可  <br/> |開催された電話会議の合計数です。  <br/> |
|**[電話会議セッションの合計数]** <br/> |不可  <br/> |電話会議セッションの合計数です。1 つの電話会議に複数のセッションが存在する場合があります。たとえば、1 つの電話会議にフォーカス セッションと MCU セッションの両方が含まれる場合があります。  <br/> |
|**[全体的なセッション エラー率]** <br/> |不可  <br/> |エラーが発生したすべての電話会議の割合です。  <br/> |
|**[フォーカス セッション]** <br/> |不可  <br/> |フォーカス セッションの合計数です。  <br/> |
|**[フォーカス エラー率]** <br/> |不可  <br/> |エラーが発生したフォーカス セッションの割合です。  <br/> |
|[MCU セッション]  <br/> |不可  <br/> |MCU セッションの合計数です。  <br/> |
|**[MCU エラー率]** <br/> |不可  <br/> |エラーが発生した MCU セッションの割合です。  <br/> |
|**[MCU セッション (モダリティ別)]** <br/> |不可  <br/> |モダリティ (IM 電話会議など) ごとにグループ化した、MCU セッションの合計数です。  <br/> |

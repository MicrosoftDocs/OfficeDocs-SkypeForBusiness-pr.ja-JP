...
---
# <a name="ip-phone-inventory-report-in-skype-for-business-server"></a>Skype for Business Server の IP 電話インベントリ レポート
 
**概要:** Skype for Business Server の IP 電話インベントリ レポートについて学習します。
...
このレポートは、真の在庫レポートとして使用される場合にいくつかの制限があります。 1 つの問題として、IP 電話レポートには、指定した期間中に Skype for Business Server にログオンした電話すべてが、最後のログオン時刻順に並べ替えたものがあります。 指定した期間中に電話がログオンしなかった場合、電話は在庫レポートに一覧表示されません。 これには、期間が開始される前にログオンし、指定した時間間隔中にログオンしていた電話が含まれます。 たとえば、2015 年 7 月のすべての電話在庫を確認するとします。 また、2015 年 6 月 30 日に複数の電話が Skype for Business Server にログオンし、7 月 1 日の現在もログオンしていたとします。 これらの電話は、7 月 1 日の在庫レポートには表示されない。
  
また、インベントリ レポートには、組織で使用されなくなった電話が含まれる可能性があります。 たとえば、2015 年 7 月 1 日にシステムにログオンした Fabrikam の電話が多数あるとします。5 日後、組織は Fabrikam のすべての電話を取り除き、それらを新しい Contoso モデルに置き換えました。 Fabrikam の電話は、7 月中にシステムにログオンしたからといって、"インベントリ" レポートに表示されます。
...
IP 電話インベントリ レポートを使用するもう 1 つの興味深い方法は、IP 電話の MAC アドレスを持っている場合は、そのアドレスを MAC アドレス テキスト ボックスに入力するだけで、その電話を最後に使用したユーザーを見つける方法です。 その後、IP 電話インベントリ レポートは、その電話で最後にログオンしたユーザーの SIP アドレスを (特に) 報告します。 または、ユーザー SIP アドレス ([ユーザー URI プレフィックス] ボックス) を入力して、そのユーザーが使用した電話を検索することもできます。
...
|:-----|:-----|:-----|
|**製造元** <br/> |必要  <br/> |IP 電話を製造した会社の名前。  <br/> |
|[**ハードウェア バージョン**] <br/> |必要  <br/> |IP 電話のバージョン番号。  <br/> |
|[**MAC アドレス**] <br/> |必要  <br/> |IP 電話のネットワーク インターフェイスの一意の識別子。MAC アドレスは、通常、電話の製造時に割り当てられ、デバイス ハードウェアに組み込まれます。  <br/> |
|[**ユーザー URI**] <br/> |必要  <br/> |IP 電話を使用したユーザーの SIP アドレス。  <br/> |
|[**ユーザー エージェント**] <br/> |必要  <br/> |IP 電話で使われているソフトウェアの識別子。  <br/> |
|[**最後にログオンした時刻**] <br/> |必要  <br/> |IP 電話が最後に Skype for Business Server にログオンした日時。  <br/> |
|[**最後にログオフした時刻**] <br/> |必要  <br/> |IP 電話が Skype for Business Server から最後にログオフした日時。  <br/> |
|[**最後のアクティビティ**] <br/> |必要  <br/> |IP 電話が最後に使われた日時。  <br/> |

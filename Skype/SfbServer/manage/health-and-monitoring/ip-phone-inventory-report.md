...
|**名前**|**この項目での並べ替え**|**説明**|
|:-----|:-----|:-----|
|**[製造元]** <br/> |可  <br/> |IP 電話を製造した会社の名前。  <br/> |
|**[ハードウェア バージョン]** <br/> |可  <br/> |IP 電話のバージョン番号。  <br/> |
|**[MAC アドレス]** <br/> |可  <br/> |IP 電話のネットワーク インターフェイスの一意の識別子。MAC アドレスは、通常、電話の製造時に割り当てられ、デバイス ハードウェアに組み込まれます。  <br/> |
|**[ユーザー URI]** <br/> |可  <br/> |IP 電話を使用したユーザーの SIP アドレス。  <br/> |
|**[ユーザー エージェント]** <br/> |可  <br/> |IP 電話で使われているソフトウェアの識別子。  <br/> |
|**[最後にログオンした時刻]** <br/> |可  <br/> |日付と IP 電話の前回のログイン Skype をビジネスのサーバーの時間です。  <br/> |
|**[最後にログオフした時刻]** <br/> |可  <br/> |日付と IP 電話が最後にログオフ Skype からビジネス サーバーの時間です。  <br/> |

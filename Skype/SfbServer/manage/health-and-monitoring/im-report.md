...
---
# <a name="peer-to-peer-im-report-in-skype-for-business-server-2015"></a>Skype for Business Server 2015 のピアツーピア IM レポート
 
**の概要:**ビジネス サーバー 2015 の Skype でピア ツー ピア IM レポートについて説明します。
...
[ビジネス サーバー 2015 の Skype でのピア ツー ピア アクティビティ概要レポート](peer-to-peer-activity-summary-report.md)を開き、次の測定値のいずれかをクリックするだけでは、ピア ツー ピア IM レポートにアクセスできます。
...
**メトリックは、ピア ツー ピア IM セッションのプールを**

|**名**|**この項目を並べ替えることができますか。**|**説明**|
|:-----|:-----|:-----|
|**[プール]** <br/> |不可  <br/> |レジストラー プールまたはエッジ サーバーの名前です。  <br/> |
|**[日付/時刻]** <br/> |不可  <br/> |セッションの発生日時。  <br/> |
...
**認証の種類によって、ピア ツー ピア IM セッションの指標**

...
2. コマンド ライン プロンプトで次のように入力します。
  ...
  ```
    ...
    > [!NOTE]
    > New-CsClsConfiguration を使用すると、オプションの多数の構成設定にアクセスできます。 詳細構成オプションについては、 [Get CsClsConfiguration](https://docs.microsoft.com/powershell/module/skype/get-csclsconfiguration?view=skype-ps)と[理解する一元的なログ記録サービス構成の設定](http://technet.microsoft.com/library/3c34e600-0b91-43dc-b4cc-90b6a70ee12e.aspx)を参照してください。 

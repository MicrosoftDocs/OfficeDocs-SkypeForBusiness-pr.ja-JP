...
セントラル サイトでエンタープライズ VoIP を展開するのにには、このトピックを使用します。 ブランチ サイトでエンタープライズ VoIP を展開するには、[ブランチ サイトの展開](https://technet.microsoft.com/library/1475dee0-66ae-4ee5-b6f1-7409b4bbff45.aspx)をスキップします。

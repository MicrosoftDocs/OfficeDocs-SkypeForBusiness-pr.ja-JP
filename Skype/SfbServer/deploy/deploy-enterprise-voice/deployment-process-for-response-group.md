...
応答グループを構成する最初の手順は、エージェント グループを作成するのには。 エージェント グループを作成することができます、前に、ビジネスおよびエンタープライズ VoIP の Skype の応答グループのエージェントとなるユーザーを有効にする必要があります。 ビジネス用の Skype のユーザーを有効にすることは、通常、Enterprise Edition サーバーまたは Standard Edition サーバーの展開の手順です。 ビジネス用の Skype のユーザーを有効にする方法の詳細は、[有効または無効にするユーザーが Lync Server 2013 プレビュー](https://technet.microsoft.com/library/12497d00-f665-4a97-be68-854c5a8be4fc.aspx)を参照してください。 エンタープライズ VoIP に対してユーザーを有効にすることは、通常、エンタープライズ VoIP 展開のステップです。 詳細については、 [Skype のビジネス サーバーでエンタープライズ VoIP のユーザーを有効にする](enable-users-for-enterprise-voice.md)を参照してください。

...
Lync Server 2013 を Skype for Business Server 2015 にアップグレードするには、前提条件ソフトウェアのインストール、Skype for Business Server トポロジ ビルダーを使用したプール内のデータベースのアップグレード、および関連付けられた各サーバーでの Skype for Business Server In-Place アップグレードの使用が含まれます。プール。 アップグレードを完了するには、このトピックの 8 つの手順を実行します。
  
### <a name="before-you-begin"></a>開始する前に

- 「[2015 年にアップグレードするSkype for Business Server」を参照してください](../plan-your-deployment/upgrade.md)。
    
- [2015 年のサーバー要件Skype for Business Server確認します](../plan-your-deployment/requirements-for-your-environment/server-requirements.md)。
...
2. 2015 Skype for Business Serverメディアから **、Setup.exe** **\Setup\AMD64 OCS_Volumeを実行します**。 
...
1. トポロジ ビルダーで、Lync Server 2013 プールを右クリックし、[アップグレードして **2015 Skype for Business Server]** を選択し、手順に従います。 
    
     ![Lync Server 2013 のアップグレード オプションを使用した右クリック メニューのスクリーン ショット。](../media/7d5b25b1-e5c0-474c-a024-a5ba33f1b3a1.png)
  
2. トポロジ ビルダーで、[**ActionPublish**  >  トポロジ] または [**ActionTopologyPublish** >  > **] をクリックします**。 
...
3. Lync Server 2013 プールを右クリックし、[アップグレード **して 2015 Skype for Business Serverを** 選択し、手順に従います。 
    
     ![Lync Server 2013 のアップグレード オプションを使用した右クリック メニューのスクリーン ショット。](../media/7d5b25b1-e5c0-474c-a024-a5ba33f1b3a1.png)
  
4. トポロジ ビルダーで、[**ActionPublish**  >  トポロジ] または [**ActionTopologyPublish** >  > **] をクリックします**。 
...
6. トポロジ ビルダーで、[**ActionPublish**  >  トポロジ] または [**ActionTopologyPublish** >  > **] をクリックします**。 
...
アップグレード準備の確認または不足している前提条件のインストールで In-Place アップグレードが失敗した場合は、サーバーに最新の Windows Server、Lync Server、および SQL Server 更新プログラムが適用され、必要なすべてのソフトウェアと役割がインストールされていることを確認します。 必要な項目の一覧については、「サーバー要件 for [Skype for Business Server 2015](../plan-your-deployment/requirements-for-your-environment/server-requirements.md)」および「Install [prerequisites for Skype for Business Server 2015」を参照](install/install-prerequisites.md)してください。

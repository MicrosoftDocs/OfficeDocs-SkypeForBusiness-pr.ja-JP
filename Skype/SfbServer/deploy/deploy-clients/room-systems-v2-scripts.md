...
---
# <a name="skype-room-systems-v2-scripts"></a><span data-ttu-id="a70ea-103">Skype ルーム システム v2 のスクリプト</span><span class="sxs-lookup"><span data-stu-id="a70ea-103">Skype Room Systems v2 Scripts</span></span>
 
<span data-ttu-id="a70ea-104">この資料のセクションの見出しにという名前のテキスト ファイルの各セクションをコピーします。</span><span class="sxs-lookup"><span data-stu-id="a70ea-104">Copy each of the sections in this article into a text file named in the section heading.</span></span> <span data-ttu-id="a70ea-105">Skype ルーム システム v2 を展開することでこれらのファイルが使用されます。</span><span class="sxs-lookup"><span data-stu-id="a70ea-105">These files are used in deploying Skype Room Systems v2:</span></span> 
* <span data-ttu-id="a70ea-106">[CreateSrsMedia.ps1](#createsrsmediaps1)は、コンソール デバイスのソフトウェア ・ イメージの作成に使用される Powershell スクリプトです。</span><span class="sxs-lookup"><span data-stu-id="a70ea-106">[CreateSrsMedia.ps1](#createsrsmediaps1) is a Powershell script used to create a software image for the console device.</span></span>  
* <span data-ttu-id="a70ea-107">[SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1)は、ビジネスと Exchange のアカウント、デバイスの Skype を設定するためのスクリプトを使用する Powershell です。</span><span class="sxs-lookup"><span data-stu-id="a70ea-107">[SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) is a Powershell script used to set up Skype for Business and Exchange accounts the devices will use.</span></span>  
* <span data-ttu-id="a70ea-108">[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview)は、OMS を使用して Skype ルーム システム v2 の管理を設定するときに使用されます。</span><span class="sxs-lookup"><span data-stu-id="a70ea-108">[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview)  is used when setting up management of Skype Room Systems v2 using OMS.</span></span>
  
<a name="CreateSrs"></a>
## <a name="createsrsmediaps1"></a><span data-ttu-id="a70ea-109">CreateSrsMedia.ps1</span><span class="sxs-lookup"><span data-stu-id="a70ea-109">CreateSrsMedia.ps1</span></span>
...
<a name="CreateRoom"></a>
## <a name="skyperoomprovisioningscriptps1"></a><span data-ttu-id="a70ea-110">SkypeRoomProvisioningScript.ps1</span><span class="sxs-lookup"><span data-stu-id="a70ea-110">SkypeRoomProvisioningScript.ps1</span></span>
...
```
<a name="OMSVIEW"></a>
## <a name="skyperoomsystemsv2omsview"></a><span data-ttu-id="a70ea-111">SkypeRoomSystems_v2.omsview</span><span class="sxs-lookup"><span data-stu-id="a70ea-111">SkypeRoomSystems_v2.omsview</span></span>
...
## <a name="see-also"></a><span data-ttu-id="a70ea-112">関連項目</span><span class="sxs-lookup"><span data-stu-id="a70ea-112">See also</span></span>

#### 

[<span data-ttu-id="a70ea-113">Skype ルームの計画システム v2</span><span class="sxs-lookup"><span data-stu-id="a70ea-113">Plan for Skype Room Systems v2</span></span>](../../plan-your-deployment/clients-and-devices/skype-room-systems-v2-0.md)
  
[<span data-ttu-id="a70ea-114">Skype ルーム システム v2 のコンソールを構成します。</span><span class="sxs-lookup"><span data-stu-id="a70ea-114">Configure a Skype Room Systems v2 console</span></span>](console.md)
  
[<span data-ttu-id="a70ea-115">Skype ルームの管理システム v2</span><span class="sxs-lookup"><span data-stu-id="a70ea-115">Manage Skype Room Systems v2</span></span>](../../manage/skype-room-systems-v2/skype-room-systems-v2.md)

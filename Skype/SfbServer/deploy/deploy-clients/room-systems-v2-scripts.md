...
---
# <a name="skype-room-systems-v2-scripts"></a>Skype ルーム システム v2 のスクリプト
 
この資料のセクションの見出しにという名前のテキスト ファイルの各セクションをコピーします。 Skype ルーム システム v2 を展開することでこれらのファイルが使用されます。 
* [CreateSrsMedia.ps1](#createsrsmediaps1)は、コンソール デバイスのソフトウェア ・ イメージの作成に使用される Powershell スクリプトです。  
* [SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1)は、ビジネスと Exchange のアカウント、デバイスの Skype を設定するためのスクリプトを使用する Powershell です。  
* [SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview)は、OMS を使用して Skype ルーム システム v2 の管理を設定するときに使用されます。

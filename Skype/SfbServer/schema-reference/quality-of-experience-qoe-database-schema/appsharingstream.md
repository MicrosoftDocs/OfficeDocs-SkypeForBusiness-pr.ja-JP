...
|**SessionSeq** <br/> |整数  <br/> |主/プライマリ、外部  <br/> |同じ日付に、同時に開始したセッションを区別する順次識別子。  <br/> |
|**MediaLineLabel** <br/> |tinyint  <br/> |主/プライマリ、外部  <br/> | [「MediaLine テーブル」を参照してください](./medialine-0.md)。 <br/> |
|**StreamID** <br/> |整数  <br/> |Primary  <br/> |アプリケーション共有ストリームの一意識別子。  <br/> |
|**ジッターInterArrival** <br/> |整数  <br/> ||RTP パケットの着信間に検出された平均ジッター (ジッターとは、通話の "揺れ" の測定値です)。通常、この値が高い場合は、輻輳やメディア サーバーの過負荷の原因が考えられます。その結果、音声のひずみや欠落が生じます。  <br/> |
|**ジッターInterArrivalMax** <br/> |整数  <br/> ||RTP パケットの着信間に検出された最大ジッター (ジッターとは、通話の "揺れ" の測定値です)。通常、この値が高い場合は、輻輳やメディア サーバーの過負荷の原因が考えられます。その結果、音声のひずみや欠落が生じます。  <br/> |
|**RoundTrip** <br/> |整数  <br/> ||リアルタイム転送プロトコル (RTP) パケットが別のエンドポイントとの間を往復するのに要する平均時間 (ミリ秒単位)。200 ミリ秒以下の往復時間が許容できる品質と見なされます。  <br/> この値が高い場合は、国際通話ルーティング、ルーティングの構成ミス、メディア サーバーの過負荷などの原因が考えられます。その結果、双方向のリアルタイムの音声会話が難しくなります。  <br/> |
|**RoundTripMax** <br/> |整数  <br/> ||リアルタイム転送プロトコル (RTP) パケットが別のエンドポイントとの間を往復するのに要する最大時間 (ミリ秒単位)。200 ミリ秒以下の往復時間が許容できる品質と見なされます。  <br/> この値が高い場合は、国際通話ルーティング、ルーティングの構成ミス、メディア サーバーの過負荷などの原因が考えられます。その結果、双方向のリアルタイムの音声会話が難しくなります。  <br/> |
...
|**PacketUtilization** <br/> |整数  <br/> ||送信されたパケット数。  <br/> |
|**BandwidthEst** <br/> |整数  <br/> ||セッションの最後での、推定された一方向の帯域幅。ビット/秒で報告されます。  <br/> |
|**AppSharingPayloadDescription** <br/> |整数  <br/> ||アプリケーション共有ペイロードの詳細。  <br/> |
...
|**RelativeOneWayBurstOccurrences** <br/> |整数  <br/> ||一方向のバーストの合計発生数。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> |
|**RelativeOneWayBurstDensity** <br/> |浮動小数点数  <br/> ||一方向のバーストの合計密度。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> |
|**RelativeOneWayBurstDuration** <br/> |浮動小数点数  <br/> ||一方向のバーストの合計期間。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> |
|**RelativeOneWayGapOccurrences** <br/> |整数  <br/> ||一方通行間隔の合計。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。ギャップは、これらのバースト間の遅延を示します。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> |
|**RelativeOneWayGapDensity** <br/> |浮動小数点数  <br/> ||一方通行のギャップ密度の合計。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。ギャップは、これらのバースト間の遅延を示します。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> |
|**RelativeOneWayGapDuration** <br/> |浮動小数点数  <br/> ||一方通行間隔の合計期間。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。ギャップは、これらのバースト間の遅延を示します。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> |
...
|**RDPTileProcessingLatencyBurstOccurrences** <br/> |整数  <br/> ||リモート デスクトップ プロトコル (RDP) タイルの処理時間でのバースト発生数。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。  <br/> |
|**RDPTileProcessingLatencyBurstDensity** <br/> |浮動小数点数  <br/> ||リモート デスクトップ プロトコル (RDP) タイルの処理時間でのバースト密度。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。  <br/> |
|**RDPTileProcessingLatencyBurstDuration** <br/> |浮動小数点数  <br/> ||リモート デスクトップ プロトコル (RDP) タイルの処理時間でのバースト持続時間。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。  <br/> |
|**RDPTileProcessingLatencyGapOccurrences** <br/> |整数  <br/> ||リモート デスクトップ プロトコル (RDP) タイルの処理時間でのギャップ発生数。  <br/> |
...
|**CaptureTileRateGapOccurrences** <br/> |整数  <br/> ||キャプチャされたタイルのレート (タイル/秒) でのギャップ発生数。  <br/> |
...
|**SpoiledTilePercentBurstOccurrences** <br/> |整数  <br/> ||視聴者に到達せず、新規のコンテンツによって破棄されて、上書きされたコンテンツでのバースト発生数。  <br/> |
...
|**SpoiledTilePercentGapOccurrences** <br/> |整数  <br/> ||視聴者に到達せず、新規のコンテンツによって破棄されて、上書きされたコンテンツでのギャップ発生数。  <br/> |
...
|**ScrapingFrameRateBurstOccurrences** <br/> |整数  <br/> ||グラフィックス ソースからスクレープされたフレームのバースト発生数。  <br/> |
...
|**ScrapingFrameRateGapOccurrences** <br/> |整数  <br/> ||グラフィックス ソースからスクレープされたフレームのギャップ発生数。  <br/> |
...
|**IncomingTileRateBurstOccurrences** <br/> |整数  <br/> ||閲覧者が受信する受信タイル レートでのバースト発生数。  <br/> |
...
|**IncomingTileRateGapOccurrences** <br/> |整数  <br/> ||閲覧者が受信する受信タイル レートでのギャップ発生数。  <br/> |
...
|**IncomingFrameRateBurstOccurrences** <br/> |整数  <br/> ||閲覧者が受信する受信フレーム レートでのバースト発生数。  <br/> |
...
|**IncomingFrameRateGapOccurrences** <br/> |整数  <br/> ||閲覧者が受信する受信フレーム レートでのギャップ発生数。  <br/> |
...
|**OutgoingTileRateBurstOccurrences** <br/> |整数  <br/> ||送信者の送信タイル レートのバースト発生数。  <br/> |
...
|**OutgoingTileRateGapOccurrences** <br/> |整数  <br/> ||送信者の送信タイル レートのギャップ発生数。  <br/> |
...
|**OutgoingFrameRateBurstOccurrences** <br/> |整数  <br/> ||送信者の送信フレーム レートのバースト発生数。  <br/> |
...
|**OutgoingFrameRateGapOccurrences** <br/> |整数  <br/> ||送信者の送信フレーム レートのギャップ発生数。  <br/> |
...
|**AverageRectangleHeight** <br/> |整数  <br/> ||平均のビデオ解像度の高さ (ピクセル)。  <br/> |
|**AverageRectangleWidth** <br/> |整数  <br/> ||平均のビデオ解像度の幅 (ピクセル)。  <br/> |
|**受信** <br/> |ビット  <br/> ||着信の平均フレーム レート (フレーム/秒)。  <br/> |
|**送信** <br/> |ビット  <br/> ||発信の平均フレーム レート (フレーム/秒)。  <br/> |
|**SenderIsCallerPAI** <br/> |ビット  <br/> ||1 は、ストリームの方向が発信者から呼び出し先へ向かうことを意味します。  <br/> 0 は、ストリームの方向が呼び出し先から発信者へ向かうことを意味します。  <br/> |

...
|CallerCPUProcessorSpeed  <br/> |int  <br/> |呼び出し元のエンドポイントの CPU プロセッサ速度。  <br/> |
...
|ジッターInterArrival  <br/> |int  <br/> |リアルタイム制御プロトコル (RTCP) 統計情報に基づく平均ネットワーク ジッター。  <br/> |
|ジッターInterArrivalMax  <br/> |int  <br/> |通話時の最大ネットワーク ジッター。  <br/> |
...
|CallerSpeakerGlitchRate  <br/> |int  <br/> |呼び出し元の拡声器レンダリングの 5 分あたりの平均グリッチ。 良好な品質といえるのは、5 分間に 1 回未満です。 音声ビデオ会議サーバー、仲介サーバー、または IP 電話では報告されません。  <br/> |
|CallerMicGlitchRate  <br/> |int  <br/> |発信者のマイク キャプチャの 5 分あたりの平均グリッチ。 良好な品質といえるのは、5 分間に 1 回未満です。 音声ビデオ会議サーバー、仲介サーバー、または IP 電話では報告されません。  <br/> |
...
|CallerRxAGCSignalLevel  <br/> |int  <br/> |呼び出し元のオーディオのゲートウェイから仲介サーバーで受信した信号レベル。これは仲介サーバーにのみ適用されます。 この測定指標の単位は dBoV です。 良好な品質を得る場合、許容範囲は -30 ~ -18 dBoV である必要があります。  <br/> |
|CallerRxAGCNoiseLevel  <br/> |int  <br/> |呼び出し元のオーディオのゲートウェイから仲介サーバーで受信した信号レベル。 この値は、仲介サーバーに対してのみ適用されます。 この測定指標の単位は dBoV です。 良好な品質として許容される範囲は、-50 dBoV 未満です。  <br/> |
|CallerRxAGCGain  <br/> |int  <br/> |呼び出し元のオーディオに適用される仲介サーバー側の自動ゲイン制御 (AGC)。  <br/> |
...
|CalleeSpeakerGlitchRate  <br/> |int  <br/> |呼び出し先の拡声器レンダリングの 5 分あたりの平均グリッチ。 良好な品質といえるのは、5 分間に 1 回未満です。 音声ビデオ会議サーバー、仲介サーバー、または IP 電話では報告されません。  <br/> |
|CalleeMicGlitchRate  <br/> |int  <br/> |通話者のマイク キャプチャの 5 分あたりの平均グリッチ。 良好な品質といえるのは、5 分間に 1 回未満です。 音声ビデオ会議サーバー、仲介サーバー、または IP 電話では報告されません。  <br/> |
...
|CalleeRxAGCSignalLevel  <br/> |int  <br/> |呼び出し先のオーディオのゲートウェイから仲介サーバーで受信した信号レベル。これは仲介サーバーにのみ適用されます。 この測定指標の単位は dBoV です。 良好な品質を得る場合、許容範囲は [-30 ~ -18] dBoV である必要があります。  <br/> |
|CalleeRxAGCNoiseLevel  <br/> |int  <br/> |呼び出し先のオーディオのゲートウェイから仲介サーバーで受信した信号レベル。 この値は、仲介サーバーに対してのみ適用されます。 この測定指標の単位は dBoV です。 良好な品質として許容される範囲は、-50 dBoV 未満です。  <br/> |
|CalleeRxAGCGain  <br/> |int  <br/> |呼び出し先のオーディオに適用される仲介サーバー側の自動ゲイン制御 (AGC)。  <br/> |

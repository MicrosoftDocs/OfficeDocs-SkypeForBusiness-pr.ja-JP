...
|**SessionSeq** <br/> |整数  <br/> |Primary  <br/> |R [MediaLine テーブルから参照されます](medialine-0.md)。  <br/> |
|**MediaLineLabel** <br/> |tinyint  <br/> |Primary  <br/> |[MediaLine テーブルから参照されます](medialine-0.md)。  <br/> |
|**StreamID** <br/> |整数  <br/> |Primary  <br/> |メディア ライン内の一意の ID。  <br/> |
...
|**ジッターInterArrival** <br/> |整数  <br/> | <br/> |リアルタイム制御プロトコル (RTCP) 統計情報に基づく平均ネットワーク ジッター。  <br/> |
|**ジッターInterArrivalMax** <br/> |整数  <br/> | <br/> |ビデオ セッション中の最大ネットワーク ジッター。  <br/> |
|**RoundTrip** <br/> |整数  <br/> | <br/> |RTCP 統計情報に基づく往復時間。  <br/> |
|**RoundTripMax** <br/> |整数  <br/> | <br/> |ビデオ ストリームの最大ラウンド トリップ時間。  <br/> |
|**PacketLossRate** <br/> |decimal(5,4)  <br/> | <br/> |通話時の平均パケット損失率。  <br/> |
|**PacketLossRateMax** <br/> |decimal(5,4)  <br/> | <br/> |通話時に観測された最大パケット損失。  <br/> |
|**PacketUtilization** <br/> |整数  <br/> | <br/> |ビデオ ストリームのパケット数 (リアルタイム転送プロトコル、RTP)。  <br/> |
|**BandwidthEst** <br/> |整数  <br/> | <br/> |ビデオ ストリームの帯域幅の見積もり。  <br/> |
|**VideoResolution** <br/> |char(9)  <br/> | <br/> |幅×高さで示すビデオの解像度 (単位ピクセル)。文字列で報告されます。  <br/> |
|**VideoBitRateAvg** <br/> |整数  <br/> | <br/> |ビデオ ストリームの平均ビット レート。  <br/> |
...
|**VideoBitRateMax** <br/> |整数  <br/> | <br/> |ビデオ セッション中の最大ビデオ ビット レート。  <br/> |
...
|**BandwidthEstMin** <br/> |整数  <br/> ||通話中に測定される最小帯域幅推定量。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**BandwidthEstMax** <br/> |整数  <br/> ||通話中に測定される最大帯域幅推定量。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**BandwidthEstStdDev** <br/> |整数  <br/> ||通話中に測定された帯域幅推定の標準偏差。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**BandwidthEstAvge** <br/> |整数  <br/> ||通話中に測定された平均帯域幅推定量。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
...
|**RelativeOneWayBurstOccurrences** <br/> |整数  <br/> ||一方向のバーストの合計発生数。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**RelativeOneWayBurstDensity** <br/> |整数  <br/> ||一方向のバーストの合計密度。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
...
|**RelativeOneWayGapOccurrences** <br/> |整数  <br/> ||一方通行間隔の合計。 "バースト" 伝送とは、安定したストリームではなく、予測できないバーストでデータが流れる伝送です。ギャップは、これらのバースト間の遅延を示します。 この指標では、クライアントとサーバーの間のデータ フローが測定されます。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
...
|**VideoAllocateBWAvg** <br/> |整数  <br/> ||ビデオに割り当てられた帯域幅の平均。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
...
|**SendResolutionWidth** <br/> |整数  <br/> ||送信者が使用する解像度の幅。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**SendResolutionHeight** <br/> |整数  <br/> ||送信者が使用する解像度の高さ。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**SendFrameRateAverage** <br/> |浮動小数点数  <br/> ||送信者が使用する平均ビデオ フレーム レート伝送。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**SendBitRateMaximum** <br/> |整数  <br/> ||送信者の最大ビット レート。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**SendBitRateAverage** <br/> |整数  <br/> ||送信者の平均ビット レート。  <br/> |
|**SendVideoStreamsMax** <br/> |整数  <br/> ||送信者が使用するビデオ ストリームの最大数。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
...
|**RecvResolutionWidth** <br/> |整数  <br/> ||レシーバーで使用される解像度の幅。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**RecvResolutionHeight** <br/> |整数  <br/> ||レシーバーで使用される解像度の高さ。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**RecvFrameRateAverage** <br/> |浮動小数点数  <br/> ||レシーバーが使用する平均ビデオ フレーム レート。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**RecvBitRateMaximum** <br/> |整数  <br/> ||レシーバーの最大ビット レート。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**RecvBitRateAverage** <br/> |整数  <br/> ||レシーバーの平均ビット レート。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**RecvVideoStreamsMax** <br/> |整数  <br/> ||レシーバーの最大ビデオ ストリーム。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**RecvVideoStreamsMin** <br/> |整数  <br/> ||レシーバーの最小ビデオ ストリーム。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |
|**RecvVideoStreamsMode** <br/> |整数  <br/> ||レシーバーのビデオ モード (ギャラリーや単一ストリームなど)。  <br/> この列は、Microsoft Lync Server 2013 で導入されました。  <br/> |

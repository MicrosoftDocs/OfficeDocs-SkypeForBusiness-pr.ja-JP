...
|[UserAgentDef テーブル (QoE)](useragentdef-qoe.md) <br/> |マップエージェント識別子をエージェントのわかりやすい名前に設定します。  <br/> |
...
|[エンドポイント テーブル](endpoint.md) <br/> |音声およびビデオ セッションに参加しているエンドポイントの FQDN コンピューター名を格納します。  <br/> |
|[プール テーブル](pool.md) <br/> |指標データが属するプールの名前を格納します。  <br/> |
|[デバイス テーブル](device.md) <br/> |音声ビデオ通話で使用されるキャプチャ デバイスおよびレンダー デバイスを格納します。  <br/> |
...
|[地域テーブル](region.md) <br/> |NCS 設定で定義されているネットワーク地域を格納します。  <br/> |
|[UserSite テーブル](usersite.md) <br/> |NCS 設定で定義されているネットワーク サイトを格納します。  <br/> |
|[サブネット テーブル](subnet.md) <br/> |NCS 設定で定義されているサブネットを格納します。  <br/> |

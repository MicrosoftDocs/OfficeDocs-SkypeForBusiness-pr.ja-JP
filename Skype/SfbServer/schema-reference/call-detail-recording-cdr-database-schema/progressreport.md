...
|**ErrorReportSeq** <br/> |int  <br/> |主/プライマリ、外部  <br/> |エラー レポートを識別する ID 番号。 ErrorReporSeq は、一意的にエラー レポートを識別する目的で ErrorTime と共に使用されます。 詳細については[、「ErrorReport table in Skype for Business Server 2015](errorreport.md)」を参照してください。 <br/> このフィールドは、Microsoft Lync Server 2013 で導入されました。  <br/> |

...
|**ClientVersionId** <br/> |int  <br/> |外部  <br/> |現在のユーザーのクライアントのバージョン。 詳細については[、2015 Skype for Business Server ClientVersions](clientversions.md)テーブルを参照してください。 <br/> |
...
|**EdgeServerId** <br/> |int  <br/> |外部  <br/> |登録が通過するエッジ サーバー。 詳細については[、2015 年の edgeServers Skype for Business Serverを](edgeservers.md)参照してください。 <br/> |

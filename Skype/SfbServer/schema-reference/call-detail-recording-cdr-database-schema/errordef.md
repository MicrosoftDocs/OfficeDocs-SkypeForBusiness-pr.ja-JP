...
|**列**|**データ型**|**キー/インデックス**|**詳細**|
|:-----|:-----|:-----|:-----|
|**ErrorId** <br/> |整数  <br/> |Primary  <br/> |この種類のエラーを識別する一意の ID 番号。  <br/> |
|**ResponseCode** <br/> |整数  <br/> | <br/> |このエラーに関連付けられている標準の SIP 応答コード。  <br/> |
|**MsDiagId** <br/> |整数  <br/> | <br/> |Microsoft 診断 ID。  <br/> |

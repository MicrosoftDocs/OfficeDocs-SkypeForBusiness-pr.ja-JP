---
title: "電話番号の有効化が保留のままになるのはなぜですか?"
ms.author: tonysmit
author: tonysmit
manager: scotv
ms.date: 11/17/2017
...
description: "住所検証は、Office 365 の通話プランのセットアップで重要な項目です。住所検証により、組織のユーザーに、緊急応答サービスが使用できる緊急通話住所が提供されます。"
---

# 電話番号の有効化が保留のままになるのはなぜですか?

住所検証は、Office 365 の通話プランのセットアップで重要な項目です。住所検証により、組織のユーザーに、緊急応答サービスが使用できる緊急通話住所が提供されます。
...
> [!TIP]
> Office 365 管理センターの [ **サービス リクエストの表示**] ページに、参照番号が表示されます。 

...
|電話番号は自動的に電話会議に割り当てられますか?  <br/> |はいの場合。 <br/><ul><li> イスタンブール</ul> 専用の電話番号が必要な場合は、「[Skype for Business および Microsoft Teams のサービス電話番号の取得](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md)」をご覧ください。  <br/> |
...
|**機能**|**詳細**|
|:-----|:-----|
|有料電話番号を取得できる首都または主要都市はどこですか?  <br/> |<ul><li>アンカラ <li>  アンタルヤ <li>  イスタンブール <li>  イズミル </ul> |

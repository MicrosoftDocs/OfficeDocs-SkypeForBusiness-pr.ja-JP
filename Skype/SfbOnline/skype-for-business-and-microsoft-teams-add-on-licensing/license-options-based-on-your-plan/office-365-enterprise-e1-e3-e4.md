...
1. マーケティング Web サイトから E3 のシートを [1 つ購入します](https://go.microsoft.com/fwlink/?LinkId=24393)。 既存のテナントにシートに追加するためのオプションを選択します。

2. 管理センターにサインインし、[**課金サブスクリプション]** アドオン  >    >  **に移動します**。
...
- **年間契約ではなく月単位の契約を結んでいます** 。 場合によっては、月単位の契約のユーザーはアドオンを購入いただけません (支払方法が月単位の場合は該当しません)。 これは、修正中の既知の問題です。 [ビジネス製品のサポートに問い合わせ - 管理者向けヘルプ](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)。

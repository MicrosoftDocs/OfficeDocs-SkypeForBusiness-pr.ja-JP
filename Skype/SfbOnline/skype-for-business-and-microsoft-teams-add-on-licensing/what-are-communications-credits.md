...
コミュニケーション クレジットの最適な設定を把握するために、組織の PSTN サービスの利用状況を注意深く評価することをお勧めします。 PSTN サービスの詳細を参照するにを参照して[Office 365 のプランを呼び出すことは何ですか?](../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md)と[オーディオ会議のよく寄せられる質問](../audio-conferencing-in-office-365/Audio-Conferencing-common-questions.md)です。

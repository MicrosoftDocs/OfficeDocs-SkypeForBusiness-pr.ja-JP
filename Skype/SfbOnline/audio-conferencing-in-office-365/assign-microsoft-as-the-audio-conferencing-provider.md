...
### <a name="an-icon-showing-the-skype-for-business-logo-using-the-skype-for-business-admin-center"></a>![ロゴのアイコンSkype for Business表示されます。](../images/sfb-logo-30x30.png) Skype for Business 管理センターの使用

1. 管理センターの **[Microsoft Teams ポータル]**  >  **に移動します**。
    
2. 管理センター **Skype for Business左側** のナビゲーションで、[電話会議]**に移動します**。

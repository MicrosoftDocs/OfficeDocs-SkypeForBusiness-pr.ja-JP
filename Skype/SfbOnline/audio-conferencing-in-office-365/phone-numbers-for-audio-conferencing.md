...
電話番号の電話会議 **を設定** するとSkype for Businessダイヤルイン電話番号が組織に自動的に割り当てられます。 電話会議ブリッジに割り当てられている電話番号を確認するには、Skype for Business 会議 Microsoft Bridge に  >    >  **移動します**。 「[電話会議の電話番号のリストを表示する](see-a-list-of-audio-conferencing-numbers.md)」を参照してください。
  
> [!NOTE]
> 電話会議のすべてのダイヤルイン番号のリストを含んでいるリソースはありません。 地域または国/地域でダイヤルイン電話番号を使用できる場合は **、Skype for Business 管理** センターの [Voice  >    >  **電話 Numbers]** を使用し、[追加] をクリックし、[新しいサービス番号] をクリックします。 [**国/地域**]、[**都道府県/地域**]、[**市区町村**] のリストを使用して、検索をフィルタします。 また、無料のサービス番号をお探しの場合は、[状態/地域] の一覧から [無料通話 **] を選択** します。
  
## <a name="audio-conferencing-coverage-and-pricing"></a>電話会議のサービス対象範囲と価格情報

電話会議を使用できるすべての国や地域、都市の完全なリストについては、 「[電話会議および通話プランが利用可能な国と地域](/microsoftteams/country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans)」を参照してください。 詳細については、「電話会議 [」を参照してください](https://www.microsoft.com/microsoft-teams/audio-conferencing)。
...
会議ブリッジに割り当てられる電話会議の電話番号には、 **共有** と **専用** の 2 種類があります。 どちらの種類の番号も、組織内で開催されている音声会議に参加するために、任意の呼び出し元が使用できます。
...
> [!CAUTION]
> ベネズエラ、インドネシア、ベトナム、アラブ首長国連邦 (アラブ首長国連邦) では有料電話番号が利用できないので、これらの国/地域の組織には電話会議の有料電話番号が自動的に割り当てられていない。 これらの場所の無料電話番号は、使用可能な在庫状況に応じて利用できます。 
  
専用の電話会議の電話番号は、取得して組織に割り当てることができるサービス番号です。 サービス番号は、管理センター の Skype for Business **使用して確認できます**。 詳細については、「サービスの [電話番号を取得する」を参照してください](/microsoftteams/getting-service-phone-numbers)。
...
- 電話会議でサポートされている言語の一覧については、「電話会議でサポートされている言語」 [を参照してください](/MicrosoftTeams/audio-conferencing-supported-languages)。
    
- [Get-CsOnlineDialInConferencingServiceNumber](/powershell/module/skype/Get-CsOnlineDialInConferencingServiceNumber)コマンドレットを使用すると、組織の電話会議専用の電話番号を確認できます。
    
- [Get-CsOnlineDialInConferencingLanguagesSupported](/powershell/module/skype/Get-CsOnlineDialInConferencingLanguagesSupported) コマンドレットを使って、ダイヤルインの専用電話番号に対して設定できる言語を表示できます。
    
- 電話会議の電話番号ごとに最大 4 つの言語 (プライマリとセカンダリの 3 つ) を設定できます。 また、専用の電話会議の電話番号に言語を設定できます。
    
- ユーザーのダイヤルイン電話番号を設定するには、「招待に含まれる電話番号を設定 [する」を参照してください](set-the-phone-numbers-included-on-invites.md)。

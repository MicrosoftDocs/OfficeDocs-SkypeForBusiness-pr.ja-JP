...
- [すべて Skype for Business Online ユーザーに関する情報を返す](manage-user-accounts.md#BKMKReturnInfoAboutAllUsers)
    
- [Skype for Business Online の特定のユーザーに関する情報を返す](manage-user-accounts.md#BKMKReturnInfoSpecificUser)
    
- [Skype for Business Online の特定のユーザーの特定の情報を返す](manage-user-accounts.md#BKMKReturninfoSpecificUsers)
    
- [Skype for Business Online ユーザーのフィルターが適用されたリストを返します](manage-user-accounts.md#BKMKReturnFilteredListofUsers)

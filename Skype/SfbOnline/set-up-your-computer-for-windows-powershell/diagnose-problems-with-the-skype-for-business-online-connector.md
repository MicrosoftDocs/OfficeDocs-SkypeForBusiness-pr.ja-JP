...
> [!WARNING] 
> Live ID 認証は、for Business online Connector Skype非推奨です。 PowerShell モジュールTeamsを使用して、オンライン テナントを管理します。 ハイブリッド環境を管理する場合は、最新の累積的な更新プログラムにアップグレードするか、oAuth 認証を使用します。

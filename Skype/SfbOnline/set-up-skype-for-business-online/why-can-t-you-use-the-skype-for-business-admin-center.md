...
## <a name="ok-so-what-does-that-mean"></a>では、どういう意味でしょうか。
...
- **関連付け ID** 先日のメッセージにこのメッセージが一覧表示されている場合があります。 この情報は、エラーのトラブルシューティングに役立つ Microsoft サポート エンジニアによって使用されます。 Microsoft サポートにお問い合わせの場合は、関連付け ID の入力を求めされる場合があります。
...
もちろん。 Skype for Business Online サービスを移行している間は、Microsoft 365 の他の管理センター (Microsoft 365 管理センターや Exchange 管理センターなど) を引き続き使用できます。 ただし、Skype for Business Online 管理センターと共に、移行中に Skype for Business Online リモート PowerShell コマンドレットを使用することはできません。 

...
|**有料電話番号** (必須) <br/> |サード パーティの ACP の場合、これらの電話番号は電話会議プロバイダーから受け取った電話番号です。 ユーザーが、Microsoft を電話会議プロバイダーとして使用している場合は、これらは電話会議ブリッジで設定されている番号となります。 会議出席依頼に表示する番号の書式を設定Skype for Business、Microsoft Teams表示します。  <br/> |

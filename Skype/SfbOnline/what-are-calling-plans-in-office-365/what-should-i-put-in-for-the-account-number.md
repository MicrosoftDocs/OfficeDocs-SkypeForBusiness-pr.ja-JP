...
ms.custom:
- Calling Plans
description: "「内容に追加する必要アカウント番号として Skype for Business、とを探すことができます。 "
...
---
# <a name="what-should-i-put-in-for-the-account-number"></a>を入れる口座番号ですか。

一般的では、請求書アカウント番号を見つけることができます。 またはサービス プロバイダーまたはキャリアからがある請求書が航空会社の web サイトにログオンします。まだがわからない場合、アカウントの数] を実行して、サービス プロバイダーまたは carrier お問い合わせください。
  
> [!CAUTION]
>  サービス プロバイダーであるか航空会社のアカウントの数を入力するときに、スペース、破線、またはハイフンを使用しないことが重要です。
  
 **完全な手順は、「 [Office 365 への電話番号に転送](transfer-phone-numbers-to-office-365.md)」を参照してください。**

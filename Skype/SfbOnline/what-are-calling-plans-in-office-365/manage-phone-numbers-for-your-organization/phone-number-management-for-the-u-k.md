...
|:-----|:-----|
|ビジネス管理センターは、Skype で記載されていない新規のユーザーの電話番号を取得します。   <br/> |「[英国での新しい電話番号の申請 (地域番号) (v.3.0)(en-us)](../../downloads/new-number-request-forms/new-phone-number-request-for-the-u.k.-(geographic-numbers)-(v.3.0)-(en-us).pdf)」をダウンロードして記入し、[マイクロソフトに送信します](mailto:ptneu@microsoft.com)。  <br/> |

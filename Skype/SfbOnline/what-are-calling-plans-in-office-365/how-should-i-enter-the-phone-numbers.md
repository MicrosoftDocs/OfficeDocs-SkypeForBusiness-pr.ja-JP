...
- 1 つの電話番号を入力します。
  ...
  - すべての特殊文字は無視されます (ダッシュを含む「-」)。 次に例を示します。
  ...
  - 他の言語であっても、特殊文字の任意の組み合わせが修正されます。 次に例を示します。 

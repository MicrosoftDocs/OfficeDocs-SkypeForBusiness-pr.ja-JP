...
分析機能の呼び出しを設定する方法の詳細は、 [Skype の呼び出しのビジネス分析の設定](set-up-call-analytics.md)を参照してください。 ヘルプデスクの担当者が分析機能の呼び出しを機能させる方法の詳細については、[品質の低い呼び出しのトラブルシューティングを行うコール分析機能の使用](use-call-analytics-to-troubleshoot-poor-call-quality.md)を参照してください。
...
[ビジネス分析の電話の Skype を設定します。](set-up-call-analytics.md)

                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>展開し、組織のビジネスのサーバーに対して Skype を管理します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Office 365 環境内でのオンライン ビジネスの Skype を管理するためのリソースを検索します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ビジネス用の Skype の PowerShell 参照</h3>
                                                    <p>オンライン ビジネスのビジネスおよび Skype の Skype を管理する必要があります PowerShell コマンドレットについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>計画を取得する方法、および実用的なガイダンスがマイクロソフトのチームを正常にロールバックする必要があります。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
